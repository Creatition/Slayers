...
const TALENT_TREES = {
  // ── RANGER ───────────────────────────────────────────────
  ranger: { nodes: [
    {id:'r0', x:60, y:350, type:'minor', origin:true, connections:['r_ta','r_ma','r_ba'], name:'Fletcher\'s Stance', desc:'+5% Dmg, +2 Pickup', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.basePickupRange+=2; p.recomputeStats();}},
    {id:'r_ta', x:160, y:220, type:'minor',   connections:['r0','r_t1'], name:'Keen Arrow', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'r_t1', x:270, y:150, type:'minor',   connections:['r_ta','r_t2'], name:'Hawk Sight I', desc:'+3% Crit', apply:(p)=>{p.baseCritChance+=3; p.recomputeStats();}},
    {id:'r_t2', x:380, y:100, type:'minor',   connections:['r_t1','r_t3'], name:'Hawk Sight II', desc:'+3% Crit', apply:(p)=>{p.baseCritChance+=3; p.recomputeStats();}},
    {id:'r_t3', x:490, y:70, type:'notable',  connections:['r_t2','r_t4','r_m3'], name:'Deadeye', desc:'+7% Crit, +12% Crit Dmg', apply:(p)=>{p.baseCritChance+=7; p.recomputeStats(); p.baseCritDmg+=0.12; p.recomputeStats();}},
    {id:'r_t4', x:600, y:80, type:'minor',   connections:['r_t3','r_t5'], name:'Hawkfeather', desc:'+5% Crit, +4% Dmg', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'r_t5', x:710, y:80, type:'minor',   connections:['r_t4','r_t6'], name:'Eagle Eye', desc:'+6% Crit', apply:(p)=>{p.baseCritChance+=6; p.recomputeStats();}},
    {id:'r_t6', x:820, y:80, type:'ability',  connections:['r_t5','r_t7'], name:'Focus Shot', desc:'Unlock: Focus Shot', apply:(p)=>addAbilityToPlayer(p,'focusShot')},
    {id:'r_t7', x:930, y:100, type:'minor',   connections:['r_t6','r_t8'], name:'Perfect Draw', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'r_t8', x:1040, y:80, type:'notable',  connections:['r_t7','r_t9','r_lta'], name:'Critical Mass', desc:'+10% Crit, +20% Crit Dmg', apply:(p)=>{p.baseCritChance+=10; p.recomputeStats(); p.baseCritDmg+=0.20; p.recomputeStats();}},
    {id:'r_t9', x:1150, y:90, type:'minor',   connections:['r_t8','r_ltb'], name:'Glass Jaw', desc:'+8% Crit, +6% Dmg', apply:(p)=>{p.baseCritChance+=8; p.recomputeStats(); p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'r_ma', x:160, y:350, type:'minor',   connections:['r0','r_m1'], name:'Swift Stance', desc:'+8% Atk Speed', apply:(p)=>{p.baseFireRateMult*=1.080; p.recomputeStats();}},
    {id:'r_m1', x:270, y:310, type:'minor',   connections:['r_ma','r_m2'], name:'Quick Nock', desc:'+6% Atk Speed', apply:(p)=>{p.baseFireRateMult*=1.060; p.recomputeStats();}},
    {id:'r_m2', x:380, y:350, type:'minor',   connections:['r_m1','r_m3'], name:'Arrow Storm I', desc:'+5% Atk Speed, +3% Dmg', apply:(p)=>{p.baseFireRateMult*=1.050; p.recomputeStats(); p.baseDmgMult*=1.030; p.recomputeStats();}},
    {id:'r_m3', x:490, y:320, type:'notable',  connections:['r_m2','r_t3','r_m4'], name:'Swift Quiver', desc:'+15% Atk Speed', apply:(p)=>{p.baseFireRateMult*=1.150; p.recomputeStats();}},
    {id:'r_m4', x:600, y:310, type:'ability',  connections:['r_m3','r_m5'], name:'Hunter\'s Arrow', desc:'Unlock: Hunter\'s Arrow', apply:(p)=>addAbilityToPlayer(p,'huntersArrow')},
    {id:'r_m5', x:710, y:320, type:'minor',   connections:['r_m4','r_m6'], name:'Rain of Arrows', desc:'+6% Atk Speed, +4% Dmg', apply:(p)=>{p.baseFireRateMult*=1.060; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'r_m6', x:820, y:310, type:'ability',  connections:['r_m5','r_m7'], name:'Volley Shot', desc:'Unlock: Volley Shot', apply:(p)=>addAbilityToPlayer(p,'volleyShot')},
    {id:'r_m7', x:930, y:340, type:'minor',   connections:['r_m6','r_m8'], name:'Rapid Release', desc:'+8% Atk Speed', apply:(p)=>{p.baseFireRateMult*=1.080; p.recomputeStats();}},
    {id:'r_m8', x:1040, y:330, type:'notable',  connections:['r_m7','r_lta','r_lma'], name:'Rapid Fire', desc:'+18% Atk Speed, +8% Dmg', apply:(p)=>{p.baseFireRateMult*=1.180; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'r_ba', x:160, y:480, type:'minor',   connections:['r0','r_b1'], name:'Eagle Scout', desc:'+15 Pickup, +4% Dmg', apply:(p)=>{p.basePickupRange+=15; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'r_b1', x:270, y:540, type:'minor',   connections:['r_ba','r_b2'], name:'Survivalist I', desc:'+8% Dodge', apply:(p)=>{p.baseDodge+=8; p.recomputeStats();}},
    {id:'r_b2', x:380, y:580, type:'minor',   connections:['r_b1','r_b3'], name:'Survivalist II', desc:'+6% Dodge', apply:(p)=>{p.baseDodge+=6; p.recomputeStats();}},
    {id:'r_b3', x:490, y:600, type:'notable',  connections:['r_b2','r_b4','r_m3'], name:'Predator', desc:'+8% Dodge, +6% Crit', apply:(p)=>{p.baseDodge+=8; p.recomputeStats(); p.baseCritChance+=6; p.recomputeStats();}},
    {id:'r_b4', x:600, y:610, type:'ability',  connections:['r_b3','r_b5'], name:'Hawk Eye', desc:'Unlock: Hawk Eye', apply:(p)=>addAbilityToPlayer(p,'hawkEye')},
    {id:'r_b5', x:710, y:590, type:'minor',   connections:['r_b4','r_b6'], name:'Evasion I', desc:'+5% Dodge, +4% Dmg', apply:(p)=>{p.baseDodge+=5; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'r_b6', x:820, y:580, type:'ability',  connections:['r_b5','r_b7'], name:'Trueshot', desc:'Unlock: Trueshot', apply:(p)=>addAbilityToPlayer(p,'trueshot')},
    {id:'r_b7', x:930, y:560, type:'minor',   connections:['r_b6','r_b8'], name:'Sure Foot', desc:'+6% Dodge', apply:(p)=>{p.baseDodge+=6; p.recomputeStats();}},
    {id:'r_b8', x:1040, y:560, type:'notable',  connections:['r_b7','r_lba','r_lma'], name:'Shadow Step', desc:'+10% Dodge, +8% Dmg', apply:(p)=>{p.baseDodge+=10; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'r_lta', x:1160, y:160, type:'ability',  connections:['r_t8','r_lma'], name:'Storm of Arrows', desc:'Unlock: Storm of Arrows', apply:(p)=>addAbilityToPlayer(p,'stormOfArrows')},
    {id:'r_ltb', x:1160, y:220, type:'ability',  connections:['r_t9','r_lma'], name:'Marked for Death', desc:'Unlock: Marked for Death', apply:(p)=>addAbilityToPlayer(p,'markedForDeath')},
    {id:'r_lma', x:1230, y:340, type:'notable',  connections:['r_lta','r_ltb','r_m8','r_lba','r_cap'], name:'Apex Hunter', desc:'+12% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'r_lba', x:1160, y:500, type:'minor',   connections:['r_b8','r_lma'], name:'One With Nature', desc:'+10% Dmg, +8% Dodge', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseDodge+=8; p.recomputeStats();}},
    {id:'r_pre', x:1320, y:270, type:'minor',   connections:['r_lma','r_cap'], name:'Master Archer', desc:'+8% Dmg, +5% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'r_prb', x:1320, y:410, type:'minor',   connections:['r_lma','r_cap'], name:'Arrow Dancer', desc:'+10% Atk Speed, +5% Dodge', apply:(p)=>{p.baseFireRateMult*=1.100; p.recomputeStats(); p.baseDodge+=5; p.recomputeStats();}},
    {id:'r_cap', x:1400, y:350, type:'keystone', connections:[], name:'One With The Hunt', desc:'+25% Dmg, +50% Crit Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.baseCritDmg+=0.50; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
  ]},
  // ── BERSERKER ─────────────────────────────────────────────
  berserker: { nodes: [
    {id:'bz0', x:60, y:350, type:'minor', origin:true, connections:['bz_ta','bz_ma','bz_ba'], name:'Battle Fury', desc:'+5% Dmg, +5 HP', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxHp+=5; p.recomputeStats();}},
    {id:'bz_ta', x:160, y:220, type:'minor',   connections:['bz0','bz_t1'], name:'Blood Lust', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'bz_t1', x:270, y:150, type:'minor',   connections:['bz_ta','bz_t2'], name:'Rampage I', desc:'+5% Dmg, +4% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseFireRateMult*=1.040; p.recomputeStats();}},
    {id:'bz_t2', x:380, y:100, type:'minor',   connections:['bz_t1','bz_t3'], name:'Rampage II', desc:'+6% Dmg, +4% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseFireRateMult*=1.040; p.recomputeStats();}},
    {id:'bz_t3', x:490, y:70, type:'notable',  connections:['bz_t2','bz_t4','bz_m3'], name:'Blood Thirst', desc:'+8% Dmg, +2 Life on Kill', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.lifeOnKill=(p.lifeOnKill||0)+2; p.recomputeStats();}},
    {id:'bz_t4', x:600, y:80, type:'ability',  connections:['bz_t3','bz_t5'], name:'Berserker Rage', desc:'Unlock: Berserker Rage', apply:(p)=>addAbilityToPlayer(p,'berserkerRage')},
    {id:'bz_t5', x:710, y:80, type:'minor',   connections:['bz_t4','bz_t6'], name:'Fury Burn', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'bz_t6', x:820, y:80, type:'minor',   connections:['bz_t5','bz_t7'], name:'Overpower I', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'bz_t7', x:930, y:90, type:'notable',  connections:['bz_t6','bz_t8'], name:'Conqueror', desc:'+12% Dmg, +10 HP', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxHp+=10; p.recomputeStats();}},
    {id:'bz_t8', x:1040, y:80, type:'ability',  connections:['bz_t7','bz_lta'], name:'Warchief Call', desc:'Unlock: Warchief Call', apply:(p)=>addAbilityToPlayer(p,'warchiefCall')},
    {id:'bz_t9', x:1150, y:90, type:'minor',   connections:['bz_t8','bz_ltb'], name:'War Cry', desc:'+10% Dmg, +8% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseFireRateMult*=1.080; p.recomputeStats();}},
    {id:'bz_ma', x:160, y:350, type:'minor',   connections:['bz0','bz_m1'], name:'Brutal Strikes', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'bz_m1', x:270, y:310, type:'minor',   connections:['bz_ma','bz_m2'], name:'Hack & Slash I', desc:'+6% Dmg, +5% Crit Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseCritDmg+=0.05; p.recomputeStats();}},
    {id:'bz_m2', x:380, y:350, type:'minor',   connections:['bz_m1','bz_m3'], name:'Hack & Slash II', desc:'+6% Dmg, +5% Crit Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseCritDmg+=0.05; p.recomputeStats();}},
    {id:'bz_m3', x:490, y:320, type:'notable',  connections:['bz_m2','bz_t3','bz_m4'], name:'Savage', desc:'+10% Dmg, +10% Crit Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseCritDmg+=0.10; p.recomputeStats();}},
    {id:'bz_m4', x:600, y:310, type:'ability',  connections:['bz_m3','bz_m5'], name:'Blood Rend', desc:'Unlock: Blood Rend', apply:(p)=>addAbilityToPlayer(p,'bloodRend')},
    {id:'bz_m5', x:710, y:320, type:'minor',   connections:['bz_m4','bz_m6'], name:'Flailing Strike', desc:'+7% Dmg, +6% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats(); p.baseFireRateMult*=1.060; p.recomputeStats();}},
    {id:'bz_m6', x:820, y:310, type:'ability',  connections:['bz_m5','bz_m7'], name:'Reckless Swing', desc:'Unlock: Reckless Swing', apply:(p)=>addAbilityToPlayer(p,'recklessSwing')},
    {id:'bz_m7', x:930, y:330, type:'minor',   connections:['bz_m6','bz_m8'], name:'Carnage', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'bz_m8', x:1040, y:330, type:'notable',  connections:['bz_m7','bz_lma','bz_lta'], name:'Warmonger Pact', desc:'+15% Dmg, +2 Life on Kill', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.lifeOnKill=(p.lifeOnKill||0)+2; p.recomputeStats();}},
    {id:'bz_ba', x:160, y:480, type:'minor',   connections:['bz0','bz_b1'], name:'Iron Flesh I', desc:'+12 HP, +4 Armor', apply:(p)=>{p.baseMaxHp+=12; p.recomputeStats(); p.baseArmor+=4; p.recomputeStats();}},
    {id:'bz_b1', x:270, y:540, type:'minor',   connections:['bz_ba','bz_b2'], name:'Iron Flesh II', desc:'+15 HP, +5 Armor', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats(); p.baseArmor+=5; p.recomputeStats();}},
    {id:'bz_b2', x:380, y:580, type:'minor',   connections:['bz_b1','bz_b3'], name:'Iron Flesh III', desc:'+12 HP, +5 Armor', apply:(p)=>{p.baseMaxHp+=12; p.recomputeStats(); p.baseArmor+=5; p.recomputeStats();}},
    {id:'bz_b3', x:490, y:600, type:'notable',  connections:['bz_b2','bz_b4','bz_m3'], name:'War Veteran', desc:'+20 HP, +8 Armor', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=8; p.recomputeStats();}},
    {id:'bz_b4', x:600, y:610, type:'ability',  connections:['bz_b3','bz_b5'], name:'Battle Shout', desc:'Unlock: Battle Shout', apply:(p)=>addAbilityToPlayer(p,'battleShout')},
    {id:'bz_b5', x:710, y:590, type:'minor',   connections:['bz_b4','bz_b6'], name:'Undying I', desc:'+3% Life Steal', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'bz_b6', x:820, y:580, type:'ability',  connections:['bz_b5','bz_b7'], name:'Berserker Leap', desc:'Unlock: Berserker Leap', apply:(p)=>addAbilityToPlayer(p,'berserkerLeap')},
    {id:'bz_b7', x:930, y:560, type:'minor',   connections:['bz_b6','bz_b8'], name:'Undying II', desc:'+15 HP, +3% Life Steal', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'bz_b8', x:1040, y:560, type:'notable',  connections:['bz_b7','bz_lba','bz_lma'], name:'Death\'s Door', desc:'+25 HP, +10 Armor', apply:(p)=>{p.baseMaxHp+=25; p.recomputeStats(); p.baseArmor+=10; p.recomputeStats();}},
    {id:'bz_lta', x:1160, y:160, type:'ability',  connections:['bz_t9','bz_lma'], name:'Berserker Whirlwind', desc:'Unlock: Berserker Whirlwind', apply:(p)=>addAbilityToPlayer(p,'berserkerWhirlwind')},
    {id:'bz_ltb', x:1160, y:230, type:'ability',  connections:['bz_t9','bz_lma'], name:'Earthshatter', desc:'Unlock: Earthshatter', apply:(p)=>addAbilityToPlayer(p,'earthshatter')},
    {id:'bz_lma', x:1230, y:340, type:'notable',  connections:['bz_lta','bz_ltb','bz_m8','bz_lba','bz_cap'], name:'Warlord', desc:'+18% Dmg, +20 HP', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats();}},
    {id:'bz_lba', x:1160, y:500, type:'minor',   connections:['bz_b8','bz_lma'], name:'Blood Price', desc:'+5% Life Steal, +10% Dmg', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'bz_pra', x:1320, y:270, type:'minor',   connections:['bz_lma','bz_cap'], name:'Iron Will', desc:'+12% Dmg, +15 HP', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'bz_prb', x:1320, y:410, type:'minor',   connections:['bz_lma','bz_cap'], name:'Relentless', desc:'+10% Dmg, +8% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseFireRateMult*=1.080; p.recomputeStats();}},
    {id:'bz_cap', x:1400, y:350, type:'keystone', connections:[], name:'Warmonger', desc:'+30% Dmg, +30 HP, 5% Life Steal', apply:(p)=>{p.baseDmgMult*=1.300; p.recomputeStats(); p.baseMaxHp+=30; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}},
  ]},
  // ── ASSASSIN ─────────────────────────────────────────────
  assassin: { nodes: [
    {id:'as0', x:60, y:350, type:'minor', origin:true, connections:['as_ta','as_ma','as_ba'], name:'Shadow Step', desc:'+5% Dodge, +5% Dmg', apply:(p)=>{p.baseDodge+=5; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'as_ta', x:160, y:220, type:'minor',   connections:['as0','as_t1'], name:'Venom Coat', desc:'+4% Crit', apply:(p)=>{p.baseCritChance+=4; p.recomputeStats();}},
    {id:'as_t1', x:270, y:150, type:'minor',   connections:['as_ta','as_t2'], name:'Toxic Edge I', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'as_t2', x:380, y:100, type:'minor',   connections:['as_t1','as_t3'], name:'Toxic Edge II', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'as_t3', x:490, y:70, type:'notable',  connections:['as_t2','as_t4','as_m3'], name:'Toxic Expertise', desc:'+8% Dmg, +8% Crit Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'as_t4', x:600, y:80, type:'ability',  connections:['as_t3','as_t5'], name:'Poison Blade', desc:'Unlock: Poison Blade', apply:(p)=>addAbilityToPlayer(p,'poisonBlade')},
    {id:'as_t5', x:710, y:80, type:'minor',   connections:['as_t4','as_t6'], name:'Venom Stack', desc:'+6% Dmg, +5% Crit', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'as_t6', x:820, y:80, type:'minor',   connections:['as_t5','as_t7'], name:'Lingering Toxin', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'as_t7', x:930, y:90, type:'notable',  connections:['as_t6','as_t8'], name:'Lethal Tempo', desc:'+15% Atk Speed, +6% Crit', apply:(p)=>{p.baseFireRateMult*=1.150; p.recomputeStats(); p.baseCritChance+=6; p.recomputeStats();}},
    {id:'as_t8', x:1040, y:80, type:'ability',  connections:['as_t7','as_lta'], name:'Death Blossom', desc:'Unlock: Death Blossom', apply:(p)=>addAbilityToPlayer(p,'deathBlossom')},
    {id:'as_t9', x:1150, y:90, type:'minor',   connections:['as_t8','as_ltb'], name:'Poison Cloud', desc:'+8% Dmg, +6% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=6; p.recomputeStats();}},
    {id:'as_ma', x:160, y:350, type:'minor',   connections:['as0','as_m1'], name:'Quick Draw', desc:'+8% Atk Speed', apply:(p)=>{p.baseFireRateMult*=1.080; p.recomputeStats();}},
    {id:'as_m1', x:270, y:310, type:'minor',   connections:['as_ma','as_m2'], name:'Combo Builder I', desc:'+5 Energy Max', apply:(p)=>{p.baseMaxResource+=5; p.recomputeStats();}},
    {id:'as_m2', x:380, y:350, type:'minor',   connections:['as_m1','as_m3'], name:'Combo Builder II', desc:'+5 Energy Max', apply:(p)=>{p.baseMaxResource+=5; p.recomputeStats();}},
    {id:'as_m3', x:490, y:320, type:'notable',  connections:['as_m2','as_t3','as_m4'], name:'Ghost Walk', desc:'+10% Dodge, +10% Dmg', apply:(p)=>{p.baseDodge+=10; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'as_m4', x:600, y:310, type:'ability',  connections:['as_m3','as_m5'], name:'Smoke Bomb', desc:'Unlock: Smoke Bomb', apply:(p)=>addAbilityToPlayer(p,'smokeBomb')},
    {id:'as_m5', x:710, y:320, type:'minor',   connections:['as_m4','as_m6'], name:'Shadow Weave', desc:'+6% Dmg, +5% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseFireRateMult*=1.050; p.recomputeStats();}},
    {id:'as_m6', x:820, y:310, type:'ability',  connections:['as_m5','as_m7'], name:'Shadow Clone', desc:'Unlock: Shadow Clone', apply:(p)=>addAbilityToPlayer(p,'shadowClone')},
    {id:'as_m7', x:930, y:330, type:'minor',   connections:['as_m6','as_m8'], name:'Twin Strikes', desc:'+7% Dmg, +6% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats(); p.baseFireRateMult*=1.060; p.recomputeStats();}},
    {id:'as_m8', x:1040, y:330, type:'notable',  connections:['as_m7','as_lma','as_lta'], name:'Blur', desc:'+12% Dodge, +10% Dmg', apply:(p)=>{p.baseDodge+=12; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'as_ba', x:160, y:480, type:'minor',   connections:['as0','as_b1'], name:'Blade Mastery', desc:'+6% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'as_b1', x:270, y:540, type:'minor',   connections:['as_ba','as_b2'], name:'Backstab I', desc:'+5% Crit, +4% Crit Dmg', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats(); p.baseCritDmg+=0.04; p.recomputeStats();}},
    {id:'as_b2', x:380, y:580, type:'minor',   connections:['as_b1','as_b3'], name:'Backstab II', desc:'+5% Crit, +4% Crit Dmg', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats(); p.baseCritDmg+=0.04; p.recomputeStats();}},
    {id:'as_b3', x:490, y:600, type:'notable',  connections:['as_b2','as_b4','as_m3'], name:'Death Mark', desc:'+10% Crit, +20% Crit Dmg', apply:(p)=>{p.baseCritChance+=10; p.recomputeStats(); p.baseCritDmg+=0.20; p.recomputeStats();}},
    {id:'as_b4', x:600, y:610, type:'ability',  connections:['as_b3','as_b5'], name:'Backstab', desc:'Unlock: Backstab', apply:(p)=>addAbilityToPlayer(p,'backstab')},
    {id:'as_b5', x:710, y:590, type:'minor',   connections:['as_b4','as_b6'], name:'Execute I', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'as_b6', x:820, y:580, type:'ability',  connections:['as_b5','as_b7'], name:'Shadow Strike', desc:'Unlock: Shadow Strike', apply:(p)=>addAbilityToPlayer(p,'shadowStrike')},
    {id:'as_b7', x:930, y:560, type:'minor',   connections:['as_b6','as_b8'], name:'Execute II', desc:'+8% Dmg, +5% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'as_b8', x:1040, y:560, type:'notable',  connections:['as_b7','as_lba','as_lma'], name:'Assassination', desc:'+12% Crit Dmg, +8% Dodge', apply:(p)=>{p.baseCritDmg+=0.12; p.recomputeStats(); p.baseDodge+=8; p.recomputeStats();}},
    {id:'as_lta', x:1160, y:160, type:'ability',  connections:['as_t9','as_lma'], name:'Death Mark', desc:'Unlock: Death Mark', apply:(p)=>addAbilityToPlayer(p,'deathMark')},
    {id:'as_ltb', x:1160, y:230, type:'ability',  connections:['as_t9','as_lma'], name:'Shadow Dance', desc:'Unlock: Shadow Dance', apply:(p)=>addAbilityToPlayer(p,'shadowDance')},
    {id:'as_lma', x:1230, y:340, type:'notable',  connections:['as_lta','as_ltb','as_m8','as_lba','as_cap'], name:'Phantom', desc:'+15% Dmg, +10% Dodge', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseDodge+=10; p.recomputeStats();}},
    {id:'as_lba', x:1160, y:500, type:'minor',   connections:['as_b8','as_lma'], name:'Dark Shroud', desc:'+10% Dodge, +8% Dmg', apply:(p)=>{p.baseDodge+=10; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'as_pra', x:1320, y:270, type:'minor',   connections:['as_lma','as_cap'], name:'Shadow Lord', desc:'+12% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'as_prb', x:1320, y:410, type:'minor',   connections:['as_lma','as_cap'], name:'Night\'s Edge', desc:'+10% Crit Dmg, +8% Dodge', apply:(p)=>{p.baseCritDmg+=0.10; p.recomputeStats(); p.baseDodge+=8; p.recomputeStats();}},
    {id:'as_cap', x:1400, y:350, type:'keystone', connections:[], name:'Shadow Realm', desc:'+25% Dmg, +50% Crit Dmg, +15% Dodge', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.baseCritDmg+=0.50; p.recomputeStats(); p.baseDodge+=15; p.recomputeStats();}},
  ]},
  // ── SORCERER ─────────────────────────────────────────────
  sorcerer: { nodes: [
    {id:'sz0', x:60, y:350, type:'minor', origin:true, connections:['sz_ta','sz_ma','sz_ba'], name:'Arcane Mind', desc:'+5% Dmg, +10 Mana', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'sz_ta', x:160, y:220, type:'minor',   connections:['sz0','sz_t1'], name:'Ember I', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'sz_t1', x:270, y:150, type:'minor',   connections:['sz_ta','sz_t2'], name:'Ember II', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'sz_t2', x:380, y:100, type:'minor',   connections:['sz_t1','sz_t3'], name:'Ignition', desc:'+6% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'sz_t3', x:490, y:70, type:'notable',  connections:['sz_t2','sz_t4','sz_m3'], name:'Pyromaniac', desc:'+10% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'sz_t4', x:600, y:80, type:'ability',  connections:['sz_t3','sz_t5'], name:'Fireball', desc:'Unlock: Fireball', apply:(p)=>addAbilityToPlayer(p,'fireball')},
    {id:'sz_t5', x:710, y:80, type:'minor',   connections:['sz_t4','sz_t6'], name:'Wildfire', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'sz_t6', x:820, y:80, type:'minor',   connections:['sz_t5','sz_t7'], name:'Inferno I', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sz_t7', x:930, y:90, type:'notable',  connections:['sz_t6','sz_t8'], name:'Combustion', desc:'+12% Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'sz_t8', x:1040, y:80, type:'ability',  connections:['sz_t7','sz_lta'], name:'Meteor', desc:'Unlock: Meteor', apply:(p)=>addAbilityToPlayer(p,'meteor')},
    {id:'sz_t9', x:1150, y:90, type:'minor',   connections:['sz_t8','sz_ltb'], name:'Star Fall', desc:'+10% Dmg, +6% Crit', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseCritChance+=6; p.recomputeStats();}},
    {id:'sz_ma', x:160, y:350, type:'minor',   connections:['sz0','sz_m1'], name:'Arcane Font', desc:'+10 Mana', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'sz_m1', x:270, y:310, type:'minor',   connections:['sz_ma','sz_m2'], name:'Frost Touch I', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'sz_m2', x:380, y:350, type:'minor',   connections:['sz_m1','sz_m3'], name:'Frost Touch II', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'sz_m3', x:490, y:320, type:'notable',  connections:['sz_m2','sz_t3','sz_m4'], name:'Shatter', desc:'+8% Dmg, +8% Crit Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'sz_m4', x:600, y:310, type:'ability',  connections:['sz_m3','sz_m5'], name:'Frost Nova', desc:'Unlock: Frost Nova', apply:(p)=>addAbilityToPlayer(p,'frostNova')},
    {id:'sz_m5', x:710, y:320, type:'minor',   connections:['sz_m4','sz_m6'], name:'Permafrost', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'sz_m6', x:820, y:310, type:'ability',  connections:['sz_m5','sz_m7'], name:'Blizzard', desc:'Unlock: Blizzard', apply:(p)=>addAbilityToPlayer(p,'blizzard')},
    {id:'sz_m7', x:930, y:330, type:'minor',   connections:['sz_m6','sz_m8'], name:'Deep Freeze', desc:'+6% Dmg, +5% Crit', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'sz_m8', x:1040, y:330, type:'notable',  connections:['sz_m7','sz_lma','sz_lta'], name:'Singularity Core', desc:'+12% Dmg, +15 Mana', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'sz_ba', x:160, y:480, type:'minor',   connections:['sz0','sz_b1'], name:'Static I', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'sz_b1', x:270, y:540, type:'minor',   connections:['sz_ba','sz_b2'], name:'Static II', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'sz_b2', x:380, y:580, type:'minor',   connections:['sz_b1','sz_b3'], name:'Chain Lightning I', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'sz_b3', x:490, y:600, type:'notable',  connections:['sz_b2','sz_b4','sz_m3'], name:'Voltaic', desc:'+8% Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'sz_b4', x:600, y:610, type:'ability',  connections:['sz_b3','sz_b5'], name:'Lightning Bolt', desc:'Unlock: Lightning Bolt', apply:(p)=>addAbilityToPlayer(p,'lightningBolt')},
    {id:'sz_b5', x:710, y:590, type:'minor',   connections:['sz_b4','sz_b6'], name:'Arc Flash', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'sz_b6', x:820, y:580, type:'ability',  connections:['sz_b5','sz_b7'], name:'Ball Lightning', desc:'Unlock: Ball Lightning', apply:(p)=>addAbilityToPlayer(p,'ballLightning')},
    {id:'sz_b7', x:930, y:560, type:'minor',   connections:['sz_b6','sz_b8'], name:'Overcharge', desc:'+8% Dmg, +6% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=6; p.recomputeStats();}},
    {id:'sz_b8', x:1040, y:560, type:'notable',  connections:['sz_b7','sz_lba','sz_lma'], name:'Glass Cannon', desc:'+20% Dmg, -8% Max HP', apply:(p)=>{p.baseDmgMult*=1.20; p.baseMaxHp=Math.max(1,p.baseMaxHp-8); p.recomputeStats();}},
    {id:'sz_lta', x:1160, y:160, type:'ability',  connections:['sz_t9','sz_lma'], name:'Arcane Surge', desc:'Unlock: Arcane Surge', apply:(p)=>addAbilityToPlayer(p,'arcaneSurge')},
    {id:'sz_ltb', x:1160, y:230, type:'ability',  connections:['sz_t9','sz_lma'], name:'Time Stop', desc:'Unlock: Time Stop', apply:(p)=>addAbilityToPlayer(p,'timeStop')},
    {id:'sz_lma', x:1230, y:340, type:'notable',  connections:['sz_lta','sz_ltb','sz_m8','sz_lba','sz_cap'], name:'Arcane Ascension', desc:'+15% Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'sz_lba', x:1160, y:500, type:'minor',   connections:['sz_b8','sz_lma'], name:'Void Conduit', desc:'+15% Dmg, +10 Mana', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'sz_pra', x:1320, y:270, type:'minor',   connections:['sz_lma','sz_cap'], name:'Arcane Mastery', desc:'+12% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'sz_prb', x:1320, y:410, type:'minor',   connections:['sz_lma','sz_cap'], name:'Reality Bend', desc:'+15% Dmg', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats();}},
    {id:'sz_cap', x:1400, y:350, type:'keystone', connections:[], name:'Singularity', desc:'+30% Dmg, +20% Crit, 20 Mana', apply:(p)=>{p.baseDmgMult*=1.300; p.recomputeStats(); p.baseCritChance+=20; p.recomputeStats(); p.baseMaxResource+=20; p.recomputeStats();}},
  ]},
  // ── TEMPLAR ──────────────────────────────────────────────
  templar: { nodes: [
    {id:'tp0', x:60, y:350, type:'minor', origin:true, connections:['tp_ta','tp_ma','tp_ba'], name:'Wind Stance', desc:'+5% Dmg, +5% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseFireRateMult*=1.050; p.recomputeStats();}},
    {id:'tp_ta', x:160, y:220, type:'minor',   connections:['tp0','tp_t1'], name:'Wind Step I', desc:'+5% Atk Speed', apply:(p)=>{p.baseFireRateMult*=1.050; p.recomputeStats();}},
    {id:'tp_t1', x:270, y:150, type:'minor',   connections:['tp_ta','tp_t2'], name:'Wind Step II', desc:'+5% Atk Speed', apply:(p)=>{p.baseFireRateMult*=1.050; p.recomputeStats();}},
    {id:'tp_t2', x:380, y:100, type:'minor',   connections:['tp_t1','tp_t3'], name:'Gale Force', desc:'+6% Atk Speed, +4% Dmg', apply:(p)=>{p.baseFireRateMult*=1.060; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'tp_t3', x:490, y:70, type:'notable',  connections:['tp_t2','tp_t4','tp_m3'], name:'Swift Strikes', desc:'+12% Atk Speed, +6% Dmg', apply:(p)=>{p.baseFireRateMult*=1.120; p.recomputeStats(); p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'tp_t4', x:600, y:80, type:'ability',  connections:['tp_t3','tp_t5'], name:'Dragon Kick', desc:'Unlock: Dragon Kick', apply:(p)=>addAbilityToPlayer(p,'dragonKick')},
    {id:'tp_t5', x:710, y:80, type:'minor',   connections:['tp_t4','tp_t6'], name:'Hurricane I', desc:'+7% Atk Speed', apply:(p)=>{p.baseFireRateMult*=1.070; p.recomputeStats();}},
    {id:'tp_t6', x:820, y:80, type:'minor',   connections:['tp_t5','tp_t7'], name:'Hurricane II', desc:'+7% Atk Speed, +5% Dmg', apply:(p)=>{p.baseFireRateMult*=1.070; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'tp_t7', x:930, y:90, type:'notable',  connections:['tp_t6','tp_t8'], name:'Transcendence', desc:'+15% Atk Speed, +8% Dmg', apply:(p)=>{p.baseFireRateMult*=1.150; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'tp_t8', x:1040, y:80, type:'ability',  connections:['tp_t7','tp_lta'], name:'Tempest Strike', desc:'Unlock: Tempest Strike', apply:(p)=>addAbilityToPlayer(p,'tempestStrike')},
    {id:'tp_t9', x:1150, y:90, type:'minor',   connections:['tp_t8','tp_ltb'], name:'Eye of the Storm', desc:'+10% Atk Speed, +6% Crit', apply:(p)=>{p.baseFireRateMult*=1.100; p.recomputeStats(); p.baseCritChance+=6; p.recomputeStats();}},
    {id:'tp_ma', x:160, y:350, type:'minor',   connections:['tp0','tp_m1'], name:'Chi Focus I', desc:'+8 Chi Max', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'tp_m1', x:270, y:310, type:'minor',   connections:['tp_ma','tp_m2'], name:'Chi Focus II', desc:'+8 Chi Max', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'tp_m2', x:380, y:350, type:'minor',   connections:['tp_m1','tp_m3'], name:'Inner Fire', desc:'+6% Dmg, +4% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseFireRateMult*=1.040; p.recomputeStats();}},
    {id:'tp_m3', x:490, y:320, type:'notable',  connections:['tp_m2','tp_t3','tp_m4'], name:'Chi Mastery', desc:'+10% Dmg, +12 Chi Max', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseMaxResource+=12; p.recomputeStats();}},
    {id:'tp_m4', x:600, y:310, type:'ability',  connections:['tp_m3','tp_m5'], name:'Iron Palm', desc:'Unlock: Iron Palm', apply:(p)=>addAbilityToPlayer(p,'ironPalm')},
    {id:'tp_m5', x:710, y:320, type:'minor',   connections:['tp_m4','tp_m6'], name:'Resonance I', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'tp_m6', x:820, y:310, type:'ability',  connections:['tp_m5','tp_m7'], name:'Divine Judgment', desc:'Unlock: Divine Judgment', apply:(p)=>addAbilityToPlayer(p,'divineJudgment')},
    {id:'tp_m7', x:930, y:330, type:'minor',   connections:['tp_m6','tp_m8'], name:'Chi Surge', desc:'+8% Dmg, +6% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseFireRateMult*=1.060; p.recomputeStats();}},
    {id:'tp_m8', x:1040, y:330, type:'notable',  connections:['tp_m7','tp_lma','tp_lta'], name:'Enlightened', desc:'+12% Dmg, +15 Chi Max', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'tp_ba', x:160, y:480, type:'minor',   connections:['tp0','tp_b1'], name:'Iron Guard I', desc:'+8 HP, +5 Armor', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseArmor+=5; p.recomputeStats();}},
    {id:'tp_b1', x:270, y:540, type:'minor',   connections:['tp_ba','tp_b2'], name:'Iron Guard II', desc:'+10 HP, +6 Armor', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats(); p.baseArmor+=6; p.recomputeStats();}},
    {id:'tp_b2', x:380, y:580, type:'minor',   connections:['tp_b1','tp_b3'], name:'Aegis I', desc:'+8 HP, +6 Armor', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseArmor+=6; p.recomputeStats();}},
    {id:'tp_b3', x:490, y:600, type:'notable',  connections:['tp_b2','tp_b4','tp_m3'], name:'Iron Body', desc:'+15 HP, +10 Armor', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats(); p.baseArmor+=10; p.recomputeStats();}},
    {id:'tp_b4', x:600, y:610, type:'ability',  connections:['tp_b3','tp_b5'], name:'Healing Palm', desc:'Unlock: Healing Palm', apply:(p)=>addAbilityToPlayer(p,'healingPalm')},
    {id:'tp_b5', x:710, y:590, type:'minor',   connections:['tp_b4','tp_b6'], name:'Restoration I', desc:'+2 Life on Kill', apply:(p)=>{p.lifeOnKill=(p.lifeOnKill||0)+2; p.recomputeStats();}},
    {id:'tp_b6', x:820, y:580, type:'ability',  connections:['tp_b5','tp_b7'], name:'Spirit Shield', desc:'Unlock: Spirit Shield', apply:(p)=>addAbilityToPlayer(p,'spiritShield')},
    {id:'tp_b7', x:930, y:560, type:'minor',   connections:['tp_b6','tp_b8'], name:'Restoration II', desc:'+12 HP, +2 Life on Kill', apply:(p)=>{p.baseMaxHp+=12; p.recomputeStats(); p.lifeOnKill=(p.lifeOnKill||0)+2; p.recomputeStats();}},
    {id:'tp_b8', x:1040, y:560, type:'notable',  connections:['tp_b7','tp_lba','tp_lma'], name:'Undying Resolve', desc:'+20 HP, +10 Armor', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=10; p.recomputeStats();}},
    {id:'tp_lta', x:1160, y:160, type:'ability',  connections:['tp_t9','tp_lma'], name:'Thousand Cuts', desc:'Unlock: Thousand Cuts', apply:(p)=>addAbilityToPlayer(p,'thousandCuts')},
    {id:'tp_ltb', x:1160, y:230, type:'ability',  connections:['tp_t9','tp_lma'], name:'Chi Explosion', desc:'Unlock: Chi Explosion', apply:(p)=>addAbilityToPlayer(p,'chiExplosion')},
    {id:'tp_lma', x:1230, y:340, type:'notable',  connections:['tp_lta','tp_ltb','tp_m8','tp_lba','tp_cap'], name:'Ascendant', desc:'+15% Dmg, +12% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseFireRateMult*=1.120; p.recomputeStats();}},
    {id:'tp_lba', x:1160, y:500, type:'minor',   connections:['tp_b8','tp_lma'], name:'Iron Fortress', desc:'+15 HP, +12 Armor', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats(); p.baseArmor+=12; p.recomputeStats();}},
    {id:'tp_pra', x:1320, y:270, type:'minor',   connections:['tp_lma','tp_cap'], name:'One Strike', desc:'+15% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'tp_prb', x:1320, y:410, type:'minor',   connections:['tp_lma','tp_cap'], name:'Steel Skin', desc:'+20 HP, +15 Armor', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=15; p.recomputeStats();}},
    {id:'tp_cap', x:1400, y:350, type:'keystone', connections:[], name:'Enlightenment', desc:'+25% Dmg, +25% Atk Spd, 20 HP', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.baseFireRateMult*=1.250; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats();}},
  ]},
  // ── CRUSADER ─────────────────────────────────────────────
  crusader: { nodes: [
    {id:'cr0', x:60, y:350, type:'minor', origin:true, connections:['cr_ta','cr_ma','cr_ba'], name:'Holy Vow', desc:'+5% Dmg, +8 HP', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'cr_ta', x:160, y:220, type:'minor',   connections:['cr0','cr_t1'], name:'Holy Fervor I', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'cr_t1', x:270, y:150, type:'minor',   connections:['cr_ta','cr_t2'], name:'Holy Fervor II', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'cr_t2', x:380, y:100, type:'minor',   connections:['cr_t1','cr_t3'], name:'Wrath Surge', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'cr_t3', x:490, y:70, type:'notable',  connections:['cr_t2','cr_t4','cr_m3'], name:'Righteous Fury', desc:'+8% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'cr_t4', x:600, y:80, type:'ability',  connections:['cr_t3','cr_t5'], name:'Holy Smite', desc:'Unlock: Holy Smite', apply:(p)=>addAbilityToPlayer(p,'holySmite')},
    {id:'cr_t5', x:710, y:80, type:'minor',   connections:['cr_t4','cr_t6'], name:'Divine Wrath', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'cr_t6', x:820, y:80, type:'minor',   connections:['cr_t5','cr_t7'], name:'Crusader\'s Call', desc:'+8% Dmg, +5% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'cr_t7', x:930, y:90, type:'notable',  connections:['cr_t6','cr_t8'], name:'Holy Warrior', desc:'+12% Dmg, +10 HP', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxHp+=10; p.recomputeStats();}},
    {id:'cr_t8', x:1040, y:80, type:'ability',  connections:['cr_t7','cr_lta'], name:'Divine Shield', desc:'Unlock: Divine Shield', apply:(p)=>addAbilityToPlayer(p,'divineShield')},
    {id:'cr_t9', x:1150, y:90, type:'minor',   connections:['cr_t8','cr_ltb'], name:'Aegis of Light', desc:'+10% Dmg, +10 HP', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseMaxHp+=10; p.recomputeStats();}},
    {id:'cr_ma', x:160, y:350, type:'minor',   connections:['cr0','cr_m1'], name:'Consecrate I', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'cr_m1', x:270, y:310, type:'minor',   connections:['cr_ma','cr_m2'], name:'Consecrate II', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'cr_m2', x:380, y:350, type:'minor',   connections:['cr_m1','cr_m3'], name:'Zeal I', desc:'+5% Dmg, +4% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseFireRateMult*=1.040; p.recomputeStats();}},
    {id:'cr_m3', x:490, y:320, type:'notable',  connections:['cr_m2','cr_t3','cr_m4'], name:'Sanctification', desc:'+8% Dmg, +8 HP', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'cr_m4', x:600, y:310, type:'ability',  connections:['cr_m3','cr_m5'], name:'Consecration', desc:'Unlock: Consecration', apply:(p)=>addAbilityToPlayer(p,'consecration')},
    {id:'cr_m5', x:710, y:320, type:'minor',   connections:['cr_m4','cr_m6'], name:'Holy Ground', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'cr_m6', x:820, y:310, type:'ability',  connections:['cr_m5','cr_m7'], name:'Crusader Charge', desc:'Unlock: Crusader Charge', apply:(p)=>addAbilityToPlayer(p,'crusaderCharge')},
    {id:'cr_m7', x:930, y:330, type:'minor',   connections:['cr_m6','cr_m8'], name:'Inquisitor', desc:'+8% Dmg, +6% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=6; p.recomputeStats();}},
    {id:'cr_m8', x:1040, y:330, type:'notable',  connections:['cr_m7','cr_lma','cr_lta'], name:'Blessed Fury', desc:'+12% Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'cr_ba', x:160, y:480, type:'minor',   connections:['cr0','cr_b1'], name:'Shield Wall I', desc:'+8 HP, +6 Armor', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseArmor+=6; p.recomputeStats();}},
    {id:'cr_b1', x:270, y:540, type:'minor',   connections:['cr_ba','cr_b2'], name:'Shield Wall II', desc:'+10 HP, +7 Armor', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats(); p.baseArmor+=7; p.recomputeStats();}},
    {id:'cr_b2', x:380, y:580, type:'minor',   connections:['cr_b1','cr_b3'], name:'Fortress I', desc:'+8 HP, +7 Armor', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseArmor+=7; p.recomputeStats();}},
    {id:'cr_b3', x:490, y:600, type:'notable',  connections:['cr_b2','cr_b4','cr_m3'], name:'Iron Bastion', desc:'+15 HP, +12 Armor', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats(); p.baseArmor+=12; p.recomputeStats();}},
    {id:'cr_b4', x:600, y:610, type:'ability',  connections:['cr_b3','cr_b5'], name:'Hammer of Justice', desc:'Unlock: Hammer of Justice', apply:(p)=>addAbilityToPlayer(p,'hammerOfJustice')},
    {id:'cr_b5', x:710, y:590, type:'minor',   connections:['cr_b4','cr_b6'], name:'Martyr', desc:'+3 Life on Kill', apply:(p)=>{p.lifeOnKill=(p.lifeOnKill||0)+3; p.recomputeStats();}},
    {id:'cr_b6', x:820, y:580, type:'ability',  connections:['cr_b5','cr_b7'], name:'Avenging Wrath', desc:'Unlock: Avenging Wrath', apply:(p)=>addAbilityToPlayer(p,'avengingWrath')},
    {id:'cr_b7', x:930, y:560, type:'minor',   connections:['cr_b6','cr_b8'], name:'Holy Bulwark', desc:'+12 HP, +8 Armor', apply:(p)=>{p.baseMaxHp+=12; p.recomputeStats(); p.baseArmor+=8; p.recomputeStats();}},
    {id:'cr_b8', x:1040, y:560, type:'notable',  connections:['cr_b7','cr_lba','cr_lma'], name:'Immortal', desc:'+20 HP, +15 Armor, +3 Life on Kill', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=15; p.recomputeStats(); p.lifeOnKill=(p.lifeOnKill||0)+3; p.recomputeStats();}},
    {id:'cr_lta', x:1160, y:160, type:'ability',  connections:['cr_t9','cr_lma'], name:'Holy Nova', desc:'Unlock: Holy Nova', apply:(p)=>addAbilityToPlayer(p,'holyNova')},
    {id:'cr_ltb', x:1160, y:230, type:'ability',  connections:['cr_t9','cr_lma'], name:'Crusader\'s Oath', desc:'Unlock: Crusader\'s Oath', apply:(p)=>addAbilityToPlayer(p,'crusadersOath')},
    {id:'cr_lma', x:1230, y:340, type:'notable',  connections:['cr_lta','cr_ltb','cr_m8','cr_lba','cr_cap'], name:'Paragon', desc:'+15% Dmg, +15 HP', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'cr_lba', x:1160, y:500, type:'minor',   connections:['cr_b8','cr_lma'], name:'Stalwart', desc:'+15 HP, +12 Armor', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats(); p.baseArmor+=12; p.recomputeStats();}},
    {id:'cr_pra', x:1320, y:270, type:'minor',   connections:['cr_lma','cr_cap'], name:'Divine Crusade', desc:'+12% Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'cr_prb', x:1320, y:410, type:'minor',   connections:['cr_lma','cr_cap'], name:'Inviolate', desc:'+20 HP, +15 Armor', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=15; p.recomputeStats();}},
    {id:'cr_cap', x:1400, y:350, type:'keystone', connections:[], name:'Eternal Crusade', desc:'+25% Dmg, +30 HP, +20 Armor', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.baseMaxHp+=30; p.recomputeStats(); p.baseArmor+=20; p.recomputeStats();}},
  ]},
  // ── DRUID ────────────────────────────────────────────────
  druid: { nodes: [
    {id:'dr0', x:60, y:350, type:'minor', origin:true, connections:['dr_ta','dr_ma','dr_ba'], name:'Primal Bond', desc:'+5% Dmg, +8 Spirit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'dr_ta', x:160, y:220, type:'minor',   connections:['dr0','dr_t1'], name:'Storm Call I', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'dr_t1', x:270, y:150, type:'minor',   connections:['dr_ta','dr_t2'], name:'Storm Call II', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'dr_t2', x:380, y:100, type:'minor',   connections:['dr_t1','dr_t3'], name:'Lightning Rod', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'dr_t3', x:490, y:70, type:'notable',  connections:['dr_t2','dr_t4','dr_m3'], name:'Tempest', desc:'+10% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'dr_t4', x:600, y:80, type:'ability',  connections:['dr_t3','dr_t5'], name:'Hurricane Force', desc:'Unlock: Hurricane Force', apply:(p)=>addAbilityToPlayer(p,'hurricaneForce')},
    {id:'dr_t5', x:710, y:80, type:'minor',   connections:['dr_t4','dr_t6'], name:'Gale Strike', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'dr_t6', x:820, y:80, type:'minor',   connections:['dr_t5','dr_t7'], name:'Sky Wrath', desc:'+8% Dmg, +5% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'dr_t7', x:930, y:90, type:'notable',  connections:['dr_t6','dr_t8'], name:'Stormborn', desc:'+12% Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'dr_t8', x:1040, y:80, type:'ability',  connections:['dr_t7','dr_lta'], name:'Call Lightning', desc:'Unlock: Call Lightning', apply:(p)=>addAbilityToPlayer(p,'callLightning')},
    {id:'dr_t9', x:1150, y:90, type:'minor',   connections:['dr_t8','dr_ltb'], name:'Sky Dominion', desc:'+10% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'dr_ma', x:160, y:350, type:'minor',   connections:['dr0','dr_m1'], name:'Wild Heart I', desc:'+8 Spirit Max', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'dr_m1', x:270, y:310, type:'minor',   connections:['dr_ma','dr_m2'], name:'Wild Heart II', desc:'+8 Spirit Max', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'dr_m2', x:380, y:350, type:'minor',   connections:['dr_m1','dr_m3'], name:'Nature\'s Grasp', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'dr_m3', x:490, y:320, type:'notable',  connections:['dr_m2','dr_t3','dr_m4'], name:'Primal Fury', desc:'+10% Dmg, +12 Spirit Max', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseMaxResource+=12; p.recomputeStats();}},
    {id:'dr_m4', x:600, y:310, type:'ability',  connections:['dr_m3','dr_m5'], name:'Thornwall', desc:'Unlock: Thornwall', apply:(p)=>addAbilityToPlayer(p,'thornwall')},
    {id:'dr_m5', x:710, y:320, type:'minor',   connections:['dr_m4','dr_m6'], name:'Vine Grasp', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'dr_m6', x:820, y:310, type:'ability',  connections:['dr_m5','dr_m7'], name:'Wild Shift', desc:'Unlock: Wild Shift', apply:(p)=>addAbilityToPlayer(p,'wildShift')},
    {id:'dr_m7', x:930, y:330, type:'minor',   connections:['dr_m6','dr_m8'], name:'Feral Rush', desc:'+8% Dmg, +5% Atk Spd', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseFireRateMult*=1.050; p.recomputeStats();}},
    {id:'dr_m8', x:1040, y:330, type:'notable',  connections:['dr_m7','dr_lma','dr_lta'], name:'Apex Predator', desc:'+12% Dmg, +10 Spirit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'dr_ba', x:160, y:480, type:'minor',   connections:['dr0','dr_b1'], name:'Bark Skin I', desc:'+8 HP, +5 Armor', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseArmor+=5; p.recomputeStats();}},
    {id:'dr_b1', x:270, y:540, type:'minor',   connections:['dr_ba','dr_b2'], name:'Bark Skin II', desc:'+10 HP, +6 Armor', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats(); p.baseArmor+=6; p.recomputeStats();}},
    {id:'dr_b2', x:380, y:580, type:'minor',   connections:['dr_b1','dr_b3'], name:'Earthen Wall', desc:'+8 HP, +7 Armor', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseArmor+=7; p.recomputeStats();}},
    {id:'dr_b3', x:490, y:600, type:'notable',  connections:['dr_b2','dr_b4','dr_m3'], name:'Nature\'s Shield', desc:'+15 HP, +10 Armor', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats(); p.baseArmor+=10; p.recomputeStats();}},
    {id:'dr_b4', x:600, y:610, type:'ability',  connections:['dr_b3','dr_b5'], name:'Entangling Roots', desc:'Unlock: Entangling Roots', apply:(p)=>addAbilityToPlayer(p,'entanglingRoots')},
    {id:'dr_b5', x:710, y:590, type:'minor',   connections:['dr_b4','dr_b6'], name:'Regrowth I', desc:'+3% Life Steal', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'dr_b6', x:820, y:580, type:'ability',  connections:['dr_b5','dr_b7'], name:'Summon Wolf', desc:'Unlock: Summon Wolf', apply:(p)=>addAbilityToPlayer(p,'summonWolf')},
    {id:'dr_b7', x:930, y:560, type:'minor',   connections:['dr_b6','dr_b8'], name:'Pack Bond', desc:'+12 HP, +2 Life on Kill', apply:(p)=>{p.baseMaxHp+=12; p.recomputeStats(); p.lifeOnKill=(p.lifeOnKill||0)+2; p.recomputeStats();}},
    {id:'dr_b8', x:1040, y:560, type:'notable',  connections:['dr_b7','dr_lba','dr_lma'], name:'Ancient Grove', desc:'+20 HP, +12 Armor', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=12; p.recomputeStats();}},
    {id:'dr_lta', x:1160, y:160, type:'ability',  connections:['dr_t9','dr_lma'], name:'Solar Beam', desc:'Unlock: Solar Beam', apply:(p)=>addAbilityToPlayer(p,'solarBeam')},
    {id:'dr_ltb', x:1160, y:230, type:'ability',  connections:['dr_t9','dr_lma'], name:'Nature\'s Wrath', desc:'Unlock: Nature\'s Wrath', apply:(p)=>addAbilityToPlayer(p,'naturesWrath')},
    {id:'dr_lma', x:1230, y:340, type:'notable',  connections:['dr_lta','dr_ltb','dr_m8','dr_lba','dr_cap'], name:'World Tree', desc:'+15% Dmg, +15 HP', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'dr_lba', x:1160, y:500, type:'minor',   connections:['dr_b8','dr_lma'], name:'Ancient Power', desc:'+15 HP, +5% Life Steal', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}},
    {id:'dr_pra', x:1320, y:270, type:'minor',   connections:['dr_lma','dr_cap'], name:'Primal Storm', desc:'+12% Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'dr_prb', x:1320, y:410, type:'minor',   connections:['dr_lma','dr_cap'], name:'Ironbark', desc:'+20 HP, +15 Armor', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=15; p.recomputeStats();}},
    {id:'dr_cap', x:1400, y:350, type:'keystone', connections:[], name:'World Tree', desc:'+25% Dmg, +25 HP, +15 Armor', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.baseMaxHp+=25; p.recomputeStats(); p.baseArmor+=15; p.recomputeStats();}},
  ]},
  // ── AMAZONIAN ────────────────────────────────────────────
  amazonian: { nodes: [
    {id:'az0', x:60, y:350, type:'minor', origin:true, connections:['az_ta','az_ma','az_ba'], name:'Huntress', desc:'+5% Dmg, +5% Dodge', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseDodge+=5; p.recomputeStats();}},
    {id:'az_ta', x:160, y:220, type:'minor',   connections:['az0','az_t1'], name:'Javelin Art I', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'az_t1', x:270, y:150, type:'minor',   connections:['az_ta','az_t2'], name:'Javelin Art II', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'az_t2', x:380, y:100, type:'minor',   connections:['az_t1','az_t3'], name:'Power Throw I', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'az_t3', x:490, y:70, type:'notable',  connections:['az_t2','az_t4','az_m3'], name:'Warlady', desc:'+8% Dmg, +6% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=6; p.recomputeStats();}},
    {id:'az_t4', x:600, y:80, type:'ability',  connections:['az_t3','az_t5'], name:'Fury Throw', desc:'Unlock: Fury Throw', apply:(p)=>addAbilityToPlayer(p,'furyThrow')},
    {id:'az_t5', x:710, y:80, type:'minor',   connections:['az_t4','az_t6'], name:'Thunder Arm I', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'az_t6', x:820, y:80, type:'minor',   connections:['az_t5','az_t7'], name:'Thunder Arm II', desc:'+8% Dmg, +5% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'az_t7', x:930, y:90, type:'notable',  connections:['az_t6','az_t8'], name:'Storm Throw', desc:'+12% Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'az_t8', x:1040, y:80, type:'ability',  connections:['az_t7','az_lta'], name:'Lightning Spear', desc:'Unlock: Lightning Spear', apply:(p)=>addAbilityToPlayer(p,'lightningSpear')},
    {id:'az_t9', x:1150, y:90, type:'minor',   connections:['az_t8','az_ltb'], name:'Amazon\'s Will', desc:'+10% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'az_ma', x:160, y:350, type:'minor',   connections:['az0','az_m1'], name:'Spirit Charge I', desc:'+8 Spirit Charge Max', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'az_m1', x:270, y:310, type:'minor',   connections:['az_ma','az_m2'], name:'Spirit Charge II', desc:'+8 Spirit Charge Max', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'az_m2', x:380, y:350, type:'minor',   connections:['az_m1','az_m3'], name:'Fleet of Foot I', desc:'+6% Dodge, +4% Dmg', apply:(p)=>{p.baseDodge+=6; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'az_m3', x:490, y:320, type:'notable',  connections:['az_m2','az_t3','az_m4'], name:'Apex Predator', desc:'+10% Dmg, +8% Dodge', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseDodge+=8; p.recomputeStats();}},
    {id:'az_m4', x:600, y:310, type:'ability',  connections:['az_m3','az_m5'], name:'Spirit Bond', desc:'Unlock: Spirit Bond', apply:(p)=>addAbilityToPlayer(p,'spiritBond')},
    {id:'az_m5', x:710, y:320, type:'minor',   connections:['az_m4','az_m6'], name:'Spirit Rush I', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'az_m6', x:820, y:310, type:'ability',  connections:['az_m5','az_m7'], name:'War Cry', desc:'Unlock: War Cry', apply:(p)=>addAbilityToPlayer(p,'warCry')},
    {id:'az_m7', x:930, y:330, type:'minor',   connections:['az_m6','az_m8'], name:'Amazon Pride', desc:'+8% Dmg, +6% Dodge', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseDodge+=6; p.recomputeStats();}},
    {id:'az_m8', x:1040, y:330, type:'notable',  connections:['az_m7','az_lma','az_lta'], name:'Spirit Apex', desc:'+12% Dmg, +10% Dodge', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseDodge+=10; p.recomputeStats();}},
    {id:'az_ba', x:160, y:480, type:'minor',   connections:['az0','az_b1'], name:'Venom Tip I', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'az_b1', x:270, y:540, type:'minor',   connections:['az_ba','az_b2'], name:'Venom Tip II', desc:'+5% Crit', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats();}},
    {id:'az_b2', x:380, y:580, type:'minor',   connections:['az_b1','az_b3'], name:'Hunter\'s Mark I', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'az_b3', x:490, y:600, type:'notable',  connections:['az_b2','az_b4','az_m3'], name:'Pack Hunter', desc:'+8% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'az_b4', x:600, y:610, type:'ability',  connections:['az_b3','az_b5'], name:'Multishot', desc:'Unlock: Multishot', apply:(p)=>addAbilityToPlayer(p,'multishot')},
    {id:'az_b5', x:710, y:590, type:'minor',   connections:['az_b4','az_b6'], name:'Venom Cloud', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'az_b6', x:820, y:580, type:'ability',  connections:['az_b5','az_b7'], name:'Rain of Spears', desc:'Unlock: Rain of Spears', apply:(p)=>addAbilityToPlayer(p,'rainOfSpears')},
    {id:'az_b7', x:930, y:560, type:'minor',   connections:['az_b6','az_b8'], name:'Predator\'s Eye', desc:'+8% Crit, +5% Dodge', apply:(p)=>{p.baseCritChance+=8; p.recomputeStats(); p.baseDodge+=5; p.recomputeStats();}},
    {id:'az_b8', x:1040, y:560, type:'notable',  connections:['az_b7','az_lba','az_lma'], name:'Death Hunt', desc:'+12% Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'az_lta', x:1160, y:160, type:'ability',  connections:['az_t9','az_lma'], name:'Thunderstrike', desc:'Unlock: Thunderstrike', apply:(p)=>addAbilityToPlayer(p,'thunderstrike')},
    {id:'az_ltb', x:1160, y:230, type:'ability',  connections:['az_t9','az_lma'], name:'Eagle Strike', desc:'Unlock: Eagle Strike', apply:(p)=>addAbilityToPlayer(p,'eagleStrike')},
    {id:'az_lma', x:1230, y:340, type:'notable',  connections:['az_lta','az_ltb','az_m8','az_lba','az_cap'], name:'Apex Predator Lord', desc:'+15% Dmg, +12% Dodge', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseDodge+=12; p.recomputeStats();}},
    {id:'az_lba', x:1160, y:500, type:'minor',   connections:['az_b8','az_lma'], name:'Jungle Queen', desc:'+12% Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'az_pra', x:1320, y:270, type:'minor',   connections:['az_lma','az_cap'], name:'Battle Queen', desc:'+12% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'az_prb', x:1320, y:410, type:'minor',   connections:['az_lma','az_cap'], name:'Predator\'s Grace', desc:'+12% Dodge, +8% Dmg', apply:(p)=>{p.baseDodge+=12; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'az_cap', x:1400, y:350, type:'keystone', connections:[], name:'Apex Predator', desc:'+25% Dmg, +20% Crit, +15% Dodge', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.baseCritChance+=20; p.recomputeStats(); p.baseDodge+=15; p.recomputeStats();}},
  ]},
  // ── SHAMAN ───────────────────────────────────────────────
  shaman: { nodes: [
    {id:'sh0', x:60, y:350, type:'minor', origin:true, connections:['sh_ta','sh_ma','sh_ba'], name:'Spirit Caller', desc:'+5% Dmg, +8 Mojo', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'sh_ta', x:160, y:220, type:'minor',   connections:['sh0','sh_t1'], name:'Hex Brand I', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'sh_t1', x:270, y:150, type:'minor',   connections:['sh_ta','sh_t2'], name:'Hex Brand II', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'sh_t2', x:380, y:100, type:'minor',   connections:['sh_t1','sh_t3'], name:'Dark Curse I', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'sh_t3', x:490, y:70, type:'notable',  connections:['sh_t2','sh_t4','sh_m3'], name:'Voodoo Master', desc:'+8% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'sh_t4', x:600, y:80, type:'ability',  connections:['sh_t3','sh_t5'], name:'Hex Bolt', desc:'Unlock: Hex Bolt', apply:(p)=>addAbilityToPlayer(p,'hexBolt')},
    {id:'sh_t5', x:710, y:80, type:'minor',   connections:['sh_t4','sh_t6'], name:'Shadow Hex', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'sh_t6', x:820, y:80, type:'minor',   connections:['sh_t5','sh_t7'], name:'Mass Hex I', desc:'+8% Dmg, +5% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'sh_t7', x:930, y:90, type:'notable',  connections:['sh_t6','sh_t8'], name:'Death Hex', desc:'+12% Dmg, +10% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'sh_t8', x:1040, y:80, type:'ability',  connections:['sh_t7','sh_lta'], name:'Mass Hex', desc:'Unlock: Mass Hex', apply:(p)=>addAbilityToPlayer(p,'massHex')},
    {id:'sh_t9', x:1150, y:90, type:'minor',   connections:['sh_t8','sh_ltb'], name:'Doom Curse', desc:'+10% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'sh_ma', x:160, y:350, type:'minor',   connections:['sh0','sh_m1'], name:'Mojo Well I', desc:'+8 Mojo Max', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'sh_m1', x:270, y:310, type:'minor',   connections:['sh_ma','sh_m2'], name:'Mojo Well II', desc:'+8 Mojo Max', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'sh_m2', x:380, y:350, type:'minor',   connections:['sh_m1','sh_m3'], name:'Totem Craft I', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'sh_m3', x:490, y:320, type:'notable',  connections:['sh_m2','sh_t3','sh_m4'], name:'Ancestral Power', desc:'+10% Dmg, +12 Mojo', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseMaxResource+=12; p.recomputeStats();}},
    {id:'sh_m4', x:600, y:310, type:'ability',  connections:['sh_m3','sh_m5'], name:'Spirit Totem', desc:'Unlock: Spirit Totem', apply:(p)=>addAbilityToPlayer(p,'spiritTotem')},
    {id:'sh_m5', x:710, y:320, type:'minor',   connections:['sh_m4','sh_m6'], name:'Totem Link', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'sh_m6', x:820, y:310, type:'ability',  connections:['sh_m5','sh_m7'], name:'Lava Burst', desc:'Unlock: Lava Burst', apply:(p)=>addAbilityToPlayer(p,'lavaBurst')},
    {id:'sh_m7', x:930, y:330, type:'minor',   connections:['sh_m6','sh_m8'], name:'Mojo Surge', desc:'+8% Dmg, +6 Mojo', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseMaxResource+=6; p.recomputeStats();}},
    {id:'sh_m8', x:1040, y:330, type:'notable',  connections:['sh_m7','sh_lma','sh_lta'], name:'Ancestral Fury', desc:'+12% Dmg, +15 Mojo', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'sh_ba', x:160, y:480, type:'minor',   connections:['sh0','sh_b1'], name:'Poison Brew I', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'sh_b1', x:270, y:540, type:'minor',   connections:['sh_ba','sh_b2'], name:'Poison Brew II', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'sh_b2', x:380, y:580, type:'minor',   connections:['sh_b1','sh_b3'], name:'Nature\'s Venom I', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'sh_b3', x:490, y:600, type:'notable',  connections:['sh_b2','sh_b4','sh_m3'], name:'Venomancer', desc:'+8% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'sh_b4', x:600, y:610, type:'ability',  connections:['sh_b3','sh_b5'], name:'Poison Spray', desc:'Unlock: Poison Spray', apply:(p)=>addAbilityToPlayer(p,'poisonSpray')},
    {id:'sh_b5', x:710, y:590, type:'minor',   connections:['sh_b4','sh_b6'], name:'Swamp Hex', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'sh_b6', x:820, y:580, type:'ability',  connections:['sh_b5','sh_b7'], name:'Chain Lightning', desc:'Unlock: Chain Lightning', apply:(p)=>addAbilityToPlayer(p,'chainLightning')},
    {id:'sh_b7', x:930, y:560, type:'minor',   connections:['sh_b6','sh_b8'], name:'Storm Totem', desc:'+8% Dmg, +6% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=6; p.recomputeStats();}},
    {id:'sh_b8', x:1040, y:560, type:'notable',  connections:['sh_b7','sh_lba','sh_lma'], name:'Witch Doctor', desc:'+12% Dmg, +10 Mojo', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'sh_lta', x:1160, y:160, type:'ability',  connections:['sh_t9','sh_lma'], name:'Earthquake', desc:'Unlock: Earthquake', apply:(p)=>addAbilityToPlayer(p,'earthquake')},
    {id:'sh_ltb', x:1160, y:230, type:'ability',  connections:['sh_t9','sh_lma'], name:'Soul Rend', desc:'Unlock: Soul Rend', apply:(p)=>addAbilityToPlayer(p,'soulRend')},
    {id:'sh_lma', x:1230, y:340, type:'notable',  connections:['sh_lta','sh_ltb','sh_m8','sh_lba','sh_cap'], name:'Grand Shaman', desc:'+15% Dmg, +15 Mojo', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'sh_lba', x:1160, y:500, type:'minor',   connections:['sh_b8','sh_lma'], name:'Dark Ritual', desc:'+15% Dmg, +5% Life Steal', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}},
    {id:'sh_pra', x:1320, y:270, type:'minor',   connections:['sh_lma','sh_cap'], name:'Spirit Walk', desc:'+12% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'sh_prb', x:1320, y:410, type:'minor',   connections:['sh_lma','sh_cap'], name:'Voodoo Ascent', desc:'+12% Dmg, +10 Mojo', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'sh_cap', x:1400, y:350, type:'keystone', connections:[], name:'Ancestral Fury', desc:'+25% Dmg, +20% Crit, +20 Mojo', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.baseCritChance+=20; p.recomputeStats(); p.baseMaxResource+=20; p.recomputeStats();}},
  ]},
  // ── NECROMANCER ──────────────────────────────────────────
  necromancer: { nodes: [
    {id:'nc0', x:60, y:350, type:'minor', origin:true, connections:['nc_ta','nc_ma','nc_ba'], name:'Dark Pact', desc:'+5% Dmg, +8 Necrotic Power', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'nc_ta', x:160, y:220, type:'minor',   connections:['nc0','nc_t1'], name:'Bone Shard I', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'nc_t1', x:270, y:150, type:'minor',   connections:['nc_ta','nc_t2'], name:'Bone Shard II', desc:'+5% Dmg, +4% Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'nc_t2', x:380, y:100, type:'minor',   connections:['nc_t1','nc_t3'], name:'Bone Wall', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'nc_t3', x:490, y:70, type:'notable',  connections:['nc_t2','nc_t4','nc_m3'], name:'Ossification', desc:'+8% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'nc_t4', x:600, y:80, type:'ability',  connections:['nc_t3','nc_t5'], name:'Bone Spear', desc:'Unlock: Bone Spear', apply:(p)=>addAbilityToPlayer(p,'boneSpear')},
    {id:'nc_t5', x:710, y:80, type:'minor',   connections:['nc_t4','nc_t6'], name:'Marrow Drain', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'nc_t6', x:820, y:80, type:'minor',   connections:['nc_t5','nc_t7'], name:'Bone Armor I', desc:'+8 HP, +6 Armor', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseArmor+=6; p.recomputeStats();}},
    {id:'nc_t7', x:930, y:90, type:'notable',  connections:['nc_t6','nc_t8'], name:'Skeletal Lord', desc:'+12% Dmg, +10 HP', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxHp+=10; p.recomputeStats();}},
    {id:'nc_t8', x:1040, y:80, type:'ability',  connections:['nc_t7','nc_lta'], name:'Bone Prison', desc:'Unlock: Bone Prison', apply:(p)=>addAbilityToPlayer(p,'bonePrison')},
    {id:'nc_t9', x:1150, y:90, type:'minor',   connections:['nc_t8','nc_ltb'], name:'Death\'s Hand', desc:'+10% Dmg, +8 HP', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'nc_ma', x:160, y:350, type:'minor',   connections:['nc0','nc_m1'], name:'Dark Energy I', desc:'+8 Necrotic Power', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'nc_m1', x:270, y:310, type:'minor',   connections:['nc_ma','nc_m2'], name:'Dark Energy II', desc:'+8 Necrotic Power', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'nc_m2', x:380, y:350, type:'minor',   connections:['nc_m1','nc_m3'], name:'Undead Mastery I', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'nc_m3', x:490, y:320, type:'notable',  connections:['nc_m2','nc_t3','nc_m4'], name:'Lich\'s Power', desc:'+10% Dmg, +12 Necrotic', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseMaxResource+=12; p.recomputeStats();}},
    {id:'nc_m4', x:600, y:310, type:'ability',  connections:['nc_m3','nc_m5'], name:'Raise Skeleton', desc:'Unlock: Raise Skeleton', apply:(p)=>addAbilityToPlayer(p,'raiseSkeleton')},
    {id:'nc_m5', x:710, y:320, type:'minor',   connections:['nc_m4','nc_m6'], name:'Corpse Shield', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'nc_m6', x:820, y:310, type:'ability',  connections:['nc_m5','nc_m7'], name:'Corpse Explosion', desc:'Unlock: Corpse Explosion', apply:(p)=>addAbilityToPlayer(p,'corpseExplosion')},
    {id:'nc_m7', x:930, y:330, type:'minor',   connections:['nc_m6','nc_m8'], name:'Death Shroud', desc:'+8% Dmg, +6 HP', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseMaxHp+=6; p.recomputeStats();}},
    {id:'nc_m8', x:1040, y:330, type:'notable',  connections:['nc_m7','nc_lma','nc_lta'], name:'Death Mastery', desc:'+12% Dmg, +15 Necrotic', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'nc_ba', x:160, y:480, type:'minor',   connections:['nc0','nc_b1'], name:'Blood Rite I', desc:'+5% Dmg, +3% Life Steal', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'nc_b1', x:270, y:540, type:'minor',   connections:['nc_ba','nc_b2'], name:'Blood Rite II', desc:'+5% Life Steal', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}},
    {id:'nc_b2', x:380, y:580, type:'minor',   connections:['nc_b1','nc_b3'], name:'Corruption I', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'nc_b3', x:490, y:600, type:'notable',  connections:['nc_b2','nc_b4','nc_m3'], name:'Blood Pact', desc:'+8% Dmg, +5% Life Steal', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}},
    {id:'nc_b4', x:600, y:610, type:'ability',  connections:['nc_b3','nc_b5'], name:'Death Coil', desc:'Unlock: Death Coil', apply:(p)=>addAbilityToPlayer(p,'deathCoil')},
    {id:'nc_b5', x:710, y:590, type:'minor',   connections:['nc_b4','nc_b6'], name:'Grave Chill', desc:'+7% Dmg', apply:(p)=>{p.baseDmgMult*=1.070; p.recomputeStats();}},
    {id:'nc_b6', x:820, y:580, type:'ability',  connections:['nc_b5','nc_b7'], name:'Soul Harvest', desc:'Unlock: Soul Harvest', apply:(p)=>addAbilityToPlayer(p,'soulHarvest')},
    {id:'nc_b7', x:930, y:560, type:'minor',   connections:['nc_b6','nc_b8'], name:'Lichfire', desc:'+8% Dmg, +6% Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=6; p.recomputeStats();}},
    {id:'nc_b8', x:1040, y:560, type:'notable',  connections:['nc_b7','nc_lba','nc_lma'], name:'Death Aura', desc:'+12% Dmg, +8% Life Steal', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.080; p.recomputeStats();}},
    {id:'nc_lta', x:1160, y:160, type:'ability',  connections:['nc_t9','nc_lma'], name:'Plague', desc:'Unlock: Plague', apply:(p)=>addAbilityToPlayer(p,'plague')},
    {id:'nc_ltb', x:1160, y:230, type:'ability',  connections:['nc_t9','nc_lma'], name:'Army of Darkness', desc:'Unlock: Army of Darkness', apply:(p)=>addAbilityToPlayer(p,'armyOfDarkness')},
    {id:'nc_lma', x:1230, y:340, type:'notable',  connections:['nc_lta','nc_ltb','nc_m8','nc_lba','nc_cap'], name:'Lich King', desc:'+15% Dmg, +12 HP', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxHp+=12; p.recomputeStats();}},
    {id:'nc_lba', x:1160, y:500, type:'minor',   connections:['nc_b8','nc_lma'], name:'Undying', desc:'+5% Life Steal, +15 HP', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats(); p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'nc_pra', x:1320, y:270, type:'minor',   connections:['nc_lma','nc_cap'], name:'Necrotic Lord', desc:'+12% Dmg, +8% Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'nc_prb', x:1320, y:410, type:'minor',   connections:['nc_lma','nc_cap'], name:'Death\'s Embrace', desc:'+8% Life Steal, +12 HP', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.080; p.recomputeStats(); p.baseMaxHp+=12; p.recomputeStats();}},
    {id:'nc_cap', x:1400, y:350, type:'keystone', connections:[], name:'Necrotic Apocalypse', desc:'+25% Dmg, +8% Life Steal, +20 HP', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.080; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats();}},
  ]},
};
