...
const TALENT_TREES = {
  ...
  ranger: { nodes: [
    ...
    {id:'r_ta1', x:690, y:310, type:'ability',  connections:['r_t6','r_tn','r_tka'], name:'Trueshot', desc:'Unlock: Trueshot', apply:(p)=>addAbilityToPlayer(p,'trueshot')},
    ...
    {id:'r_ma2', x:690, y:700, type:'ability',  connections:['r_mn','r_m6'], name:'Arrow Volley', desc:'Unlock: Arrow Volley', apply:(p)=>addAbilityToPlayer(p,'arrowVolley')},
    {id:'r_ba', x:200, y:880, type:'minor',   connections:['r0','r_b1'], name:'Iron Stride', desc:'+8 HP', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'r_b1', x:320, y:1030, type:'minor',   connections:['r_ba','r_b2','r_bn'], name:'Iron Stride II', desc:'+8 HP, +4% Dodge', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseDodge+=4; p.recomputeStats();}},
    ...
    {id:'r_b2', x:390, y:1050, type:'minor',   connections:['r_b1','r_bn','r_b3'], name:'Forest Guard', desc:'+5% Dodge', apply:(p)=>{p.baseDodge+=5; p.recomputeStats();}},
    {id:'r_b3', x:530, y:1060, type:'minor',   connections:['r_b2','r_bn','r_b4'], name:'Camouflage', desc:'+5% Dodge, +5% Dmg', apply:(p)=>{p.baseDodge+=5; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    ...
    {id:'r_bka', x:850, y:1060, type:'keystone', connections:['r_b7','r_mb2'], name:'Ranger Resilience', desc:'+30 HP, +10 Armor, +5% Dodge', apply:(p)=>{p.baseMaxHp+=30; p.recomputeStats(); p.baseArmor+=10; p.recomputeStats(); p.baseDodge+=5; p.recomputeStats();}},
    ...
    {id:'r_lta', x:1160, y:360, type:'ability',  connections:['r_mb1','r_lt1'], name:'Storm of Arrows', desc:'Unlock: Storm of Arrows', apply:(p)=>addAbilityToPlayer(p,'stormOfArrows')},
    ...
    {id:'r_lba', x:1160, y:1040, type:'ability',  connections:['r_mb2','r_lb1'], name:'Marked for Death', desc:'Unlock: Marked for Death', apply:(p)=>addAbilityToPlayer(p,'markedForDeath')},
    ...
    {id:'r_lbn', x:1410, y:990, type:'notable',  connections:['r_lb1','r_lb2','r_lb3','r_lma'], name:'Predator Mark', desc:'+15% Dmg, +5% Dodge', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseDodge+=5; p.recomputeStats();}},
    {id:'r_lb2', x:1340, y:1090, type:'minor',   connections:['r_lb1','r_lbn','r_lb3'], name:'Shadow Track', desc:'+6% Dodge', apply:(p)=>{p.baseDodge+=6; p.recomputeStats();}},
    {id:'r_lb3', x:1460, y:1070, type:'minor',   connections:['r_lb2','r_lbn'], name:'Ghost Walk', desc:'+8% Speed, +4% Dodge', apply:(p)=>{p.baseSpeed*=1.080; p.recomputeStats(); p.baseDodge+=4; p.recomputeStats();}},
  ...
  berserker: { nodes: [
    ...
    {id:'bz_ta1', x:690, y:320, type:'ability',  connections:['bz_t6','bz_tn','bz_tka'], name:'War Cry', desc:'Unlock: War Cry', apply:(p)=>addAbilityToPlayer(p,'warCry')},
    ...
    {id:'bz_ma2', x:690, y:700, type:'ability',  connections:['bz_mn','bz_m6'], name:'Berserker Leap', desc:'Unlock: Berserker Leap', apply:(p)=>addAbilityToPlayer(p,'berserkerLeap')},
    ...
    {id:'bz_lta', x:1170, y:360, type:'ability',  connections:['bz_mb1','bz_lt1'], name:'Ground Slam', desc:'Unlock: Ground Slam', apply:(p)=>addAbilityToPlayer(p,'groundSlam')},
    ...
    {id:'bz_lba', x:1170, y:1040, type:'ability',  connections:['bz_mb2','bz_lb1'], name:'Whirlwind', desc:'Unlock: Whirlwind', apply:(p)=>addAbilityToPlayer(p,'whirlwind')},
  ...
  // -- ASSASSIN --
  assassin: { nodes: [
    {id:'as0', x:80, y:700, type:'minor', origin:true,   connections:['as_ta','as_ma','as_ba'], name:'Shadow Born', desc:'+5% Dmg, +4% Dodge', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseDodge+=4; p.recomputeStats();}},
    {id:'as_ta', x:200, y:520, type:'minor',   connections:['as0','as_t1'], name:'Phantom Step', desc:'+4% Dodge', apply:(p)=>{p.baseDodge+=4; p.recomputeStats();}},
    {id:'as_t1', x:330, y:380, type:'minor',   connections:['as_ta','as_t2','as_tn'], name:'Phantom Step II', desc:'+4% Dodge, +4% Dmg', apply:(p)=>{p.baseDodge+=4; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'as_tn', x:460, y:280, type:'notable',  connections:['as_t1','as_t2','as_t3','as_t4','as_t5'], name:'Shadow Arts', desc:'+8% Dodge, +8% Dmg', apply:(p)=>{p.baseDodge+=8; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'as_t2', x:400, y:200, type:'minor',   connections:['as_t1','as_tn','as_t3'], name:'Ghost Walk', desc:'+5% Dodge', apply:(p)=>{p.baseDodge+=5; p.recomputeStats();}},
    {id:'as_t3', x:540, y:190, type:'minor',   connections:['as_t2','as_tn','as_t4'], name:'Phase Step', desc:'+5% Dodge, +5 Crit', apply:(p)=>{p.baseDodge+=5; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'as_t4', x:600, y:290, type:'minor',   connections:['as_t3','as_tn','as_t5'], name:'Blur', desc:'+6% Dodge', apply:(p)=>{p.baseDodge+=6; p.recomputeStats();}},
    {id:'as_t5', x:560, y:390, type:'minor',   connections:['as_t4','as_tn','as_t6'], name:'Mirage', desc:'+4% Dodge, +4% Dmg', apply:(p)=>{p.baseDodge+=4; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'as_t6', x:470, y:420, type:'minor',   connections:['as_t5','as_ta1'], name:'Vanishing Act', desc:'+6% Dodge', apply:(p)=>{p.baseDodge+=6; p.recomputeStats();}},
    {id:'as_ta1', x:690, y:320, type:'ability',  connections:['as_t6','as_tn','as_tka'], name:'Smoke Bomb', desc:'Unlock: Smoke Bomb', apply:(p)=>addAbilityToPlayer(p,'smokeBomb')},
    {id:'as_tka', x:850, y:340, type:'keystone', connections:['as_ta1','as_mb1'], name:'Ghost Form', desc:'Dodge +20%, dodging restores 2% HP', apply:(p)=>{p.baseDodge+=20; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.040; p.recomputeStats();}},
    ...
    {id:'as_ma2', x:690, y:700, type:'ability',  connections:['as_mn','as_m6'], name:'Blade Flurry', desc:'Unlock: Blade Flurry', apply:(p)=>addAbilityToPlayer(p,'bladeFlurry')},
    ...
    {id:'as_b7', x:680, y:1160, type:'minor',   connections:['as_b6','as_bn','as_bka'], name:'Assassinate', desc:'+8% Dmg, +4% Dodge', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseDodge+=4; p.recomputeStats();}},
    {id:'as_bka', x:850, y:1060, type:'keystone', connections:['as_b7','as_mb2'], name:'Death Mark', desc:'Crits apply DoT. +15% Dmg, +6% Dodge', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseDodge+=6; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'as_mb1', x:1010, y:490, type:'notable',  connections:['as_tka','as_mb2','as_lta','as_lt1'], name:'Shadow Form', desc:'+15% Dodge, +10% Dmg', apply:(p)=>{p.baseDodge+=15; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    ...
    {id:'as_lta', x:1170, y:360, type:'ability',  connections:['as_mb1','as_lt1'], name:'Death Blossom', desc:'Unlock: Death Blossom', apply:(p)=>addAbilityToPlayer(p,'deathBlossom')},
    ...
    {id:'as_ltn', x:1420, y:310, type:'notable',  connections:['as_lt1','as_lt2','as_lt3','as_lma'], name:'Shadow Storm', desc:'+15% Dmg, +10% Dodge', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseDodge+=10; p.recomputeStats();}},
    {id:'as_lt2', x:1350, y:210, type:'minor',   connections:['as_lt1','as_ltn','as_lt3'], name:'Void Step', desc:'+8% Dodge', apply:(p)=>{p.baseDodge+=8; p.recomputeStats();}},
    {id:'as_lt3', x:1470, y:230, type:'minor',   connections:['as_lt2','as_ltn'], name:'Wraithwalk', desc:'+10% Dodge, +5% Dmg', apply:(p)=>{p.baseDodge+=10; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'as_lba', x:1170, y:1040, type:'ability',  connections:['as_mb2','as_lb1'], name:'Shadow Realm', desc:'Unlock: Shadow Realm', apply:(p)=>addAbilityToPlayer(p,'shadowRealm')},
    ...
    {id:'as_lma', x:1590, y:700, type:'notable',  connections:['as_ltn','as_lbn','as_lm1','as_lm2'], name:'Apex Shadow', desc:'+18% Dmg, +8% Dodge', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseDodge+=8; p.recomputeStats();}},
    ...
    {id:'as_ap', x:1880, y:700, type:'notable',  connections:['as_lm1','as_lm2','as_ap1','as_ap2','as_ap3'], name:'Shadow Apex', desc:'+20% Dmg, +10% Dodge', apply:(p)=>{p.baseDmgMult*=1.200; p.recomputeStats(); p.baseDodge+=10; p.recomputeStats();}},
    ...
    {id:'as_ap3', x:2000, y:790, type:'minor',   connections:['as_ap','as_ap2','as_pre'], name:'Death Shroud', desc:'+6% Dodge, +3% Life Steal', apply:(p)=>{p.baseDodge+=6; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'as_pre', x:2170, y:700, type:'minor',   connections:['as_ap1','as_ap3','as_cap'], name:'Night Blade', desc:'+15% Dmg, +8% Dodge', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseDodge+=8; p.recomputeStats();}},
    {id:'as_cap', x:2340, y:700, type:'keystone', connections:['as_pre'], name:'Shadow Realm', desc:'Kills grant invisibility burst. +25% Dmg, +15% Dodge', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.baseDodge+=15; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}}
  ]},
  // -- SORCERER --
  sorcerer: { nodes: [
    ...
    {id:'sz_ta1', x:690, y:320, type:'ability',  connections:['sz_t6','sz_tn','sz_tka'], name:'Fireball', desc:'Unlock: Fireball', apply:(p)=>addAbilityToPlayer(p,'fireball')},
    ...
    {id:'sz_ma2', x:690, y:700, type:'ability',  connections:['sz_mn','sz_m6'], name:'Chain Lightning', desc:'Unlock: Chain Lightning', apply:(p)=>addAbilityToPlayer(p,'chainLightning')},
    ...
    {id:'sz_lta', x:1170, y:360, type:'ability',  connections:['sz_mb1','sz_lt1'], name:'Meteor', desc:'Unlock: Meteor', apply:(p)=>addAbilityToPlayer(p,'meteor')},
    ...
    {id:'sz_lba', x:1170, y:1040, type:'ability',  connections:['sz_mb2','sz_lb1'], name:'Arcane Surge', desc:'Unlock: Arcane Surge', apply:(p)=>addAbilityToPlayer(p,'arcaneSurge')},
  ...
  templar: { nodes: [
    ...
    {id:'tp_ta1', x:690, y:320, type:'ability',  connections:['tp_t6','tp_tn','tp_tka'], name:'Tempest Rush', desc:'Unlock: Tempest Rush', apply:(p)=>addAbilityToPlayer(p,'tempestRush')},
    ...
    {id:'tp_ma2', x:690, y:700, type:'ability',  connections:['tp_mn','tp_m6'], name:'Seven-Sided Strike', desc:'Unlock: Seven-Sided Strike', apply:(p)=>addAbilityToPlayer(p,'sevenSidedStrike')},
    ...
    {id:'tp_lta', x:1170, y:360, type:'ability',  connections:['tp_mb1','tp_lt1'], name:'Cyclone Strike', desc:'Unlock: Cyclone Strike', apply:(p)=>addAbilityToPlayer(p,'cycloneStrike')},
    ...
    {id:'tp_lba', x:1170, y:1040, type:'ability',  connections:['tp_mb2','tp_lb1'], name:'Transcendence', desc:'Unlock: Transcendence', apply:(p)=>addAbilityToPlayer(p,'transcendence')},
  ...
  crusader: { nodes: [
    ...
    {id:'cr_ta1', x:690, y:320, type:'ability',  connections:['cr_t6','cr_tn','cr_tka'], name:'Lay on Hands', desc:'Unlock: Lay on Hands', apply:(p)=>addAbilityToPlayer(p,'layOnHands')},
    ...
    {id:'cr_ma2', x:690, y:700, type:'ability',  connections:['cr_mn','cr_m6'], name:'Divine Shield', desc:'Unlock: Divine Shield', apply:(p)=>addAbilityToPlayer(p,'divineShield')},
    ...
    {id:'cr_lta', x:1170, y:360, type:'ability',  connections:['cr_mb1','cr_lt1'], name:'Hammer of Justice', desc:'Unlock: Hammer of Justice', apply:(p)=>addAbilityToPlayer(p,'hammerOfJustice')},
    ...
    {id:'cr_lba', x:1170, y:1040, type:'ability',  connections:['cr_mb2','cr_lb1'], name:'Wrath of Heaven', desc:'Unlock: Wrath of Heaven', apply:(p)=>addAbilityToPlayer(p,'wrathOfHeaven')},
  ...
  druid: { nodes: [
    ...
    {id:'dr_ta1', x:690, y:320, type:'ability',  connections:['dr_t6','dr_tn','dr_tka'], name:'Thorn Wall', desc:'Unlock: Thorn Wall', apply:(p)=>addAbilityToPlayer(p,'thornWall')},
    ...
    {id:'dr_ma2', x:690, y:700, type:'ability',  connections:['dr_mn','dr_m6'], name:'Summon Wolves', desc:'Unlock: Summon Wolves', apply:(p)=>addAbilityToPlayer(p,'summonWolves')},
    ...
    {id:'dr_lta', x:1170, y:360, type:'ability',  connections:['dr_mb1','dr_lt1'], name:'Cataclysm', desc:'Unlock: Cataclysm', apply:(p)=>addAbilityToPlayer(p,'cataclysm')},
    ...
    {id:'dr_lba', x:1170, y:1040, type:'ability',  connections:['dr_mb2','dr_lb1'], name:'Primal Rage', desc:'Unlock: Primal Rage', apply:(p)=>addAbilityToPlayer(p,'primalRage')},
  ...
  amazonian: { nodes: [
    ...
    {id:'az_ta1', x:690, y:320, type:'ability',  connections:['az_t6','az_tn','az_tka'], name:'Javelin Volley', desc:'Unlock: Javelin Volley', apply:(p)=>addAbilityToPlayer(p,'javelinVolley')},
    ...
    {id:'az_ma2', x:690, y:700, type:'ability',  connections:['az_mn','az_m6'], name:'Spirit Dash', desc:'Unlock: Spirit Dash', apply:(p)=>addAbilityToPlayer(p,'spiritDash')},
    ...
    {id:'az_lta', x:1170, y:360, type:'ability',  connections:['az_mb1','az_lt1'], name:'Storm of Spears', desc:'Unlock: Storm of Spears', apply:(p)=>addAbilityToPlayer(p,'stormOfSpears')},
    ...
    {id:'az_lba', x:1170, y:1040, type:'ability',  connections:['az_mb2','az_lb1'], name:'Apex Predator', desc:'Unlock: Apex Predator', apply:(p)=>addAbilityToPlayer(p,'apexPredator')},
  ...
  shaman: { nodes: [
    ...
    {id:'sh_ta1', x:690, y:320, type:'ability',  connections:['sh_t6','sh_tn','sh_tka'], name:'Mass Hex', desc:'Unlock: Mass Hex', apply:(p)=>addAbilityToPlayer(p,'massHex')},
    ...
    {id:'sh_ma2', x:690, y:700, type:'ability',  connections:['sh_mn','sh_m6'], name:'Spirit Totem', desc:'Unlock: Spirit Totem', apply:(p)=>addAbilityToPlayer(p,'spiritTotem')},
    ...
    {id:'sh_lta', x:1170, y:360, type:'ability',  connections:['sh_mb1','sh_lt1'], name:'Storm Call', desc:'Unlock: Storm Call', apply:(p)=>addAbilityToPlayer(p,'stormCall')},
    ...
    {id:'sh_lba', x:1170, y:1040, type:'ability',  connections:['sh_mb2','sh_lb1'], name:'Ancestral Fury', desc:'Unlock: Ancestral Fury', apply:(p)=>addAbilityToPlayer(p,'ancestralFury')},
  ...
  necromancer: { nodes: [
    ...
    {id:'nc_ta1', x:690, y:320, type:'ability',  connections:['nc_t6','nc_tn','nc_tka'], name:'Bone Storm', desc:'Unlock: Bone Storm', apply:(p)=>addAbilityToPlayer(p,'boneStorm')},
    ...
    {id:'nc_ma2', x:690, y:700, type:'ability',  connections:['nc_mn','nc_m6'], name:'Skeleton Warrior', desc:'Unlock: Skeleton Warrior', apply:(p)=>addAbilityToPlayer(p,'skeletonWarrior')},
    ...
    {id:'nc_lta', x:1170, y:360, type:'ability',  connections:['nc_mb1','nc_lt1'], name:'Corpse Explosion', desc:'Unlock: Corpse Explosion', apply:(p)=>addAbilityToPlayer(p,'corpseExplosion')},
    ...
    {id:'nc_lba', x:1170, y:1040, type:'ability',  connections:['nc_mb2','nc_lb1'], name:'Lich Form', desc:'Unlock: Lich Form', apply:(p)=>addAbilityToPlayer(p,'lichForm')},
