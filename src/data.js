...
const GEM_TYPES = [
  ...
  {
    // Diamond — VIT gem (all elements): resist all at 1/5th single-element rate
    id: 'diamond', tier: 1, name: 'Diamond', color: '#c8eeff', primaryStat: 'vit', element: 'all',
    bonuses: [
      '+1% All Resist, +8 HP',
      '+2% All Resist, +15 HP',
      '+3% All Resist, +25 HP',
    ...
    apply: (p, q) => {
      const ra=[1,2,3,4,6][q], hp=[8,15,25,40,60][q];
      p.bonusMaxHp+=hp;
      p.bonusFireResist=(p.bonusFireResist||0)+ra;
      p.bonusColdResist=(p.bonusColdResist||0)+ra;
      p.bonusLightResist=(p.bonusLightResist||0)+ra;
      p.bonusPoisonResist=(p.bonusPoisonResist||0)+ra;
    },
  },
];
...
const SKILL_TREES = {
  ...
  ranger: { nodes: [
    ...
    {id:'r_ta', x:200, y:520, type:'minor',   connections:['r0','r_t1'], name:'Keen Eye I', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'r_t1', x:320, y:370, type:'minor',   connections:['r_ta','r_t2','r_tn'], name:'Keen Eye II', desc:'+4% Dmg, +3 Crit', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.baseCritChance+=3; p.recomputeStats();}},
    {id:'r_tn', x:450, y:280, type:'notable',  connections:['r_t1','r_t2','r_t3','r_t4','r_t5'], name:'Eagle Eye', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'r_t2', x:390, y:200, type:'minor',   connections:['r_t1','r_tn','r_t3'], name:'Hawk Sight', desc:'+5 Crit', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats();}},
    {id:'r_t3', x:530, y:190, type:'minor',   connections:['r_t2','r_tn','r_t4'], name:'Razor Focus', desc:'+5 Crit, +8% Crit Dmg', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats(); p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'r_t4', x:590, y:290, type:'minor',   connections:['r_t3','r_tn','r_t5'], name:'Piercing Draw', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'r_t5', x:560, y:390, type:'minor',   connections:['r_t4','r_tn','r_t6'], name:'Arrow Draw', desc:'+5% Dmg, +4 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'r_t6', x:470, y:420, type:'minor',   connections:['r_t5','r_ta1'], name:'Precision', desc:'+6% Crit Dmg', apply:(p)=>{p.baseCritDmg+=0.06; p.recomputeStats();}},
    {id:'r_ta1', x:690, y:310, type:'passive',  connections:['r_t6','r_tn','r_tka'], name:'Keen Eye', desc:'+3 DEX, +10% Crit Dmg', apply:(p)=>{p.primaryDex=(p.primaryDex||0)+3; p.bonusCritDmg=(p.bonusCritDmg||0)+0.10; p.recomputeStats();}},
    {id:'r_tka', x:850, y:340, type:'keystone', connections:['r_ta1','r_mb1'], name:'Dead Eye', desc:'Crits deal +40% Dmg, +10 Crit', apply:(p)=>{p.baseCritDmg+=0.40; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'r_ma', x:200, y:700, type:'minor',   connections:['r0','r_m1'], name:'Swift Nock', desc:'+4% Speed', apply:(p)=>{p.baseSpeed*=1.040; p.recomputeStats();}},
    {id:'r_m1', x:330, y:700, type:'minor',   connections:['r_ma','r_m2','r_mn'], name:'Swift Nock II', desc:'+4% Speed, +4% Dmg', apply:(p)=>{p.baseSpeed*=1.040; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'r_mn', x:460, y:700, type:'notable',  connections:['r_m1','r_m2','r_m3','r_m4','r_m5'], name:'Swift Quiver', desc:'+8% Speed, +8% Dmg', apply:(p)=>{p.baseSpeed*=1.080; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'r_m2', x:400, y:620, type:'minor',   connections:['r_m1','r_mn','r_m3'], name:'Rapid Fire', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'r_m3', x:540, y:620, type:'minor',   connections:['r_m2','r_mn','r_m4'], name:'Volley Prep', desc:'+5% Dmg, +4 Pickup', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.basePickupRange+=4; p.recomputeStats();}},
    {id:'r_m4', x:590, y:700, type:'minor',   connections:['r_m3','r_mn','r_m5'], name:'Wind Arrow', desc:'+5% Speed', apply:(p)=>{p.baseSpeed*=1.050; p.recomputeStats();}},
    {id:'r_m5', x:540, y:780, type:'minor',   connections:['r_m4','r_mn','r_m6'], name:'Hunter Pace', desc:'+4% Speed, +4% Dmg', apply:(p)=>{p.baseSpeed*=1.040; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'r_m6', x:400, y:780, type:'minor',   connections:['r_m5','r_ma2'], name:'Gale Nock', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'r_ma2', x:690, y:700, type:'passive',  connections:['r_mn','r_m6'], name:"Hunter's Mark", desc:'+2 DEX, +2 SPI, +6% Dmg', apply:(p)=>{p.primaryDex=(p.primaryDex||0)+2; p.primarySpi=(p.primarySpi||0)+2; p.baseDmgMult*=1.06; p.recomputeStats();}},
    {id:'r_ba', x:200, y:880, type:'minor',   connections:['r0','r_b1'], name:'Iron Stride', desc:'+8 HP', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'r_b1', x:320, y:1030, type:'minor',   connections:['r_ba','r_b2','r_bn'], name:'Iron Stride II', desc:'+8 HP, +1% Dodge', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseDodge += 1; p.recomputeStats();}},
    {id:'r_bn', x:450, y:1120, type:'notable',  connections:['r_b1','r_b2','r_b3','r_b4','r_b5'], name:'Hardened', desc:'+20 HP, +8 Armor', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=8; p.recomputeStats();}},
    {id:'r_b2', x:390, y:1050, type:'minor',   connections:['r_b1','r_bn','r_b3'], name:'Forest Guard', desc:'+1% Dodge', apply:(p)=>{p.baseDodge += 1; p.recomputeStats();}},
    {id:'r_b3', x:530, y:1060, type:'minor',   connections:['r_b2','r_bn','r_b4'], name:'Camouflage', desc:'+1% Dodge, +5% Dmg', apply:(p)=>{p.baseDodge += 1; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'r_b4', x:590, y:1130, type:'minor',   connections:['r_b3','r_bn','r_b5'], name:'Bark Skin', desc:'+10 Armor', apply:(p)=>{p.baseArmor+=10; p.recomputeStats();}},
    {id:'r_b5', x:530, y:1200, type:'minor',   connections:['r_b4','r_bn','r_b6'], name:'Thorn Boots', desc:'+8 HP, +5 Armor', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseArmor+=5; p.recomputeStats();}},
    {id:'r_b6', x:390, y:1200, type:'minor',   connections:['r_b5','r_b7'], name:'Viper Step', desc:'+3% Life Steal', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'r_b7', x:680, y:1160, type:'minor',   connections:['r_b6','r_bn','r_bka'], name:'Pack Instinct', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'r_bka', x:850, y:1060, type:'keystone', connections:['r_b7','r_mb2'], name:'Ranger Resilience', desc:'+30 HP, +10 Armor, +1% Dodge', apply:(p)=>{p.baseMaxHp+=30; p.recomputeStats(); p.baseArmor+=10; p.recomputeStats(); p.baseDodge += 1; p.recomputeStats();}},
    {id:'r_mb1', x:1010, y:490, type:'notable',  connections:['r_tka','r_mb2','r_lta','r_lt1'], name:'Marked Prey', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'r_mb2', x:1010, y:910, type:'notable',  connections:['r_bka','r_mb1','r_lba','r_lb1'], name:'Stalker', desc:'+12% Dmg, +3% Life Steal', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'r_lta', x:1160, y:360, type:'passive',  connections:['r_mb1','r_lt1'], name:'Pinpoint', desc:'+4 DEX, +12% Lightning Dmg', apply:(p)=>{p.primaryDex=(p.primaryDex||0)+4; p.bonusLightDmgPct=(p.bonusLightDmgPct||0)+12; p.recomputeStats();}},
    {id:'r_lt1', x:1280, y:290, type:'minor',   connections:['r_lta','r_lt2','r_ltn'], name:'Gust Volley', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'r_ltn', x:1410, y:310, type:'notable',  connections:['r_lt1','r_lt2','r_lt3','r_lma'], name:'Rain Master', desc:'+15% Dmg, +10 Crit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'r_lt2', x:1340, y:210, type:'minor',   connections:['r_lt1','r_ltn','r_lt3'], name:'Skyfall', desc:'+8% Crit Dmg', apply:(p)=>{p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'r_lt3', x:1460, y:230, type:'minor',   connections:['r_lt2','r_ltn'], name:'Altitude', desc:'+6 Crit, +6% Crit Dmg', apply:(p)=>{p.baseCritChance+=6; p.recomputeStats(); p.baseCritDmg+=0.06; p.recomputeStats();}},
    {id:'r_lba', x:1160, y:1040, type:'passive',  connections:['r_mb2','r_lb1'], name:'Toxin Mastery', desc:'+3 SPI, +12% Poison Dmg, +5% Poison Resist', apply:(p)=>{p.primarySpi=(p.primarySpi||0)+3; p.bonusPoisonDmgPct=(p.bonusPoisonDmgPct||0)+12; p.bonusPoisonResist=(p.bonusPoisonResist||0)+5; p.recomputeStats();}},
    {id:'r_lb1', x:1280, y:1010, type:'minor',   connections:['r_lba','r_lb2','r_lbn'], name:'Death Mark', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'r_lbn', x:1410, y:990, type:'notable',  connections:['r_lb1','r_lb2','r_lb3','r_lma'], name:'Predator Mark', desc:'+15% Dmg, +1% Dodge', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseDodge += 1; p.recomputeStats();}},
    {id:'r_lb2', x:1340, y:1090, type:'minor',   connections:['r_lb1','r_lbn','r_lb3'], name:'Shadow Track', desc:'+2% Dodge', apply:(p)=>{p.baseDodge += 2; p.recomputeStats();}},
    {id:'r_lb3', x:1460, y:1070, type:'minor',   connections:['r_lb2','r_lbn'], name:'Ghost Walk', desc:'+8% Speed, +1% Dodge', apply:(p)=>{p.baseSpeed*=1.080; p.recomputeStats(); p.baseDodge += 1; p.recomputeStats();}},
    {id:'r_lma', x:1590, y:700, type:'notable',  connections:['r_ltn','r_lbn','r_lm1','r_lm2'], name:'Apex Form', desc:'+15% Dmg, +8% Speed', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseSpeed*=1.080; p.recomputeStats();}},
    {id:'r_lm1', x:1710, y:620, type:'minor',   connections:['r_lma','r_lm2','r_ap'], name:'Arrow Mastery', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'r_lm2', x:1710, y:780, type:'minor',   connections:['r_lma','r_lm1','r_ap'], name:'Perfect Draw', desc:'+8 Crit, +8% Crit Dmg', apply:(p)=>{p.baseCritChance+=8; p.recomputeStats(); p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'r_ap', x:1870, y:700, type:'notable',  connections:['r_lm1','r_lm2','r_ap1','r_ap2','r_ap3'], name:'Apex Hunter', desc:'+18% Dmg, +12 Crit', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseCritChance+=12; p.recomputeStats();}},
    {id:'r_ap1', x:1990, y:610, type:'minor',   connections:['r_ap','r_ap2','r_pre'], name:'Wind Rider', desc:'+10% Speed', apply:(p)=>{p.baseSpeed*=1.100; p.recomputeStats();}},
    {id:'r_ap2', x:1990, y:700, type:'minor',   connections:['r_ap','r_ap1','r_ap3'], name:'Relentless', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'r_ap3', x:1990, y:790, type:'minor',   connections:['r_ap','r_ap2','r_pre'], name:'Iron Will', desc:'+20 HP, +3% Life Steal', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'r_pre', x:2160, y:700, type:'minor',   connections:['r_ap1','r_ap3','r_cap'], name:'One Hunt', desc:'+10% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'r_cap', x:2340, y:700, type:'keystone', connections:['r_pre'], name:'One With the Hunt', desc:'+25% Dmg, +15 Crit, +10% Speed', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.baseCritChance+=15; p.recomputeStats(); p.baseSpeed*=1.100; p.recomputeStats();}}
  ]},
  // -- BERSERKER --
  berserker: { nodes: [
    {id:'bz0', x:80, y:700, type:'minor', origin:true,   connections:['bz_ta','bz_ma','bz_ba'], name:'Berserker Oath', desc:'+5% Dmg, +10 HP', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxHp+=10; p.recomputeStats();}},
    {id:'bz_ta', x:200, y:520, type:'minor',   connections:['bz0','bz_t1'], name:'Battle Lust', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'bz_t1', x:330, y:380, type:'minor',   connections:['bz_ta','bz_t2','bz_tn'], name:'Battle Lust II', desc:'+5% Dmg, +8 HP', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'bz_tn', x:460, y:280, type:'notable',  connections:['bz_t1','bz_t2','bz_t3','bz_t4','bz_t5'], name:'Rage Engine', desc:'+15% Dmg, +15 HP', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'bz_t2', x:400, y:200, type:'minor',   connections:['bz_t1','bz_tn','bz_t3'], name:'Blood Hunger', desc:'+5 Crit', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats();}},
    {id:'bz_t3', x:540, y:190, type:'minor',   connections:['bz_t2','bz_tn','bz_t4'], name:'Reckless Strike', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'bz_t4', x:600, y:290, type:'minor',   connections:['bz_t3','bz_tn','bz_t5'], name:'Fury Draw', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'bz_t5', x:560, y:390, type:'minor',   connections:['bz_t4','bz_tn','bz_t6'], name:'Warlust', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'bz_t6', x:470, y:420, type:'minor',   connections:['bz_t5','bz_ta1'], name:'Bloodhaze', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'bz_ta1', x:690, y:320, type:'passive',  connections:['bz_t6','bz_tn','bz_tka'], name:'Battle Hardened', desc:'+3 STR, +10% Fire Dmg', apply:(p)=>{p.primaryStr=(p.primaryStr||0)+3; p.bonusFireDmgPct=(p.bonusFireDmgPct||0)+10; p.recomputeStats();}},
    {id:'bz_tka', x:850, y:340, type:'keystone', connections:['bz_ta1','bz_mb1'], name:'Warlord', desc:'Kill streak boosts Dmg. +20% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.200; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'bz_ma', x:200, y:700, type:'minor',   connections:['bz0','bz_m1'], name:'Iron Hide', desc:'+10 HP', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats();}},
    {id:'bz_m1', x:330, y:700, type:'minor',   connections:['bz_ma','bz_m2','bz_mn'], name:'Iron Hide II', desc:'+10 HP, +6 Armor', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats(); p.baseArmor+=6; p.recomputeStats();}},
    {id:'bz_mn', x:460, y:700, type:'notable',  connections:['bz_m1','bz_m2','bz_m3','bz_m4','bz_m5'], name:'Unbreakable', desc:'+25 HP, +12 Armor', apply:(p)=>{p.baseMaxHp+=25; p.recomputeStats(); p.baseArmor+=12; p.recomputeStats();}},
    {id:'bz_m2', x:400, y:620, type:'minor',   connections:['bz_m1','bz_mn','bz_m3'], name:'Stone Skin', desc:'+8 Armor', apply:(p)=>{p.baseArmor+=8; p.recomputeStats();}},
    {id:'bz_m3', x:540, y:620, type:'minor',   connections:['bz_m2','bz_mn','bz_m4'], name:'Titan Body', desc:'+15 HP, +5 Armor', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats(); p.baseArmor+=5; p.recomputeStats();}},
    {id:'bz_m4', x:590, y:700, type:'minor',   connections:['bz_m3','bz_mn','bz_m5'], name:'Bulwark', desc:'+8 Armor', apply:(p)=>{p.baseArmor+=8; p.recomputeStats();}},
    {id:'bz_m5', x:540, y:780, type:'minor',   connections:['bz_m4','bz_mn','bz_m6'], name:'War Scars', desc:'+10 HP, +3% Life Steal', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'bz_m6', x:400, y:780, type:'minor',   connections:['bz_m5','bz_ma2'], name:'Endurance', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'bz_ma2', x:690, y:700, type:'passive',  connections:['bz_mn','bz_m6'], name:'Bloodlust', desc:'+2 STR, +2 VIT, +8% Dmg', apply:(p)=>{p.primaryStr=(p.primaryStr||0)+2; p.primaryVit=(p.primaryVit||0)+2; p.baseDmgMult*=1.08; p.recomputeStats();}},
    {id:'bz_ba', x:200, y:880, type:'minor',   connections:['bz0','bz_b1'], name:'Bleed Arts', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'bz_b1', x:330, y:1030, type:'minor',   connections:['bz_ba','bz_b2','bz_bn'], name:'Bleed Arts II', desc:'+4% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'bz_bn', x:460, y:1120, type:'notable',  connections:['bz_b1','bz_b2','bz_b3','bz_b4','bz_b5'], name:'Rend', desc:'+12% Dmg, +4% Life Steal', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.040; p.recomputeStats();}},
    {id:'bz_b2', x:400, y:1050, type:'minor',   connections:['bz_b1','bz_bn','bz_b3'], name:'Deep Cut', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'bz_b3', x:540, y:1060, type:'minor',   connections:['bz_b2','bz_bn','bz_b4'], name:'Hemorrhage', desc:'+5% Dmg, +3% Life Steal', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'bz_b4', x:590, y:1130, type:'minor',   connections:['bz_b3','bz_bn','bz_b5'], name:'Wound Mastery', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'bz_b5', x:540, y:1200, type:'minor',   connections:['bz_b4','bz_bn','bz_b6'], name:'Blood Price', desc:'+15 HP, +3% Life Steal', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'bz_b6', x:400, y:1200, type:'minor',   connections:['bz_b5','bz_b7'], name:'Savage Blow', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'bz_b7', x:680, y:1160, type:'minor',   connections:['bz_b6','bz_bn','bz_bka'], name:'Carnage', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'bz_bka', x:850, y:1060, type:'keystone', connections:['bz_b7','bz_mb2'], name:'Blood Frenzy', desc:'On kill Life Steal spikes. +5% LifeSteal, +10% Dmg', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'bz_mb1', x:1010, y:490, type:'notable',  connections:['bz_tka','bz_mb2','bz_lta','bz_lt1'], name:'War Machine', desc:'+15% Dmg, +15 HP', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'bz_mb2', x:1010, y:910, type:'notable',  connections:['bz_bka','bz_mb1','bz_lba','bz_lb1'], name:'Death Drive', desc:'+12% Dmg, +5% Life Steal', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}},
    {id:'bz_lta', x:1170, y:360, type:'passive',  connections:['bz_mb1','bz_lt1'], name:'Infernal Rage', desc:'+4 STR, +12% Fire Dmg', apply:(p)=>{p.primaryStr=(p.primaryStr||0)+4; p.bonusFireDmgPct=(p.bonusFireDmgPct||0)+12; p.recomputeStats();}},
    {id:'bz_lt1', x:1290, y:290, type:'minor',   connections:['bz_lta','bz_lt2','bz_ltn'], name:'Shockwave', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'bz_ltn', x:1420, y:310, type:'notable',  connections:['bz_lt1','bz_lt2','bz_lt3','bz_lma'], name:'Earthbreaker', desc:'+18% Dmg, +20 HP', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats();}},
    {id:'bz_lt2', x:1350, y:210, type:'minor',   connections:['bz_lt1','bz_ltn','bz_lt3'], name:'Tremor', desc:'+8% Dmg, +10 HP', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseMaxHp+=10; p.recomputeStats();}},
    {id:'bz_lt3', x:1470, y:230, type:'minor',   connections:['bz_lt2','bz_ltn'], name:'Seismic', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'bz_lba', x:1170, y:1040, type:'passive',  connections:['bz_mb2','bz_lb1'], name:"Titan's Blood", desc:'+3 VIT, +40 HP, +8% Dmg', apply:(p)=>{p.primaryVit=(p.primaryVit||0)+3; p.baseMaxHp+=40; p.baseDmgMult*=1.08; p.recomputeStats();}},
    {id:'bz_lb1', x:1290, y:1010, type:'minor',   connections:['bz_lba','bz_lb2','bz_lbn'], name:'Spinning Fury', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'bz_lbn', x:1420, y:990, type:'notable',  connections:['bz_lb1','bz_lb2','bz_lb3','bz_lma'], name:'Whirling Death', desc:'+15% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'bz_lb2', x:1350, y:1090, type:'minor',   connections:['bz_lb1','bz_lbn','bz_lb3'], name:'Blade Wind', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'bz_lb3', x:1470, y:1070, type:'minor',   connections:['bz_lb2','bz_lbn'], name:'Tornado Blow', desc:'+10% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'bz_lma', x:1590, y:700, type:'notable',  connections:['bz_ltn','bz_lbn','bz_lm1','bz_lm2'], name:'Berserker Peak', desc:'+18% Dmg, +20 HP', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats();}},
    {id:'bz_lm1', x:1710, y:620, type:'minor',   connections:['bz_lma','bz_lm2','bz_ap'], name:'Killing Art', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'bz_lm2', x:1710, y:780, type:'minor',   connections:['bz_lma','bz_lm1','bz_ap'], name:'Pain Fuel', desc:'+5% Life Steal, +10% Dmg', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'bz_ap', x:1880, y:700, type:'notable',  connections:['bz_lm1','bz_lm2','bz_ap1','bz_ap2','bz_ap3'], name:'Warmonger', desc:'+20% Dmg, +25 HP', apply:(p)=>{p.baseDmgMult*=1.200; p.recomputeStats(); p.baseMaxHp+=25; p.recomputeStats();}},
    {id:'bz_ap1', x:2000, y:610, type:'minor',   connections:['bz_ap','bz_ap2','bz_pre'], name:'Final Fury', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'bz_ap2', x:2000, y:700, type:'minor',   connections:['bz_ap','bz_ap1','bz_ap3'], name:'Titan Rage', desc:'+20 HP, +8 Armor', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=8; p.recomputeStats();}},
    {id:'bz_ap3', x:2000, y:790, type:'minor',   connections:['bz_ap','bz_ap2','bz_pre'], name:'Blood Oath', desc:'+6% Life Steal', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.060; p.recomputeStats();}},
    {id:'bz_pre', x:2170, y:700, type:'minor',   connections:['bz_ap1','bz_ap3','bz_cap'], name:'Last Stand', desc:'+15% Dmg, +20 HP', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats();}},
    {id:'bz_cap', x:2340, y:700, type:'keystone', connections:['bz_pre'], name:'Warmonger', desc:'Below 30% HP triggers Rage. +35% Dmg, +12% Speed', apply:(p)=>{p.baseDmgMult*=1.350; p.recomputeStats(); p.baseSpeed*=1.120; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}}
  ]},
  // -- ASSASSIN --
  assassin: { nodes: [
    {id:'as0', x:80, y:700, type:'minor', origin:true,   connections:['as_ta','as_ma','as_ba'], name:'Shadow Born', desc:'+5% Dmg, +1% Dodge', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseDodge += 1; p.recomputeStats();}},
    {id:'as_ta', x:200, y:520, type:'minor',   connections:['as0','as_t1'], name:'Phantom Step', desc:'+1% Dodge', apply:(p)=>{p.baseDodge += 1; p.recomputeStats();}},
    {id:'as_t1', x:330, y:380, type:'minor',   connections:['as_ta','as_t2','as_tn'], name:'Phantom Step II', desc:'+1% Dodge, +4% Dmg', apply:(p)=>{p.baseDodge += 1; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'as_tn', x:460, y:280, type:'notable',  connections:['as_t1','as_t2','as_t3','as_t4','as_t5'], name:'Shadow Arts', desc:'+2% Dodge, +8% Dmg', apply:(p)=>{p.baseDodge += 2; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'as_t2', x:400, y:200, type:'minor',   connections:['as_t1','as_tn','as_t3'], name:'Ghost Walk', desc:'+1% Dodge', apply:(p)=>{p.baseDodge += 1; p.recomputeStats();}},
    {id:'as_t3', x:540, y:190, type:'minor',   connections:['as_t2','as_tn','as_t4'], name:'Phase Step', desc:'+1% Dodge, +5 Crit', apply:(p)=>{p.baseDodge += 1; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'as_t4', x:600, y:290, type:'minor',   connections:['as_t3','as_tn','as_t5'], name:'Blur', desc:'+2% Dodge', apply:(p)=>{p.baseDodge += 2; p.recomputeStats();}},
    {id:'as_t5', x:560, y:390, type:'minor',   connections:['as_t4','as_tn','as_t6'], name:'Mirage', desc:'+1% Dodge, +4% Dmg', apply:(p)=>{p.baseDodge += 1; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'as_t6', x:470, y:420, type:'minor',   connections:['as_t5','as_ta1'], name:'Vanishing Act', desc:'+2% Dodge', apply:(p)=>{p.baseDodge += 2; p.recomputeStats();}},
    {id:'as_ta1', x:690, y:320, type:'passive',  connections:['as_t6','as_tn','as_tka'], name:'Shadow Adept', desc:'+3 DEX, +10% Crit Dmg', apply:(p)=>{p.primaryDex=(p.primaryDex||0)+3; p.bonusCritDmg=(p.bonusCritDmg||0)+0.10; p.recomputeStats();}},
    {id:'as_tka', x:850, y:340, type:'keystone', connections:['as_ta1','as_mb1'], name:'Ghost Form', desc:'Dodge +5%, dodging restores 2% HP', apply:(p)=>{p.baseDodge += 5; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.040; p.recomputeStats();}},
    {id:'as_ma', x:200, y:700, type:'minor',   connections:['as0','as_m1'], name:'Blade Edge', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'as_m1', x:330, y:700, type:'minor',   connections:['as_ma','as_m2','as_mn'], name:'Blade Edge II', desc:'+4% Dmg, +4 Crit', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.baseCritChance+=4; p.recomputeStats();}},
    {id:'as_mn', x:460, y:700, type:'notable',  connections:['as_m1','as_m2','as_m3','as_m4','as_m5'], name:'Blade Mastery', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'as_m2', x:400, y:620, type:'minor',   connections:['as_m1','as_mn','as_m3'], name:'Razor Edge', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'as_m3', x:540, y:620, type:'minor',   connections:['as_m2','as_mn','as_m4'], name:'Fatal Cut', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'as_m4', x:590, y:700, type:'minor',   connections:['as_m3','as_mn','as_m5'], name:'Eviscerate', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'as_m5', x:540, y:780, type:'minor',   connections:['as_m4','as_mn','as_m6'], name:'Thousand Cuts', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'as_m6', x:400, y:780, type:'minor',   connections:['as_m5','as_ma2'], name:'Death Blow', desc:'+8% Crit Dmg', apply:(p)=>{p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'as_ma2', x:690, y:700, type:'passive',  connections:['as_mn','as_m6'], name:'Flurry Mastery', desc:'+2 DEX, +2 STR, +10% Attack Speed', apply:(p)=>{p.primaryDex=(p.primaryDex||0)+2; p.primaryStr=(p.primaryStr||0)+2; p.bonusFireRatePct+=10; p.recomputeStats();}},
    {id:'as_ba', x:200, y:880, type:'minor',   connections:['as0','as_b1'], name:'Venom Arts', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'as_b1', x:330, y:1030, type:'minor',   connections:['as_ba','as_b2','as_bn'], name:'Venom Arts II', desc:'+4% Dmg, +3% Life Steal', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'as_bn', x:460, y:1120, type:'notable',  connections:['as_b1','as_b2','as_b3','as_b4','as_b5'], name:'Poison Mastery', desc:'+10% Dmg, +5% Life Steal', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}},
    {id:'as_b2', x:400, y:1050, type:'minor',   connections:['as_b1','as_bn','as_b3'], name:'Toxic Edge', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'as_b3', x:540, y:1060, type:'minor',   connections:['as_b2','as_bn','as_b4'], name:'Viper Fang', desc:'+5% Dmg, +3% Life Steal', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'as_b4', x:590, y:1130, type:'minor',   connections:['as_b3','as_bn','as_b5'], name:'Lethal Venom', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'as_b5', x:540, y:1200, type:'minor',   connections:['as_b4','as_bn','as_b6'], name:'Death Mark', desc:'+5 Crit, +5% Dmg', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'as_b6', x:400, y:1200, type:'minor',   connections:['as_b5','as_b7'], name:'Execute', desc:'+10% Crit Dmg', apply:(p)=>{p.baseCritDmg+=0.10; p.recomputeStats();}},
    {id:'as_b7', x:680, y:1160, type:'minor',   connections:['as_b6','as_bn','as_bka'], name:'Assassinate', desc:'+8% Dmg, +1% Dodge', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseDodge += 1; p.recomputeStats();}},
    {id:'as_bka', x:850, y:1060, type:'keystone', connections:['as_b7','as_mb2'], name:'Death Mark', desc:'Crits apply DoT. +15% Dmg, +2% Dodge', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseDodge += 2; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'as_mb1', x:1010, y:490, type:'notable',  connections:['as_tka','as_mb2','as_lta','as_lt1'], name:'Shadow Form', desc:'+4% Dodge, +10% Dmg', apply:(p)=>{p.baseDodge += 4; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'as_mb2', x:1010, y:910, type:'notable',  connections:['as_bka','as_mb1','as_lba','as_lb1'], name:'Killing Arts', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'as_lta', x:1170, y:360, type:'passive',  connections:['as_mb1','as_lt1'], name:"Death's Touch", desc:'+4 DEX, +14% Poison Dmg', apply:(p)=>{p.primaryDex=(p.primaryDex||0)+4; p.bonusPoisonDmgPct=(p.bonusPoisonDmgPct||0)+14; p.recomputeStats();}},
    {id:'as_lt1', x:1290, y:290, type:'minor',   connections:['as_lta','as_lt2','as_ltn'], name:'Petal Storm', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'as_ltn', x:1420, y:310, type:'notable',  connections:['as_lt1','as_lt2','as_lt3','as_lma'], name:'Shadow Storm', desc:'+15% Dmg, +2% Dodge', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseDodge += 2; p.recomputeStats();}},
    {id:'as_lt2', x:1350, y:210, type:'minor',   connections:['as_lt1','as_ltn','as_lt3'], name:'Void Step', desc:'+2% Dodge', apply:(p)=>{p.baseDodge += 2; p.recomputeStats();}},
    {id:'as_lt3', x:1470, y:230, type:'minor',   connections:['as_lt2','as_ltn'], name:'Wraithwalk', desc:'+2% Dodge, +5% Dmg', apply:(p)=>{p.baseDodge += 2; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'as_lba', x:1170, y:1040, type:'passive',  connections:['as_mb2','as_lb1'], name:"Assassin's Mark", desc:'+3 STR, +8% Crit Chance, +6% Crit Dmg', apply:(p)=>{p.primaryStr=(p.primaryStr||0)+3; p.bonusCritChance+=8; p.bonusCritDmg=(p.bonusCritDmg||0)+0.06; p.recomputeStats();}},
    {id:'as_lb1', x:1290, y:1010, type:'minor',   connections:['as_lba','as_lb2','as_lbn'], name:'Dark Shroud', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'as_lbn', x:1420, y:990, type:'notable',  connections:['as_lb1','as_lb2','as_lb3','as_lma'], name:'Reaper Arts', desc:'+15% Dmg, +10 Crit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'as_lb2', x:1350, y:1090, type:'minor',   connections:['as_lb1','as_lbn','as_lb3'], name:'Shadow Crit', desc:'+8 Crit', apply:(p)=>{p.baseCritChance+=8; p.recomputeStats();}},
    {id:'as_lb3', x:1470, y:1070, type:'minor',   connections:['as_lb2','as_lbn'], name:'Lethal Mastery', desc:'+10% Dmg, +8% Crit Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'as_lma', x:1590, y:700, type:'notable',  connections:['as_ltn','as_lbn','as_lm1','as_lm2'], name:'Apex Shadow', desc:'+18% Dmg, +2% Dodge', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseDodge += 2; p.recomputeStats();}},
    {id:'as_lm1', x:1710, y:620, type:'minor',   connections:['as_lma','as_lm2','as_ap'], name:'Killing Mastery', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'as_lm2', x:1710, y:780, type:'minor',   connections:['as_lma','as_lm1','as_ap'], name:'Death Art', desc:'+10 Crit, +10% Crit Dmg', apply:(p)=>{p.baseCritChance+=10; p.recomputeStats(); p.baseCritDmg+=0.10; p.recomputeStats();}},
    {id:'as_ap', x:1880, y:700, type:'notable',  connections:['as_lm1','as_lm2','as_ap1','as_ap2','as_ap3'], name:'Shadow Apex', desc:'+20% Dmg, +2% Dodge', apply:(p)=>{p.baseDmgMult*=1.200; p.recomputeStats(); p.baseDodge += 2; p.recomputeStats();}},
    {id:'as_ap1', x:2000, y:610, type:'minor',   connections:['as_ap','as_ap2','as_pre'], name:'Phantom Kill', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'as_ap2', x:2000, y:700, type:'minor',   connections:['as_ap','as_ap1','as_ap3'], name:'Ghost Crit', desc:'+12 Crit, +10% Crit Dmg', apply:(p)=>{p.baseCritChance+=12; p.recomputeStats(); p.baseCritDmg+=0.10; p.recomputeStats();}},
    {id:'as_ap3', x:2000, y:790, type:'minor',   connections:['as_ap','as_ap2','as_pre'], name:'Death Shroud', desc:'+2% Dodge, +3% Life Steal', apply:(p)=>{p.baseDodge += 2; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'as_pre', x:2170, y:700, type:'minor',   connections:['as_ap1','as_ap3','as_cap'], name:'Night Blade', desc:'+15% Dmg, +2% Dodge', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseDodge += 2; p.recomputeStats();}},
    {id:'as_cap', x:2340, y:700, type:'keystone', connections:['as_pre'], name:'Shadow Realm', desc:'Kills grant invisibility burst. +25% Dmg, +4% Dodge', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.baseDodge += 4; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}}
  ]},
  // -- SORCERER --
  sorcerer: { nodes: [
    {id:'sz0', x:80, y:700, type:'minor', origin:true,   connections:['sz_ta','sz_ma','sz_ba'], name:'Arcane Spark', desc:'+5% Dmg, +10 Mana', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'sz_ta', x:200, y:520, type:'minor',   connections:['sz0','sz_t1'], name:'Fire Touch', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'sz_t1', x:330, y:380, type:'minor',   connections:['sz_ta','sz_t2','sz_tn'], name:'Fire Touch II', desc:'+4% Dmg, +5 Mana', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.baseMaxResource+=5; p.recomputeStats();}},
    {id:'sz_tn', x:460, y:280, type:'notable',  connections:['sz_t1','sz_t2','sz_t3','sz_t4','sz_t5'], name:'Inferno Arts', desc:'+12% Dmg, +15 Mana', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'sz_t2', x:400, y:200, type:'minor',   connections:['sz_t1','sz_tn','sz_t3'], name:'Burning Edge', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'sz_t3', x:540, y:190, type:'minor',   connections:['sz_t2','sz_tn','sz_t4'], name:'Immolate', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sz_t4', x:600, y:290, type:'minor',   connections:['sz_t3','sz_tn','sz_t5'], name:'Conflagrate', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'sz_t5', x:560, y:390, type:'minor',   connections:['sz_t4','sz_tn','sz_t6'], name:'Pyromaniac', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'sz_t6', x:470, y:420, type:'minor',   connections:['sz_t5','sz_ta1'], name:'Flame Surge', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sz_ta1', x:690, y:320, type:'passive',  connections:['sz_t6','sz_tn','sz_tka'], name:'Pyromancy', desc:'+3 INT, +12% Fire Dmg', apply:(p)=>{p.primaryInt=(p.primaryInt||0)+3; p.bonusFireDmgPct=(p.bonusFireDmgPct||0)+12; p.recomputeStats();}},
    {id:'sz_tka', x:850, y:340, type:'keystone', connections:['sz_ta1','sz_mb1'], name:'Phoenix Heart', desc:'Spells deal +35% Dmg, +20 Mana', apply:(p)=>{p.baseDmgMult*=1.350; p.recomputeStats(); p.baseMaxResource+=20; p.recomputeStats();}},
    {id:'sz_ma', x:200, y:700, type:'minor',   connections:['sz0','sz_m1'], name:'Arcane Font', desc:'+10 Mana', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'sz_m1', x:330, y:700, type:'minor',   connections:['sz_ma','sz_m2','sz_mn'], name:'Arcane Font II', desc:'+10 Mana, +4% Dmg', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'sz_mn', x:460, y:700, type:'notable',  connections:['sz_m1','sz_m2','sz_m3','sz_m4','sz_m5'], name:'Arcane Mastery', desc:'+20 Mana, +8% Dmg', apply:(p)=>{p.baseMaxResource+=20; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sz_m2', x:400, y:620, type:'minor',   connections:['sz_m1','sz_mn','sz_m3'], name:'Mana Surge', desc:'+12 Mana', apply:(p)=>{p.baseMaxResource+=12; p.recomputeStats();}},
    {id:'sz_m3', x:540, y:620, type:'minor',   connections:['sz_m2','sz_mn','sz_m4'], name:'Arcane Flood', desc:'+10 Mana, +4% Dmg', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'sz_m4', x:590, y:700, type:'minor',   connections:['sz_m3','sz_mn','sz_m5'], name:'Deep Well', desc:'+15 Mana', apply:(p)=>{p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'sz_m5', x:540, y:780, type:'minor',   connections:['sz_m4','sz_mn','sz_m6'], name:'Spell Echo', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sz_m6', x:400, y:780, type:'minor',   connections:['sz_m5','sz_ma2'], name:'Overload', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'sz_ma2', x:690, y:700, type:'passive',  connections:['sz_mn','sz_m6'], name:'Arc Mastery', desc:'+2 INT, +2 SPI, +10% Lightning Dmg', apply:(p)=>{p.primaryInt=(p.primaryInt||0)+2; p.primarySpi=(p.primarySpi||0)+2; p.bonusLightDmgPct=(p.bonusLightDmgPct||0)+10; p.recomputeStats();}},
    {id:'sz_ba', x:200, y:880, type:'minor',   connections:['sz0','sz_b1'], name:'Frost Veil', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'sz_b1', x:330, y:1030, type:'minor',   connections:['sz_ba','sz_b2','sz_bn'], name:'Frost Veil II', desc:'+4% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'sz_bn', x:460, y:1120, type:'notable',  connections:['sz_b1','sz_b2','sz_b3','sz_b4','sz_b5'], name:'Ice Mastery', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'sz_b2', x:400, y:1050, type:'minor',   connections:['sz_b1','sz_bn','sz_b3'], name:'Chill Touch', desc:'+5 Crit', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats();}},
    {id:'sz_b3', x:540, y:1060, type:'minor',   connections:['sz_b2','sz_bn','sz_b4'], name:'Frost Bite', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'sz_b4', x:590, y:1130, type:'minor',   connections:['sz_b3','sz_bn','sz_b5'], name:'Deep Freeze', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sz_b5', x:540, y:1200, type:'minor',   connections:['sz_b4','sz_bn','sz_b6'], name:'Shatter', desc:'+8% Crit Dmg', apply:(p)=>{p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'sz_b6', x:400, y:1200, type:'minor',   connections:['sz_b5','sz_b7'], name:'Blizzard Arts', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sz_b7', x:680, y:1160, type:'minor',   connections:['sz_b6','sz_bn','sz_bka'], name:'Arctic Core', desc:'+5 Crit, +10 Mana', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'sz_bka', x:850, y:1060, type:'keystone', connections:['sz_b7','sz_mb2'], name:'Frozen World', desc:'Crits chill enemies. +15% Dmg, +10 Crit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats(); p.baseCritDmg+=0.10; p.recomputeStats();}},
    {id:'sz_mb1', x:1010, y:490, type:'notable',  connections:['sz_tka','sz_mb2','sz_lta','sz_lt1'], name:'Spell Surge', desc:'+15% Dmg, +15 Mana', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'sz_mb2', x:1010, y:910, type:'notable',  connections:['sz_bka','sz_mb1','sz_lba','sz_lb1'], name:'Elemental Fury', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'sz_lta', x:1170, y:360, type:'passive',  connections:['sz_mb1','sz_lt1'], name:'Arcane Resonance', desc:'+4 INT, +10% All Elemental Dmg', apply:(p)=>{p.primaryInt=(p.primaryInt||0)+4; p.bonusFireDmgPct=(p.bonusFireDmgPct||0)+10; p.bonusLightDmgPct=(p.bonusLightDmgPct||0)+10; p.bonusPoisonDmgPct=(p.bonusPoisonDmgPct||0)+10; p.bonusColdDmgPct=(p.bonusColdDmgPct||0)+10; p.recomputeStats();}},
    {id:'sz_lt1', x:1290, y:290, type:'minor',   connections:['sz_lta','sz_lt2','sz_ltn'], name:'Impact Crater', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'sz_ltn', x:1420, y:310, type:'notable',  connections:['sz_lt1','sz_lt2','sz_lt3','sz_lma'], name:'Cataclysm', desc:'+18% Dmg, +20 Mana', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxResource+=20; p.recomputeStats();}},
    {id:'sz_lt2', x:1350, y:210, type:'minor',   connections:['sz_lt1','sz_ltn','sz_lt3'], name:'Arcane Blast', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'sz_lt3', x:1470, y:230, type:'minor',   connections:['sz_lt2','sz_ltn'], name:'Spell Storm', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'sz_lba', x:1170, y:1040, type:'passive',  connections:['sz_mb2','sz_lb1'], name:'Mana Font', desc:'+3 SPI, +20 Resource, -6% Ability Cost', apply:(p)=>{p.primarySpi=(p.primarySpi||0)+3; p.bonusMaxResource+=20; p.abilityCostMult=Math.max(0.4,(p.abilityCostMult||1)-0.06); p.recomputeStats();}},
    {id:'sz_lb1', x:1290, y:1010, type:'minor',   connections:['sz_lba','sz_lb2','sz_lbn'], name:'Mana Burst', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'sz_lbn', x:1420, y:990, type:'notable',  connections:['sz_lb1','sz_lb2','sz_lb3','sz_lma'], name:'Power Surge', desc:'+15% Dmg, +12 Crit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseCritChance+=12; p.recomputeStats();}},
    {id:'sz_lb2', x:1350, y:1090, type:'minor',   connections:['sz_lb1','sz_lbn','sz_lb3'], name:'Arcane Crit', desc:'+10 Crit', apply:(p)=>{p.baseCritChance+=10; p.recomputeStats();}},
    {id:'sz_lb3', x:1470, y:1070, type:'minor',   connections:['sz_lb2','sz_lbn'], name:'Overcharge', desc:'+12% Dmg, +8% Crit Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'sz_lma', x:1590, y:700, type:'notable',  connections:['sz_ltn','sz_lbn','sz_lm1','sz_lm2'], name:'Arcane Peak', desc:'+18% Dmg, +25 Mana', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxResource+=25; p.recomputeStats();}},
    {id:'sz_lm1', x:1710, y:620, type:'minor',   connections:['sz_lma','sz_lm2','sz_ap'], name:'Spell Mastery', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'sz_lm2', x:1710, y:780, type:'minor',   connections:['sz_lma','sz_lm1','sz_ap'], name:'Mana Torrent', desc:'+12 Crit, +20 Mana', apply:(p)=>{p.baseCritChance+=12; p.recomputeStats(); p.baseMaxResource+=20; p.recomputeStats();}},
    {id:'sz_ap', x:1880, y:700, type:'notable',  connections:['sz_lm1','sz_lm2','sz_ap1','sz_ap2','sz_ap3'], name:'Arcane God', desc:'+22% Dmg, +30 Mana', apply:(p)=>{p.baseDmgMult*=1.220; p.recomputeStats(); p.baseMaxResource+=30; p.recomputeStats();}},
    {id:'sz_ap1', x:2000, y:610, type:'minor',   connections:['sz_ap','sz_ap2','sz_pre'], name:'Glass Cannon', desc:'+15% Dmg', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats();}},
    {id:'sz_ap2', x:2000, y:700, type:'minor',   connections:['sz_ap','sz_ap1','sz_ap3'], name:'Arcane Apex', desc:'+12 Crit, +12% Crit Dmg', apply:(p)=>{p.baseCritChance+=12; p.recomputeStats(); p.baseCritDmg+=0.12; p.recomputeStats();}},
    {id:'sz_ap3', x:2000, y:790, type:'minor',   connections:['sz_ap','sz_ap2','sz_pre'], name:'Mana Pool', desc:'+30 Mana, +10% Dmg', apply:(p)=>{p.baseMaxResource+=30; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'sz_pre', x:2170, y:700, type:'minor',   connections:['sz_ap1','sz_ap3','sz_cap'], name:'Singularity', desc:'+15% Dmg, +20 Mana', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxResource+=20; p.recomputeStats();}},
    {id:'sz_cap', x:2340, y:700, type:'keystone', connections:['sz_pre'], name:'Singularity', desc:'Spells chain to extra targets. +30% Dmg, +20 Crit', apply:(p)=>{p.baseDmgMult*=1.300; p.recomputeStats(); p.baseCritChance+=20; p.recomputeStats(); p.baseMaxResource+=30; p.recomputeStats();}}
  ]},
  // -- TEMPLAR --
  templar: { nodes: [
    {id:'tp0', x:80, y:700, type:'minor', origin:true,   connections:['tp_ta','tp_ma','tp_ba'], name:'Balanced Stance', desc:'+5% Dmg, +10 Chi', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'tp_ta', x:200, y:520, type:'minor',   connections:['tp0','tp_t1'], name:'Wind Step', desc:'+4% Speed', apply:(p)=>{p.baseSpeed*=1.040; p.recomputeStats();}},
    {id:'tp_t1', x:330, y:380, type:'minor',   connections:['tp_ta','tp_t2','tp_tn'], name:'Wind Step II', desc:'+4% Speed, +4% Dmg', apply:(p)=>{p.baseSpeed*=1.040; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'tp_tn', x:460, y:280, type:'notable',  connections:['tp_t1','tp_t2','tp_t3','tp_t4','tp_t5'], name:'Swift Wind', desc:'+8% Speed, +8% Dmg', apply:(p)=>{p.baseSpeed*=1.080; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'tp_t2', x:400, y:200, type:'minor',   connections:['tp_t1','tp_tn','tp_t3'], name:'Gust Strike', desc:'+5% Speed', apply:(p)=>{p.baseSpeed*=1.050; p.recomputeStats();}},
    {id:'tp_t3', x:540, y:190, type:'minor',   connections:['tp_t2','tp_tn','tp_t4'], name:'Storm Fist', desc:'+5% Speed, +5% Dmg', apply:(p)=>{p.baseSpeed*=1.050; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'tp_t4', x:600, y:290, type:'minor',   connections:['tp_t3','tp_tn','tp_t5'], name:'Hurricane Palm', desc:'+6% Speed', apply:(p)=>{p.baseSpeed*=1.060; p.recomputeStats();}},
    {id:'tp_t5', x:560, y:390, type:'minor',   connections:['tp_t4','tp_tn','tp_t6'], name:'Tempest Flow', desc:'+4% Speed, +5% Dmg', apply:(p)=>{p.baseSpeed*=1.040; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'tp_t6', x:470, y:420, type:'minor',   connections:['tp_t5','tp_ta1'], name:'Wind Walker', desc:'+6% Speed', apply:(p)=>{p.baseSpeed*=1.060; p.recomputeStats();}},
    {id:'tp_ta1', x:690, y:320, type:'passive',  connections:['tp_t6','tp_tn','tp_tka'], name:'Iron Constitution', desc:'+3 VIT, +30 HP, +5% Cold Resist', apply:(p)=>{p.primaryVit=(p.primaryVit||0)+3; p.baseMaxHp+=30; p.bonusColdResist=(p.bonusColdResist||0)+5; p.recomputeStats();}},
    {id:'tp_tka', x:850, y:340, type:'keystone', connections:['tp_ta1','tp_mb1'], name:'Wind Master', desc:'Speed +25%, attacks deal +20% Dmg', apply:(p)=>{p.baseSpeed*=1.250; p.recomputeStats(); p.baseDmgMult*=1.200; p.recomputeStats();}},
    {id:'tp_ma', x:200, y:700, type:'minor',   connections:['tp0','tp_m1'], name:'Chi Flow', desc:'+10 Chi', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'tp_m1', x:330, y:700, type:'minor',   connections:['tp_ma','tp_m2','tp_mn'], name:'Chi Flow II', desc:'+10 Chi, +4% Dmg', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'tp_mn', x:460, y:700, type:'notable',  connections:['tp_m1','tp_m2','tp_m3','tp_m4','tp_m5'], name:'Chi Mastery', desc:'+20 Chi, +8% Dmg', apply:(p)=>{p.baseMaxResource+=20; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'tp_m2', x:400, y:620, type:'minor',   connections:['tp_m1','tp_mn','tp_m3'], name:'Inner Fire', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'tp_m3', x:540, y:620, type:'minor',   connections:['tp_m2','tp_mn','tp_m4'], name:'Resonance', desc:'+10 Chi, +5% Dmg', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'tp_m4', x:590, y:700, type:'minor',   connections:['tp_m3','tp_mn','tp_m5'], name:'Harmony', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'tp_m5', x:540, y:780, type:'minor',   connections:['tp_m4','tp_mn','tp_m6'], name:'Balance Point', desc:'+5% Dmg, +5% Speed', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseSpeed*=1.050; p.recomputeStats();}},
    {id:'tp_m6', x:400, y:780, type:'minor',   connections:['tp_m5','tp_ma2'], name:'Enlightened', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'tp_ma2', x:690, y:700, type:'passive',  connections:['tp_mn','tp_m6'], name:'Martial Mastery', desc:'+2 VIT, +2 STR, +10% Dmg', apply:(p)=>{p.primaryVit=(p.primaryVit||0)+2; p.primaryStr=(p.primaryStr||0)+2; p.baseDmgMult*=1.10; p.recomputeStats();}},
    {id:'tp_ba', x:200, y:880, type:'minor',   connections:['tp0','tp_b1'], name:'Iron Defense', desc:'+10 HP', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats();}},
    {id:'tp_b1', x:330, y:1030, type:'minor',   connections:['tp_ba','tp_b2','tp_bn'], name:'Iron Defense II', desc:'+10 HP, +6 Armor', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats(); p.baseArmor+=6; p.recomputeStats();}},
    {id:'tp_bn', x:460, y:1120, type:'notable',  connections:['tp_b1','tp_b2','tp_b3','tp_b4','tp_b5'], name:'Iron Body', desc:'+20 HP, +10 Armor', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=10; p.recomputeStats();}},
    {id:'tp_b2', x:400, y:1050, type:'minor',   connections:['tp_b1','tp_bn','tp_b3'], name:'Jade Shield', desc:'+8 Armor', apply:(p)=>{p.baseArmor+=8; p.recomputeStats();}},
    {id:'tp_b3', x:540, y:1060, type:'minor',   connections:['tp_b2','tp_bn','tp_b4'], name:'Stone Skin', desc:'+10 HP, +5 Armor', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats(); p.baseArmor+=5; p.recomputeStats();}},
    {id:'tp_b4', x:590, y:1130, type:'minor',   connections:['tp_b3','tp_bn','tp_b5'], name:'Iron Will', desc:'+15 HP', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'tp_b5', x:540, y:1200, type:'minor',   connections:['tp_b4','tp_bn','tp_b6'], name:'Fortress', desc:'+8 Armor, +8 HP', apply:(p)=>{p.baseArmor+=8; p.recomputeStats(); p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'tp_b6', x:400, y:1200, type:'minor',   connections:['tp_b5','tp_b7'], name:'Mountain Stance', desc:'+3% Life Steal', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'tp_b7', x:680, y:1160, type:'minor',   connections:['tp_b6','tp_bn','tp_bka'], name:'Immovable', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'tp_bka', x:850, y:1060, type:'keystone', connections:['tp_b7','tp_mb2'], name:'Iron Templar', desc:'+30 HP, +15 Armor, +3% Life Steal', apply:(p)=>{p.baseMaxHp+=30; p.recomputeStats(); p.baseArmor+=15; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'tp_mb1', x:1010, y:490, type:'notable',  connections:['tp_tka','tp_mb2','tp_lta','tp_lt1'], name:'Wind Fist', desc:'+15% Dmg, +10% Speed', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseSpeed*=1.100; p.recomputeStats();}},
    {id:'tp_mb2', x:1010, y:910, type:'notable',  connections:['tp_bka','tp_mb1','tp_lba','tp_lb1'], name:'Steel Chi', desc:'+12% Dmg, +15 HP', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'tp_lta', x:1170, y:360, type:'passive',  connections:['tp_mb1','tp_lt1'], name:'Frostfist', desc:'+4 VIT, +12% Cold Dmg', apply:(p)=>{p.primaryVit=(p.primaryVit||0)+4; p.bonusColdDmgPct=(p.bonusColdDmgPct||0)+12; p.recomputeStats();}},
    {id:'tp_lt1', x:1290, y:290, type:'minor',   connections:['tp_lta','tp_lt2','tp_ltn'], name:'Cyclone Arts', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'tp_ltn', x:1420, y:310, type:'notable',  connections:['tp_lt1','tp_lt2','tp_lt3','tp_lma'], name:'Vortex Palm', desc:'+18% Dmg, +15% Speed', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseSpeed*=1.150; p.recomputeStats();}},
    {id:'tp_lt2', x:1350, y:210, type:'minor',   connections:['tp_lt1','tp_ltn','tp_lt3'], name:'Eye of Storm', desc:'+10% Speed', apply:(p)=>{p.baseSpeed*=1.100; p.recomputeStats();}},
    {id:'tp_lt3', x:1470, y:230, type:'minor',   connections:['tp_lt2','tp_ltn'], name:'Storm Master', desc:'+12% Dmg, +8% Speed', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseSpeed*=1.080; p.recomputeStats();}},
    {id:'tp_lba', x:1170, y:1040, type:'passive',  connections:['tp_mb2','tp_lb1'], name:'Undying Will', desc:'+3 STR, +12 Armor, +1.5 HP Regen', apply:(p)=>{p.primaryStr=(p.primaryStr||0)+3; p.baseArmor+=12; p.bonusRegen+=1.5; p.recomputeStats();}},
    {id:'tp_lb1', x:1290, y:1010, type:'minor',   connections:['tp_lba','tp_lb2','tp_lbn'], name:'Ascended', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'tp_lbn', x:1420, y:990, type:'notable',  connections:['tp_lb1','tp_lb2','tp_lb3','tp_lma'], name:'Nirvana Strike', desc:'+15% Dmg, +20 Chi', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxResource+=20; p.recomputeStats();}},
    {id:'tp_lb2', x:1350, y:1090, type:'minor',   connections:['tp_lb1','tp_lbn','tp_lb3'], name:'Pure Chi', desc:'+15 Chi', apply:(p)=>{p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'tp_lb3', x:1470, y:1070, type:'minor',   connections:['tp_lb2','tp_lbn'], name:'Chi Burst', desc:'+12% Dmg, +10 Chi', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'tp_lma', x:1590, y:700, type:'notable',  connections:['tp_ltn','tp_lbn','tp_lm1','tp_lm2'], name:'Templar Peak', desc:'+18% Dmg, +20% Speed', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseSpeed*=1.200; p.recomputeStats();}},
    {id:'tp_lm1', x:1710, y:620, type:'minor',   connections:['tp_lma','tp_lm2','tp_ap'], name:'Fist Mastery', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'tp_lm2', x:1710, y:780, type:'minor',   connections:['tp_lma','tp_lm1','tp_ap'], name:'Chi Overload', desc:'+20 Chi, +8% Dmg', apply:(p)=>{p.baseMaxResource+=20; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'tp_ap', x:1880, y:700, type:'notable',  connections:['tp_lm1','tp_lm2','tp_ap1','tp_ap2','tp_ap3'], name:'Enlightenment', desc:'+22% Dmg, +30 Chi', apply:(p)=>{p.baseDmgMult*=1.220; p.recomputeStats(); p.baseMaxResource+=30; p.recomputeStats();}},
    {id:'tp_ap1', x:2000, y:610, type:'minor',   connections:['tp_ap','tp_ap2','tp_pre'], name:'Wind God', desc:'+12% Speed', apply:(p)=>{p.baseSpeed*=1.120; p.recomputeStats();}},
    {id:'tp_ap2', x:2000, y:700, type:'minor',   connections:['tp_ap','tp_ap1','tp_ap3'], name:'Chi God', desc:'+15% Dmg', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats();}},
    {id:'tp_ap3', x:2000, y:790, type:'minor',   connections:['tp_ap','tp_ap2','tp_pre'], name:'Iron God', desc:'+20 HP, +10 Armor', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=10; p.recomputeStats();}},
    {id:'tp_pre', x:2170, y:700, type:'minor',   connections:['tp_ap1','tp_ap3','tp_cap'], name:'Path of Light', desc:'+15% Dmg, +10% Speed', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseSpeed*=1.100; p.recomputeStats();}},
    {id:'tp_cap', x:2340, y:700, type:'keystone', connections:['tp_pre'], name:'Enlightenment', desc:'Full Chi triggers auto Divine Judgment. +25% Dmg', apply:(p)=>{p.baseDmgMult*=1.250; p.recomputeStats(); p.baseSpeed*=1.200; p.recomputeStats(); p.baseMaxResource+=30; p.recomputeStats();}}
  ]},
  // -- CRUSADER --
  crusader: { nodes: [
    {id:'cr0', x:80, y:700, type:'minor', origin:true,   connections:['cr_ta','cr_ma','cr_ba'], name:'Holy Oath', desc:'+5% Dmg, +15 HP', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'cr_ta', x:200, y:520, type:'minor',   connections:['cr0','cr_t1'], name:'Holy Light', desc:'+8 HP', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'cr_t1', x:330, y:380, type:'minor',   connections:['cr_ta','cr_t2','cr_tn'], name:'Holy Light II', desc:'+8 HP, +4% Dmg', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'cr_tn', x:460, y:280, type:'notable',  connections:['cr_t1','cr_t2','cr_t3','cr_t4','cr_t5'], name:'Divine Aura', desc:'+20 HP, +8% Dmg', apply:(p)=>{p.baseMaxHp+=20; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'cr_t2', x:400, y:200, type:'minor',   connections:['cr_t1','cr_tn','cr_t3'], name:'Holy Mend', desc:'+3% Life Steal', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'cr_t3', x:540, y:190, type:'minor',   connections:['cr_t2','cr_tn','cr_t4'], name:'Sacred Light', desc:'+10 HP, +4% Dmg', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'cr_t4', x:600, y:290, type:'minor',   connections:['cr_t3','cr_tn','cr_t5'], name:'Blessed', desc:'+15 HP', apply:(p)=>{p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'cr_t5', x:560, y:390, type:'minor',   connections:['cr_t4','cr_tn','cr_t6'], name:'Holy Vigor', desc:'+8 HP, +4% Dmg', apply:(p)=>{p.baseMaxHp+=8; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'cr_t6', x:470, y:420, type:'minor',   connections:['cr_t5','cr_ta1'], name:'Radiant', desc:'+3% Life Steal', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'cr_ta1', x:690, y:320, type:'passive',  connections:['cr_t6','cr_tn','cr_tka'], name:'Sacred Flame', desc:'+3 STR, +12% Fire Dmg', apply:(p)=>{p.primaryStr=(p.primaryStr||0)+3; p.bonusFireDmgPct=(p.bonusFireDmgPct||0)+12; p.recomputeStats();}},
    {id:'cr_tka', x:850, y:340, type:'keystone', connections:['cr_ta1','cr_mb1'], name:'Holy Champion', desc:'Healing +50%. +25 HP, +3% Life Steal', apply:(p)=>{p.baseMaxHp+=25; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'cr_ma', x:200, y:700, type:'minor',   connections:['cr0','cr_m1'], name:'Crusader Shield', desc:'+8 Armor', apply:(p)=>{p.baseArmor+=8; p.recomputeStats();}},
    {id:'cr_m1', x:330, y:700, type:'minor',   connections:['cr_ma','cr_m2','cr_mn'], name:'Crusader Shield II', desc:'+8 Armor, +8 HP', apply:(p)=>{p.baseArmor+=8; p.recomputeStats(); p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'cr_mn', x:460, y:700, type:'notable',  connections:['cr_m1','cr_m2','cr_m3','cr_m4','cr_m5'], name:'Holy Bulwark', desc:'+20 Armor, +20 HP', apply:(p)=>{p.baseArmor+=20; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats();}},
    {id:'cr_m2', x:400, y:620, type:'minor',   connections:['cr_m1','cr_mn','cr_m3'], name:'Fortress', desc:'+10 Armor', apply:(p)=>{p.baseArmor+=10; p.recomputeStats();}},
    {id:'cr_m3', x:540, y:620, type:'minor',   connections:['cr_m2','cr_mn','cr_m4'], name:'Iron Faith', desc:'+10 HP, +8 Armor', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats(); p.baseArmor+=8; p.recomputeStats();}},
    {id:'cr_m4', x:590, y:700, type:'minor',   connections:['cr_m3','cr_mn','cr_m5'], name:'Adamant', desc:'+12 Armor', apply:(p)=>{p.baseArmor+=12; p.recomputeStats();}},
    {id:'cr_m5', x:540, y:780, type:'minor',   connections:['cr_m4','cr_mn','cr_m6'], name:'Bulwark of Faith', desc:'+10 HP, +5 Armor', apply:(p)=>{p.baseMaxHp+=10; p.recomputeStats(); p.baseArmor+=5; p.recomputeStats();}},
    {id:'cr_m6', x:400, y:780, type:'minor',   connections:['cr_m5','cr_ma2'], name:'Righteous Shield', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'cr_ma2', x:690, y:700, type:'passive',  connections:['cr_mn','cr_m6'], name:'Aegis Mastery', desc:'+2 STR, +2 VIT, +12 Armor', apply:(p)=>{p.primaryStr=(p.primaryStr||0)+2; p.primaryVit=(p.primaryVit||0)+2; p.baseArmor+=12; p.recomputeStats();}},
    {id:'cr_ba', x:200, y:880, type:'minor',   connections:['cr0','cr_b1'], name:'Wrath Arts', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'cr_b1', x:330, y:1030, type:'minor',   connections:['cr_ba','cr_b2','cr_bn'], name:'Wrath Arts II', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'cr_bn', x:460, y:1120, type:'notable',  connections:['cr_b1','cr_b2','cr_b3','cr_b4','cr_b5'], name:'Righteous Fury', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'cr_b2', x:400, y:1050, type:'minor',   connections:['cr_b1','cr_bn','cr_b3'], name:'Holy Wrath', desc:'+6% Dmg', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats();}},
    {id:'cr_b3', x:540, y:1060, type:'minor',   connections:['cr_b2','cr_bn','cr_b4'], name:'Consecrated Blade', desc:'+6% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'cr_b4', x:590, y:1130, type:'minor',   connections:['cr_b3','cr_bn','cr_b5'], name:'Divine Smite', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'cr_b5', x:540, y:1200, type:'minor',   connections:['cr_b4','cr_bn','cr_b6'], name:'Holy Judgment', desc:'+5 Crit, +8% Crit Dmg', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats(); p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'cr_b6', x:400, y:1200, type:'minor',   connections:['cr_b5','cr_b7'], name:'Wrath of God', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'cr_b7', x:680, y:1160, type:'minor',   connections:['cr_b6','cr_bn','cr_bka'], name:'Crusader Edge', desc:'+8% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'cr_bka', x:850, y:1060, type:'keystone', connections:['cr_b7','cr_mb2'], name:'Eternal Crusade', desc:'Max Wrath triggers burst. +15% Dmg, +10 Crit', apply:(p)=>{p.baseDmgMult*=1.200; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'cr_mb1', x:1010, y:490, type:'notable',  connections:['cr_tka','cr_mb2','cr_lta','cr_lt1'], name:'Holy Warrior', desc:'+15% Dmg, +20 HP', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats();}},
    {id:'cr_mb2', x:1010, y:910, type:'notable',  connections:['cr_bka','cr_mb1','cr_lba','cr_lb1'], name:'Sacred Fury', desc:'+12% Dmg, +10 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'cr_lta', x:1170, y:360, type:'passive',  connections:['cr_mb1','cr_lt1'], name:'Hammer Mastery', desc:'+4 STR, +12% Fire Dmg, +8% Dmg', apply:(p)=>{p.primaryStr=(p.primaryStr||0)+4; p.bonusFireDmgPct=(p.bonusFireDmgPct||0)+12; p.baseDmgMult*=1.08; p.recomputeStats();}},
    {id:'cr_lt1', x:1290, y:290, type:'minor',   connections:['cr_lta','cr_lt2','cr_ltn'], name:'Justice Strike', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'cr_ltn', x:1420, y:310, type:'notable',  connections:['cr_lt1','cr_lt2','cr_lt3','cr_lma'], name:'Divine Hammer', desc:'+18% Dmg, +25 HP', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxHp+=25; p.recomputeStats();}},
    {id:'cr_lt2', x:1350, y:210, type:'minor',   connections:['cr_lt1','cr_ltn','cr_lt3'], name:'Verdict', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'cr_lt3', x:1470, y:230, type:'minor',   connections:['cr_lt2','cr_ltn'], name:'Execution', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'cr_lba', x:1170, y:1040, type:'passive',  connections:['cr_mb2','cr_lb1'], name:'Divine Armor', desc:'+3 VIT, +35 HP, +6% Fire Resist', apply:(p)=>{p.primaryVit=(p.primaryVit||0)+3; p.baseMaxHp+=35; p.bonusFireResist=(p.bonusFireResist||0)+6; p.recomputeStats();}},
    {id:'cr_lb1', x:1290, y:1010, type:'minor',   connections:['cr_lba','cr_lb2','cr_lbn'], name:'Heaven Smite', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'cr_lbn', x:1420, y:990, type:'notable',  connections:['cr_lb1','cr_lb2','cr_lb3','cr_lma'], name:'Wrath Storm', desc:'+15% Dmg, +12 Crit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseCritChance+=12; p.recomputeStats();}},
    {id:'cr_lb2', x:1350, y:1090, type:'minor',   connections:['cr_lb1','cr_lbn','cr_lb3'], name:'Holy Fury', desc:'+8 Crit', apply:(p)=>{p.baseCritChance+=8; p.recomputeStats();}},
    {id:'cr_lb3', x:1470, y:1070, type:'minor',   connections:['cr_lb2','cr_lbn'], name:'Crusade', desc:'+12% Dmg, +10 HP', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxHp+=10; p.recomputeStats();}},
    {id:'cr_lma', x:1590, y:700, type:'notable',  connections:['cr_ltn','cr_lbn','cr_lm1','cr_lm2'], name:'Crusader Peak', desc:'+18% Dmg, +25 HP', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxHp+=25; p.recomputeStats();}},
    {id:'cr_lm1', x:1710, y:620, type:'minor',   connections:['cr_lma','cr_lm2','cr_ap'], name:'Holy Mastery', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'cr_lm2', x:1710, y:780, type:'minor',   connections:['cr_lma','cr_lm1','cr_ap'], name:'Divine Power', desc:'+10 Crit, +10% Crit Dmg', apply:(p)=>{p.baseCritChance+=10; p.recomputeStats(); p.baseCritDmg+=0.10; p.recomputeStats();}},
    {id:'cr_ap', x:1880, y:700, type:'notable',  connections:['cr_lm1','cr_lm2','cr_ap1','cr_ap2','cr_ap3'], name:'Champion of Light', desc:'+22% Dmg, +30 HP', apply:(p)=>{p.baseDmgMult*=1.220; p.recomputeStats(); p.baseMaxHp+=30; p.recomputeStats();}},
    {id:'cr_ap1', x:2000, y:610, type:'minor',   connections:['cr_ap','cr_ap2','cr_pre'], name:'Holy Lance', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'cr_ap2', x:2000, y:700, type:'minor',   connections:['cr_ap','cr_ap1','cr_ap3'], name:'Blessed Blade', desc:'+10 Crit, +12% Crit Dmg', apply:(p)=>{p.baseCritChance+=10; p.recomputeStats(); p.baseCritDmg+=0.12; p.recomputeStats();}},
    {id:'cr_ap3', x:2000, y:790, type:'minor',   connections:['cr_ap','cr_ap2','cr_pre'], name:'Sacred Armor', desc:'+25 HP, +10 Armor', apply:(p)=>{p.baseMaxHp+=25; p.recomputeStats(); p.baseArmor+=10; p.recomputeStats();}},
    {id:'cr_pre', x:2170, y:700, type:'minor',   connections:['cr_ap1','cr_ap3','cr_cap'], name:'Eternal Light', desc:'+15% Dmg, +20 HP', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats();}},
    {id:'cr_cap', x:2340, y:700, type:'keystone', connections:['cr_pre'], name:'Eternal Crusade', desc:'Full Wrath procs auto-smite. +30% Dmg, +35 HP', apply:(p)=>{p.baseDmgMult*=1.300; p.recomputeStats(); p.baseMaxHp+=35; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}}
  ]},
  // -- DRUID --
  druid: { nodes: [
    {id:'dr0', x:80, y:700, type:'minor', origin:true,   connections:['dr_ta','dr_ma','dr_ba'], name:'Nature Bond', desc:'+5% Dmg, +10 Spirit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'dr_ta', x:200, y:520, type:'minor',   connections:['dr0','dr_t1'], name:'Thorn Skin', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'dr_t1', x:330, y:380, type:'minor',   connections:['dr_ta','dr_t2','dr_tn'], name:'Thorn Skin II', desc:'+4% Dmg, +8 HP', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'dr_tn', x:460, y:280, type:'notable',  connections:['dr_t1','dr_t2','dr_t3','dr_t4','dr_t5'], name:'Primal Force', desc:'+12% Dmg, +15 HP', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'dr_t2', x:400, y:200, type:'minor',   connections:['dr_t1','dr_tn','dr_t3'], name:'Wild Thorns', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'dr_t3', x:540, y:190, type:'minor',   connections:['dr_t2','dr_tn','dr_t4'], name:'Barbed Hide', desc:'+6% Dmg, +8 HP', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'dr_t4', x:600, y:290, type:'minor',   connections:['dr_t3','dr_tn','dr_t5'], name:'Nature Wrath', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'dr_t5', x:560, y:390, type:'minor',   connections:['dr_t4','dr_tn','dr_t6'], name:'Primal Fury', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'dr_t6', x:470, y:420, type:'minor',   connections:['dr_t5','dr_ta1'], name:'Wild Rage', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'dr_ta1', x:690, y:320, type:'passive',  connections:['dr_t6','dr_tn','dr_tka'], name:"Nature's Wrath", desc:'+3 SPI, +12% Poison Dmg', apply:(p)=>{p.primarySpi=(p.primarySpi||0)+3; p.bonusPoisonDmgPct=(p.bonusPoisonDmgPct||0)+12; p.recomputeStats();}},
    {id:'dr_tka', x:850, y:340, type:'keystone', connections:['dr_ta1','dr_mb1'], name:'Living Forest', desc:'Thorns reflect 30% dmg. +20% Dmg, +20 HP', apply:(p)=>{p.baseDmgMult*=1.200; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats(); p.baseArmor+=10; p.recomputeStats();}},
    {id:'dr_ma', x:200, y:700, type:'minor',   connections:['dr0','dr_m1'], name:'Spirit Regen', desc:'+10 Spirit', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'dr_m1', x:330, y:700, type:'minor',   connections:['dr_ma','dr_m2','dr_mn'], name:'Spirit Regen II', desc:'+10 Spirit, +5% Dmg', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'dr_mn', x:460, y:700, type:'notable',  connections:['dr_m1','dr_m2','dr_m3','dr_m4','dr_m5'], name:'Spirit Surge', desc:'+20 Spirit, +8% Dmg', apply:(p)=>{p.baseMaxResource+=20; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'dr_m2', x:400, y:620, type:'minor',   connections:['dr_m1','dr_mn','dr_m3'], name:'Nature Flow', desc:'+12 Spirit', apply:(p)=>{p.baseMaxResource+=12; p.recomputeStats();}},
    {id:'dr_m3', x:540, y:620, type:'minor',   connections:['dr_m2','dr_mn','dr_m4'], name:'Forest Heart', desc:'+10 Spirit, +5% Dmg', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'dr_m4', x:590, y:700, type:'minor',   connections:['dr_m3','dr_mn','dr_m5'], name:'Grove', desc:'+15 Spirit', apply:(p)=>{p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'dr_m5', x:540, y:780, type:'minor',   connections:['dr_m4','dr_mn','dr_m6'], name:'Sylvan Power', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'dr_m6', x:400, y:780, type:'minor',   connections:['dr_m5','dr_ma2'], name:'Ancient Power', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'dr_ma2', x:690, y:700, type:'passive',  connections:['dr_mn','dr_m6'], name:'Pack Leader', desc:'+2 SPI, +2 INT, +10% Dmg', apply:(p)=>{p.primarySpi=(p.primarySpi||0)+2; p.primaryInt=(p.primaryInt||0)+2; p.baseDmgMult*=1.10; p.recomputeStats();}},
    {id:'dr_ba', x:200, y:880, type:'minor',   connections:['dr0','dr_b1'], name:'Storm Call', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'dr_b1', x:330, y:1030, type:'minor',   connections:['dr_ba','dr_b2','dr_bn'], name:'Storm Call II', desc:'+4% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'dr_bn', x:460, y:1120, type:'notable',  connections:['dr_b1','dr_b2','dr_b3','dr_b4','dr_b5'], name:'Storm Master', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'dr_b2', x:400, y:1050, type:'minor',   connections:['dr_b1','dr_bn','dr_b3'], name:'Thunder Fist', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'dr_b3', x:540, y:1060, type:'minor',   connections:['dr_b2','dr_bn','dr_b4'], name:'Storm Eye', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'dr_b4', x:590, y:1130, type:'minor',   connections:['dr_b3','dr_bn','dr_b5'], name:'Tempest', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'dr_b5', x:540, y:1200, type:'minor',   connections:['dr_b4','dr_bn','dr_b6'], name:'Lightning Body', desc:'+5 Crit, +8 HP', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats(); p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'dr_b6', x:400, y:1200, type:'minor',   connections:['dr_b5','dr_b7'], name:'Nature Lightning', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'dr_b7', x:680, y:1160, type:'minor',   connections:['dr_b6','dr_bn','dr_bka'], name:'Solar Strike', desc:'+6% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'dr_bka', x:850, y:1060, type:'keystone', connections:['dr_b7','dr_mb2'], name:'Storm Form', desc:'Storm Strike hits 3 targets. +15% Dmg, +10 Crit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats(); p.baseCritDmg+=0.10; p.recomputeStats();}},
    {id:'dr_mb1', x:1010, y:490, type:'notable',  connections:['dr_tka','dr_mb2','dr_lta','dr_lt1'], name:'Wild Power', desc:'+15% Dmg, +20 HP', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats();}},
    {id:'dr_mb2', x:1010, y:910, type:'notable',  connections:['dr_bka','dr_mb1','dr_lba','dr_lb1'], name:'Primal Storm', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'dr_lta', x:1170, y:360, type:'passive',  connections:['dr_mb1','dr_lt1'], name:'Storm Caller', desc:'+4 SPI, +12% Lightning Dmg', apply:(p)=>{p.primarySpi=(p.primarySpi||0)+4; p.bonusLightDmgPct=(p.bonusLightDmgPct||0)+12; p.recomputeStats();}},
    {id:'dr_lt1', x:1290, y:290, type:'minor',   connections:['dr_lta','dr_lt2','dr_ltn'], name:'World Shaker', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'dr_ltn', x:1420, y:310, type:'notable',  connections:['dr_lt1','dr_lt2','dr_lt3','dr_lma'], name:'Earth Shaker', desc:'+18% Dmg, +20 HP', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxHp+=20; p.recomputeStats();}},
    {id:'dr_lt2', x:1350, y:210, type:'minor',   connections:['dr_lt1','dr_ltn','dr_lt3'], name:'Seismic Force', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'dr_lt3', x:1470, y:230, type:'minor',   connections:['dr_lt2','dr_ltn'], name:'Land Breaker', desc:'+12% Dmg, +8 HP', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxHp+=8; p.recomputeStats();}},
    {id:'dr_lba', x:1170, y:1040, type:'passive',  connections:['dr_mb2','dr_lb1'], name:'Primal Wisdom', desc:'+3 INT, +15 Resource, +10% Cold Dmg', apply:(p)=>{p.primaryInt=(p.primaryInt||0)+3; p.bonusMaxResource+=15; p.bonusColdDmgPct=(p.bonusColdDmgPct||0)+10; p.recomputeStats();}},
    {id:'dr_lb1', x:1290, y:1010, type:'minor',   connections:['dr_lba','dr_lb2','dr_lbn'], name:'Feral Strike', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'dr_lbn', x:1420, y:990, type:'notable',  connections:['dr_lb1','dr_lb2','dr_lb3','dr_lma'], name:'Beast Form', desc:'+15% Dmg, +15% Speed', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseSpeed*=1.150; p.recomputeStats();}},
    {id:'dr_lb2', x:1350, y:1090, type:'minor',   connections:['dr_lb1','dr_lbn','dr_lb3'], name:'Primal Speed', desc:'+10% Speed', apply:(p)=>{p.baseSpeed*=1.100; p.recomputeStats();}},
    {id:'dr_lb3', x:1470, y:1070, type:'minor',   connections:['dr_lb2','dr_lbn'], name:'Wild Rush', desc:'+12% Dmg, +8% Speed', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseSpeed*=1.080; p.recomputeStats();}},
    {id:'dr_lma', x:1590, y:700, type:'notable',  connections:['dr_ltn','dr_lbn','dr_lm1','dr_lm2'], name:'Nature Peak', desc:'+18% Dmg, +25 Spirit', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxResource+=25; p.recomputeStats();}},
    {id:'dr_lm1', x:1710, y:620, type:'minor',   connections:['dr_lma','dr_lm2','dr_ap'], name:'Druid Mastery', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'dr_lm2', x:1710, y:780, type:'minor',   connections:['dr_lma','dr_lm1','dr_ap'], name:'Spirit Flood', desc:'+20 Spirit, +8% Dmg', apply:(p)=>{p.baseMaxResource+=20; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'dr_ap', x:1880, y:700, type:'notable',  connections:['dr_lm1','dr_lm2','dr_ap1','dr_ap2','dr_ap3'], name:'World Tree', desc:'+22% Dmg, +30 Spirit', apply:(p)=>{p.baseDmgMult*=1.220; p.recomputeStats(); p.baseMaxResource+=30; p.recomputeStats();}},
    {id:'dr_ap1', x:2000, y:610, type:'minor',   connections:['dr_ap','dr_ap2','dr_pre'], name:'Ancient Grove', desc:'+12% Dmg, +10% Speed', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseSpeed*=1.100; p.recomputeStats();}},
    {id:'dr_ap2', x:2000, y:700, type:'minor',   connections:['dr_ap','dr_ap1','dr_ap3'], name:'Nature God', desc:'+15% Dmg', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats();}},
    {id:'dr_ap3', x:2000, y:790, type:'minor',   connections:['dr_ap','dr_ap2','dr_pre'], name:'Titan Root', desc:'+25 HP, +15 Armor', apply:(p)=>{p.baseMaxHp+=25; p.recomputeStats(); p.baseArmor+=15; p.recomputeStats();}},
    {id:'dr_pre', x:2170, y:700, type:'minor',   connections:['dr_ap1','dr_ap3','dr_cap'], name:'World Root', desc:'+15% Dmg, +20 Spirit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxResource+=20; p.recomputeStats();}},
    {id:'dr_cap', x:2340, y:700, type:'keystone', connections:['dr_pre'], name:'World Tree', desc:'Passive tree totem spawns. +30% Dmg, +30 Spirit', apply:(p)=>{p.baseDmgMult*=1.300; p.recomputeStats(); p.baseMaxResource+=30; p.recomputeStats(); p.baseMaxHp+=25; p.recomputeStats();}}
  ]},
  // -- AMAZONIAN --
  amazonian: { nodes: [
    {id:'az0', x:80, y:700, type:'minor', origin:true,   connections:['az_ta','az_ma','az_ba'], name:'Apex Born', desc:'+5% Dmg, +4% Speed', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseSpeed*=1.040; p.recomputeStats();}},
    {id:'az_ta', x:200, y:520, type:'minor',   connections:['az0','az_t1'], name:'Javelin Arts', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'az_t1', x:330, y:380, type:'minor',   connections:['az_ta','az_t2','az_tn'], name:'Javelin Arts II', desc:'+4% Dmg, +4% Speed', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.baseSpeed*=1.040; p.recomputeStats();}},
    {id:'az_tn', x:460, y:280, type:'notable',  connections:['az_t1','az_t2','az_t3','az_t4','az_t5'], name:'Javelin Mastery', desc:'+12% Dmg, +8% Speed', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseSpeed*=1.080; p.recomputeStats();}},
    {id:'az_t2', x:400, y:200, type:'minor',   connections:['az_t1','az_tn','az_t3'], name:'Spear Dance', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'az_t3', x:540, y:190, type:'minor',   connections:['az_t2','az_tn','az_t4'], name:'Thunder Throw', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'az_t4', x:600, y:290, type:'minor',   connections:['az_t3','az_tn','az_t5'], name:'Lightning Arm', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'az_t5', x:560, y:390, type:'minor',   connections:['az_t4','az_tn','az_t6'], name:'Amazon Fury', desc:'+5% Dmg, +4% Speed', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseSpeed*=1.040; p.recomputeStats();}},
    {id:'az_t6', x:470, y:420, type:'minor',   connections:['az_t5','az_ta1'], name:'War Maiden', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'az_ta1', x:690, y:320, type:'passive',  connections:['az_t6','az_tn','az_tka'], name:'Storm Throw', desc:'+3 DEX, +12% Lightning Dmg', apply:(p)=>{p.primaryDex=(p.primaryDex||0)+3; p.bonusLightDmgPct=(p.bonusLightDmgPct||0)+12; p.recomputeStats();}},
    {id:'az_tka', x:850, y:340, type:'keystone', connections:['az_ta1','az_mb1'], name:'Amazon War Cry', desc:'Kills boost speed 5s. +20% Dmg, +10% Speed', apply:(p)=>{p.baseDmgMult*=1.200; p.recomputeStats(); p.baseSpeed*=1.100; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'az_ma', x:200, y:700, type:'minor',   connections:['az0','az_m1'], name:'Spirit Charge', desc:'+8 Spirit', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats();}},
    {id:'az_m1', x:330, y:700, type:'minor',   connections:['az_ma','az_m2','az_mn'], name:'Spirit Charge II', desc:'+8 Spirit, +4% Dmg', apply:(p)=>{p.baseMaxResource+=8; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'az_mn', x:460, y:700, type:'notable',  connections:['az_m1','az_m2','az_m3','az_m4','az_m5'], name:'Spirit Surge', desc:'+20 Spirit, +8% Dmg', apply:(p)=>{p.baseMaxResource+=20; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'az_m2', x:400, y:620, type:'minor',   connections:['az_m1','az_mn','az_m3'], name:'Battle Charge', desc:'+10 Spirit', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'az_m3', x:540, y:620, type:'minor',   connections:['az_m2','az_mn','az_m4'], name:'Hunt Flow', desc:'+10 Spirit, +4% Dmg', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'az_m4', x:590, y:700, type:'minor',   connections:['az_m3','az_mn','az_m5'], name:'War Spirit', desc:'+12 Spirit', apply:(p)=>{p.baseMaxResource+=12; p.recomputeStats();}},
    {id:'az_m5', x:540, y:780, type:'minor',   connections:['az_m4','az_mn','az_m6'], name:'Predator Flow', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'az_m6', x:400, y:780, type:'minor',   connections:['az_m5','az_ma2'], name:'Amazon Grace', desc:'+10% Speed', apply:(p)=>{p.baseSpeed*=1.100; p.recomputeStats();}},
    {id:'az_ma2', x:690, y:700, type:'passive',  connections:['az_mn','az_m6'], name:'War Spirit', desc:'+2 DEX, +2 SPI, +8% Dmg', apply:(p)=>{p.primaryDex=(p.primaryDex||0)+2; p.primarySpi=(p.primarySpi||0)+2; p.baseDmgMult*=1.08; p.recomputeStats();}},
    {id:'az_ba', x:200, y:880, type:'minor',   connections:['az0','az_b1'], name:'Venom Arts', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'az_b1', x:330, y:1030, type:'minor',   connections:['az_ba','az_b2','az_bn'], name:'Venom Arts II', desc:'+4% Dmg, +3% Life Steal', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'az_bn', x:460, y:1120, type:'notable',  connections:['az_b1','az_b2','az_b3','az_b4','az_b5'], name:'Venom Mastery', desc:'+10% Dmg, +5% Life Steal', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}},
    {id:'az_b2', x:400, y:1050, type:'minor',   connections:['az_b1','az_bn','az_b3'], name:'Toxic Tip', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'az_b3', x:540, y:1060, type:'minor',   connections:['az_b2','az_bn','az_b4'], name:'Predator Fang', desc:'+5% Dmg, +3% Life Steal', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'az_b4', x:590, y:1130, type:'minor',   connections:['az_b3','az_bn','az_b5'], name:'Viper Strike', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'az_b5', x:540, y:1200, type:'minor',   connections:['az_b4','az_bn','az_b6'], name:'Hunting Fang', desc:'+5 Crit, +5% Dmg', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'az_b6', x:400, y:1200, type:'minor',   connections:['az_b5','az_b7'], name:'Apex Fang', desc:'+8% Crit Dmg', apply:(p)=>{p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'az_b7', x:680, y:1160, type:'minor',   connections:['az_b6','az_bn','az_bka'], name:'Predator Kill', desc:'+8% Dmg, +4% Speed', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseSpeed*=1.040; p.recomputeStats();}},
    {id:'az_bka', x:850, y:1060, type:'keystone', connections:['az_b7','az_mb2'], name:'Apex Predator', desc:'Kills charge Spirit faster. +15% Dmg, +8% Speed', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseSpeed*=1.080; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.040; p.recomputeStats();}},
    {id:'az_mb1', x:1010, y:490, type:'notable',  connections:['az_tka','az_mb2','az_lta','az_lt1'], name:'War Stride', desc:'+15% Dmg, +10% Speed', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseSpeed*=1.100; p.recomputeStats();}},
    {id:'az_mb2', x:1010, y:910, type:'notable',  connections:['az_bka','az_mb1','az_lba','az_lb1'], name:'Hunt Drive', desc:'+12% Dmg, +5% Life Steal', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}},
    {id:'az_lta', x:1170, y:360, type:'passive',  connections:['az_mb1','az_lt1'], name:'Tempest Mastery', desc:'+4 DEX, +14% Lightning Dmg', apply:(p)=>{p.primaryDex=(p.primaryDex||0)+4; p.bonusLightDmgPct=(p.bonusLightDmgPct||0)+14; p.recomputeStats();}},
    {id:'az_lt1', x:1290, y:290, type:'minor',   connections:['az_lta','az_lt2','az_ltn'], name:'Spear Storm', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'az_ltn', x:1420, y:310, type:'notable',  connections:['az_lt1','az_lt2','az_lt3','az_lma'], name:'Javelin God', desc:'+18% Dmg, +12% Speed', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseSpeed*=1.120; p.recomputeStats();}},
    {id:'az_lt2', x:1350, y:210, type:'minor',   connections:['az_lt1','az_ltn','az_lt3'], name:'Sky Javelin', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'az_lt3', x:1470, y:230, type:'minor',   connections:['az_lt2','az_ltn'], name:'Thunderspear', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'az_lba', x:1170, y:1040, type:'passive',  connections:['az_mb2','az_lb1'], name:"Hunter's Bond", desc:'+3 SPI, +10% Poison Dmg, +1.5 Resource Regen', apply:(p)=>{p.primarySpi=(p.primarySpi||0)+3; p.bonusPoisonDmgPct=(p.bonusPoisonDmgPct||0)+10; p.bonusResourceRegen+=1.5; p.recomputeStats();}},
    {id:'az_lb1', x:1290, y:1010, type:'minor',   connections:['az_lba','az_lb2','az_lbn'], name:'Predator Form', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'az_lbn', x:1420, y:990, type:'notable',  connections:['az_lb1','az_lb2','az_lb3','az_lma'], name:'Hunt God', desc:'+15% Dmg, +10% Speed', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseSpeed*=1.100; p.recomputeStats();}},
    {id:'az_lb2', x:1350, y:1090, type:'minor',   connections:['az_lb1','az_lbn','az_lb3'], name:'Predator Rush', desc:'+8% Speed', apply:(p)=>{p.baseSpeed*=1.080; p.recomputeStats();}},
    {id:'az_lb3', x:1470, y:1070, type:'minor',   connections:['az_lb2','az_lbn'], name:'Blitz Hunt', desc:'+12% Dmg, +8% Speed', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseSpeed*=1.080; p.recomputeStats();}},
    {id:'az_lma', x:1590, y:700, type:'notable',  connections:['az_ltn','az_lbn','az_lm1','az_lm2'], name:'Amazon Peak', desc:'+18% Dmg, +20% Speed', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseSpeed*=1.200; p.recomputeStats();}},
    {id:'az_lm1', x:1710, y:620, type:'minor',   connections:['az_lma','az_lm2','az_ap'], name:'War Mastery', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'az_lm2', x:1710, y:780, type:'minor',   connections:['az_lma','az_lm1','az_ap'], name:'Spirit God', desc:'+20 Spirit, +10% Dmg', apply:(p)=>{p.baseMaxResource+=20; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'az_ap', x:1880, y:700, type:'notable',  connections:['az_lm1','az_lm2','az_ap1','az_ap2','az_ap3'], name:'Apex Amazon', desc:'+22% Dmg, +20% Speed', apply:(p)=>{p.baseDmgMult*=1.220; p.recomputeStats(); p.baseSpeed*=1.200; p.recomputeStats();}},
    {id:'az_ap1', x:2000, y:610, type:'minor',   connections:['az_ap','az_ap2','az_pre'], name:'War God', desc:'+12% Dmg, +10% Speed', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseSpeed*=1.100; p.recomputeStats();}},
    {id:'az_ap2', x:2000, y:700, type:'minor',   connections:['az_ap','az_ap1','az_ap3'], name:'Hunt God', desc:'+15% Dmg', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats();}},
    {id:'az_ap3', x:2000, y:790, type:'minor',   connections:['az_ap','az_ap2','az_pre'], name:'Predator God', desc:'+6% Life Steal, +10% Dmg', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.060; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'az_pre', x:2170, y:700, type:'minor',   connections:['az_ap1','az_ap3','az_cap'], name:'Amazon Legend', desc:'+15% Dmg, +12% Speed', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseSpeed*=1.120; p.recomputeStats();}},
    {id:'az_cap', x:2340, y:700, type:'keystone', connections:['az_pre'], name:'Apex Predator', desc:'Max Spirit Charge = god mode. +30% Dmg, +25% Speed', apply:(p)=>{p.baseDmgMult*=1.300; p.recomputeStats(); p.baseSpeed*=1.250; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}}
  ]},
  // -- SHAMAN --
  shaman: { nodes: [
    {id:'sh0', x:80, y:700, type:'minor', origin:true,   connections:['sh_ta','sh_ma','sh_ba'], name:'Mojo Root', desc:'+5% Dmg, +10 Mojo', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'sh_ta', x:200, y:520, type:'minor',   connections:['sh0','sh_t1'], name:'Hex Arts', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'sh_t1', x:330, y:380, type:'minor',   connections:['sh_ta','sh_t2','sh_tn'], name:'Hex Arts II', desc:'+4% Dmg, +5 Mojo', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.baseMaxResource+=5; p.recomputeStats();}},
    {id:'sh_tn', x:460, y:280, type:'notable',  connections:['sh_t1','sh_t2','sh_t3','sh_t4','sh_t5'], name:'Hex Mastery', desc:'+12% Dmg, +15 Mojo', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'sh_t2', x:400, y:200, type:'minor',   connections:['sh_t1','sh_tn','sh_t3'], name:'Dark Hex', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'sh_t3', x:540, y:190, type:'minor',   connections:['sh_t2','sh_tn','sh_t4'], name:'Voodoo Arts', desc:'+6% Dmg, +5 Mojo', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseMaxResource+=5; p.recomputeStats();}},
    {id:'sh_t4', x:600, y:290, type:'minor',   connections:['sh_t3','sh_tn','sh_t5'], name:'Curse Weave', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sh_t5', x:560, y:390, type:'minor',   connections:['sh_t4','sh_tn','sh_t6'], name:'Shadow Hex', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'sh_t6', x:470, y:420, type:'minor',   connections:['sh_t5','sh_ta1'], name:'Death Curse', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sh_ta1', x:690, y:320, type:'passive',  connections:['sh_t6','sh_tn','sh_tka'], name:'Hex Mastery', desc:'+3 SPI, +12% Poison Dmg', apply:(p)=>{p.primarySpi=(p.primarySpi||0)+3; p.bonusPoisonDmgPct=(p.bonusPoisonDmgPct||0)+12; p.recomputeStats();}},
    {id:'sh_tka', x:850, y:340, type:'keystone', connections:['sh_ta1','sh_mb1'], name:'Voodoo Lord', desc:'Hexed targets take +35% Dmg. +20% Dmg', apply:(p)=>{p.baseDmgMult*=1.200; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'sh_ma', x:200, y:700, type:'minor',   connections:['sh0','sh_m1'], name:'Spirit Totem', desc:'+10 Mojo', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'sh_m1', x:330, y:700, type:'minor',   connections:['sh_ma','sh_m2','sh_mn'], name:'Spirit Totem II', desc:'+10 Mojo, +4% Dmg', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'sh_mn', x:460, y:700, type:'notable',  connections:['sh_m1','sh_m2','sh_m3','sh_m4','sh_m5'], name:'Totem Mastery', desc:'+20 Mojo, +8% Dmg', apply:(p)=>{p.baseMaxResource+=20; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sh_m2', x:400, y:620, type:'minor',   connections:['sh_m1','sh_mn','sh_m3'], name:'Ancestor Power', desc:'+12 Mojo', apply:(p)=>{p.baseMaxResource+=12; p.recomputeStats();}},
    {id:'sh_m3', x:540, y:620, type:'minor',   connections:['sh_m2','sh_mn','sh_m4'], name:'Spirit Call', desc:'+10 Mojo, +5% Dmg', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'sh_m4', x:590, y:700, type:'minor',   connections:['sh_m3','sh_mn','sh_m5'], name:'Mojo Surge', desc:'+15 Mojo', apply:(p)=>{p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'sh_m5', x:540, y:780, type:'minor',   connections:['sh_m4','sh_mn','sh_m6'], name:'War Drum', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sh_m6', x:400, y:780, type:'minor',   connections:['sh_m5','sh_ma2'], name:'Shaman Power', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'sh_ma2', x:690, y:700, type:'passive',  connections:['sh_mn','sh_m6'], name:'Spirit Vessel', desc:'+2 SPI, +2 INT, +15 Resource', apply:(p)=>{p.primarySpi=(p.primarySpi||0)+2; p.primaryInt=(p.primaryInt||0)+2; p.bonusMaxResource+=15; p.recomputeStats();}},
    {id:'sh_ba', x:200, y:880, type:'minor',   connections:['sh0','sh_b1'], name:'Venom Cloud', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'sh_b1', x:330, y:1030, type:'minor',   connections:['sh_ba','sh_b2','sh_bn'], name:'Venom Cloud II', desc:'+4% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'sh_bn', x:460, y:1120, type:'notable',  connections:['sh_b1','sh_b2','sh_b3','sh_b4','sh_b5'], name:'Poison Mastery', desc:'+10% Dmg, +4% Life Steal', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.040; p.recomputeStats();}},
    {id:'sh_b2', x:400, y:1050, type:'minor',   connections:['sh_b1','sh_bn','sh_b3'], name:'Toxic Brew', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'sh_b3', x:540, y:1060, type:'minor',   connections:['sh_b2','sh_bn','sh_b4'], name:'Viper Spirit', desc:'+5% Dmg, +4% Life Steal', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.040; p.recomputeStats();}},
    {id:'sh_b4', x:590, y:1130, type:'minor',   connections:['sh_b3','sh_bn','sh_b5'], name:'Plague Arts', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sh_b5', x:540, y:1200, type:'minor',   connections:['sh_b4','sh_bn','sh_b6'], name:'Death Venom', desc:'+5 Crit, +5% Dmg', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'sh_b6', x:400, y:1200, type:'minor',   connections:['sh_b5','sh_b7'], name:'Corpse Poison', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sh_b7', x:680, y:1160, type:'minor',   connections:['sh_b6','sh_bn','sh_bka'], name:'Soul Harvest', desc:'+8% Dmg, +5 Mojo', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.baseMaxResource+=5; p.recomputeStats();}},
    {id:'sh_bka', x:850, y:1060, type:'keystone', connections:['sh_b7','sh_mb2'], name:'Soul Reaper', desc:'Kills restore 10 Mojo. +15% Dmg, +5% Life Steal', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'sh_mb1', x:1010, y:490, type:'notable',  connections:['sh_tka','sh_mb2','sh_lta','sh_lt1'], name:'Hex Storm', desc:'+15% Dmg, +15 Mojo', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'sh_mb2', x:1010, y:910, type:'notable',  connections:['sh_bka','sh_mb1','sh_lba','sh_lb1'], name:'Dark Mojo', desc:'+12% Dmg, +5% Life Steal', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}},
    {id:'sh_lta', x:1170, y:360, type:'passive',  connections:['sh_mb1','sh_lt1'], name:'Thunder Rites', desc:'+4 INT, +14% Lightning Dmg', apply:(p)=>{p.primaryInt=(p.primaryInt||0)+4; p.bonusLightDmgPct=(p.bonusLightDmgPct||0)+14; p.recomputeStats();}},
    {id:'sh_lt1', x:1290, y:290, type:'minor',   connections:['sh_lta','sh_lt2','sh_ltn'], name:'Thunder Mojo', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'sh_ltn', x:1420, y:310, type:'notable',  connections:['sh_lt1','sh_lt2','sh_lt3','sh_lma'], name:'Ancestor Storm', desc:'+18% Dmg, +20 Mojo', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxResource+=20; p.recomputeStats();}},
    {id:'sh_lt2', x:1350, y:210, type:'minor',   connections:['sh_lt1','sh_ltn','sh_lt3'], name:'Storm Hex', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'sh_lt3', x:1470, y:230, type:'minor',   connections:['sh_lt2','sh_ltn'], name:'Thunder God', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'sh_lba', x:1170, y:1040, type:'passive',  connections:['sh_mb2','sh_lb1'], name:'Ancestral Power', desc:'+3 SPI, +10% All Elemental Dmg', apply:(p)=>{p.primarySpi=(p.primarySpi||0)+3; p.bonusFireDmgPct=(p.bonusFireDmgPct||0)+10; p.bonusLightDmgPct=(p.bonusLightDmgPct||0)+10; p.bonusPoisonDmgPct=(p.bonusPoisonDmgPct||0)+10; p.bonusColdDmgPct=(p.bonusColdDmgPct||0)+10; p.recomputeStats();}},
    {id:'sh_lb1', x:1290, y:1010, type:'minor',   connections:['sh_lba','sh_lb2','sh_lbn'], name:'Ancestor Rage', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'sh_lbn', x:1420, y:990, type:'notable',  connections:['sh_lb1','sh_lb2','sh_lb3','sh_lma'], name:'Fury Totem', desc:'+15% Dmg, +12 Crit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseCritChance+=12; p.recomputeStats();}},
    {id:'sh_lb2', x:1350, y:1090, type:'minor',   connections:['sh_lb1','sh_lbn','sh_lb3'], name:'Rage Spirit', desc:'+8 Crit', apply:(p)=>{p.baseCritChance+=8; p.recomputeStats();}},
    {id:'sh_lb3', x:1470, y:1070, type:'minor',   connections:['sh_lb2','sh_lbn'], name:'Fury Storm', desc:'+12% Dmg, +8% Crit Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'sh_lma', x:1590, y:700, type:'notable',  connections:['sh_ltn','sh_lbn','sh_lm1','sh_lm2'], name:'Shaman Peak', desc:'+18% Dmg, +25 Mojo', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxResource+=25; p.recomputeStats();}},
    {id:'sh_lm1', x:1710, y:620, type:'minor',   connections:['sh_lma','sh_lm2','sh_ap'], name:'Hex Mastery', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'sh_lm2', x:1710, y:780, type:'minor',   connections:['sh_lma','sh_lm1','sh_ap'], name:'Mojo God', desc:'+20 Mojo, +8% Dmg', apply:(p)=>{p.baseMaxResource+=20; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'sh_ap', x:1880, y:700, type:'notable',  connections:['sh_lm1','sh_lm2','sh_ap1','sh_ap2','sh_ap3'], name:'Ancestral God', desc:'+22% Dmg, +30 Mojo', apply:(p)=>{p.baseDmgMult*=1.220; p.recomputeStats(); p.baseMaxResource+=30; p.recomputeStats();}},
    {id:'sh_ap1', x:2000, y:610, type:'minor',   connections:['sh_ap','sh_ap2','sh_pre'], name:'Spirit God', desc:'+12% Dmg, +15 Mojo', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'sh_ap2', x:2000, y:700, type:'minor',   connections:['sh_ap','sh_ap1','sh_ap3'], name:'Voodoo God', desc:'+15% Dmg', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats();}},
    {id:'sh_ap3', x:2000, y:790, type:'minor',   connections:['sh_ap','sh_ap2','sh_pre'], name:'Dark God', desc:'+6% Life Steal, +10% Dmg', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.060; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'sh_pre', x:2170, y:700, type:'minor',   connections:['sh_ap1','sh_ap3','sh_cap'], name:'Ancestor Legend', desc:'+15% Dmg, +15 Mojo', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'sh_cap', x:2340, y:700, type:'keystone', connections:['sh_pre'], name:'Ancestral Fury', desc:'Hexes chain on enemy death. +30% Dmg, +30 Mojo', apply:(p)=>{p.baseDmgMult*=1.300; p.recomputeStats(); p.baseMaxResource+=30; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}}
  ]},
  // -- NECROMANCER --
  necromancer: { nodes: [
    {id:'nc0', x:80, y:700, type:'minor', origin:true,   connections:['nc_ta','nc_ma','nc_ba'], name:'Death Pact', desc:'+5% Dmg, +10 Necrotic', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'nc_ta', x:200, y:520, type:'minor',   connections:['nc0','nc_t1'], name:'Bone Arts', desc:'+4% Dmg', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'nc_t1', x:330, y:380, type:'minor',   connections:['nc_ta','nc_t2','nc_tn'], name:'Bone Arts II', desc:'+4% Dmg, +5 Necrotic', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.baseMaxResource+=5; p.recomputeStats();}},
    {id:'nc_tn', x:460, y:280, type:'notable',  connections:['nc_t1','nc_t2','nc_t3','nc_t4','nc_t5'], name:'Bone Mastery', desc:'+12% Dmg, +15 Necrotic', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'nc_t2', x:400, y:200, type:'minor',   connections:['nc_t1','nc_tn','nc_t3'], name:'Bone Shards', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'nc_t3', x:540, y:190, type:'minor',   connections:['nc_t2','nc_tn','nc_t4'], name:'Skeletal Arts', desc:'+6% Dmg, +5 Necrotic', apply:(p)=>{p.baseDmgMult*=1.060; p.recomputeStats(); p.baseMaxResource+=5; p.recomputeStats();}},
    {id:'nc_t4', x:600, y:290, type:'minor',   connections:['nc_t3','nc_tn','nc_t5'], name:'Death Wave', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'nc_t5', x:560, y:390, type:'minor',   connections:['nc_t4','nc_tn','nc_t6'], name:'Bone Spear', desc:'+5% Dmg, +5 Crit', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.baseCritChance+=5; p.recomputeStats();}},
    {id:'nc_t6', x:470, y:420, type:'minor',   connections:['nc_t5','nc_ta1'], name:'Skeletal Storm', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'nc_ta1', x:690, y:320, type:'passive',  connections:['nc_t6','nc_tn','nc_tka'], name:'Bone Mastery', desc:'+3 INT, +12% Cold Dmg', apply:(p)=>{p.primaryInt=(p.primaryInt||0)+3; p.bonusColdDmgPct=(p.bonusColdDmgPct||0)+12; p.recomputeStats();}},
    {id:'nc_tka', x:850, y:340, type:'keystone', connections:['nc_ta1','nc_mb1'], name:'Lich Lord', desc:'Bone spells +35% Dmg, +20 Necrotic', apply:(p)=>{p.baseDmgMult*=1.350; p.recomputeStats(); p.baseMaxResource+=20; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'nc_ma', x:200, y:700, type:'minor',   connections:['nc0','nc_m1'], name:'Undead Army', desc:'+10 Necrotic', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats();}},
    {id:'nc_m1', x:330, y:700, type:'minor',   connections:['nc_ma','nc_m2','nc_mn'], name:'Undead Army II', desc:'+10 Necrotic, +4% Dmg', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats(); p.baseDmgMult*=1.040; p.recomputeStats();}},
    {id:'nc_mn', x:460, y:700, type:'notable',  connections:['nc_m1','nc_m2','nc_m3','nc_m4','nc_m5'], name:'Death Mastery', desc:'+20 Necrotic, +8% Dmg', apply:(p)=>{p.baseMaxResource+=20; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'nc_m2', x:400, y:620, type:'minor',   connections:['nc_m1','nc_mn','nc_m3'], name:'Raise Dead', desc:'+12 Necrotic', apply:(p)=>{p.baseMaxResource+=12; p.recomputeStats();}},
    {id:'nc_m3', x:540, y:620, type:'minor',   connections:['nc_m2','nc_mn','nc_m4'], name:'Army of Bone', desc:'+10 Necrotic, +5% Dmg', apply:(p)=>{p.baseMaxResource+=10; p.recomputeStats(); p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'nc_m4', x:590, y:700, type:'minor',   connections:['nc_m3','nc_mn','nc_m5'], name:'Death Pool', desc:'+15 Necrotic', apply:(p)=>{p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'nc_m5', x:540, y:780, type:'minor',   connections:['nc_m4','nc_mn','nc_m6'], name:'Undying Army', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'nc_m6', x:400, y:780, type:'minor',   connections:['nc_m5','nc_ma2'], name:'Death March', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'nc_ma2', x:690, y:700, type:'passive',  connections:['nc_mn','nc_m6'], name:'Death Legion', desc:'+2 INT, +2 VIT, +10% Dmg', apply:(p)=>{p.primaryInt=(p.primaryInt||0)+2; p.primaryVit=(p.primaryVit||0)+2; p.baseDmgMult*=1.10; p.recomputeStats();}},
    {id:'nc_ba', x:200, y:880, type:'minor',   connections:['nc0','nc_b1'], name:'Blood Pact', desc:'+4% Dmg, +2% Life Steal', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.020; p.recomputeStats();}},
    {id:'nc_b1', x:330, y:1030, type:'minor',   connections:['nc_ba','nc_b2','nc_bn'], name:'Blood Pact II', desc:'+4% Dmg, +3% Life Steal', apply:(p)=>{p.baseDmgMult*=1.040; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'nc_bn', x:460, y:1120, type:'notable',  connections:['nc_b1','nc_b2','nc_b3','nc_b4','nc_b5'], name:'Blood Rite', desc:'+10% Dmg, +6% Life Steal', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.060; p.recomputeStats();}},
    {id:'nc_b2', x:400, y:1050, type:'minor',   connections:['nc_b1','nc_bn','nc_b3'], name:'Dark Blood', desc:'+5% Dmg', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats();}},
    {id:'nc_b3', x:540, y:1060, type:'minor',   connections:['nc_b2','nc_bn','nc_b4'], name:'Blood Arts', desc:'+5% Dmg, +3% Life Steal', apply:(p)=>{p.baseDmgMult*=1.050; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'nc_b4', x:590, y:1130, type:'minor',   connections:['nc_b3','nc_bn','nc_b5'], name:'Blood Storm', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'nc_b5', x:540, y:1200, type:'minor',   connections:['nc_b4','nc_bn','nc_b6'], name:'Death Blood', desc:'+5 Crit, +3% Life Steal', apply:(p)=>{p.baseCritChance+=5; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'nc_b6', x:400, y:1200, type:'minor',   connections:['nc_b5','nc_b7'], name:'Corpse Fuel', desc:'+8% Dmg', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'nc_b7', x:680, y:1160, type:'minor',   connections:['nc_b6','nc_bn','nc_bka'], name:'Death Rite', desc:'+8% Dmg, +3% Life Steal', apply:(p)=>{p.baseDmgMult*=1.080; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.030; p.recomputeStats();}},
    {id:'nc_bka', x:850, y:1060, type:'keystone', connections:['nc_b7','nc_mb2'], name:'Blood Covenant', desc:'Kills restore HP. +15% Dmg, +5% Life Steal', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats(); p.baseMaxHp+=15; p.recomputeStats();}},
    {id:'nc_mb1', x:1010, y:490, type:'notable',  connections:['nc_tka','nc_mb2','nc_lta','nc_lt1'], name:'Death Storm', desc:'+15% Dmg, +15 Necrotic', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'nc_mb2', x:1010, y:910, type:'notable',  connections:['nc_bka','nc_mb1','nc_lba','nc_lb1'], name:'Dark Covenant', desc:'+12% Dmg, +5% Life Steal', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.050; p.recomputeStats();}},
    {id:'nc_lta', x:1170, y:360, type:'passive',  connections:['nc_mb1','nc_lt1'], name:'Plague Bringer', desc:'+4 INT, +14% Poison Dmg', apply:(p)=>{p.primaryInt=(p.primaryInt||0)+4; p.bonusPoisonDmgPct=(p.bonusPoisonDmgPct||0)+14; p.recomputeStats();}},
    {id:'nc_lt1', x:1290, y:290, type:'minor',   connections:['nc_lta','nc_lt2','nc_ltn'], name:'Corpse Rain', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'nc_ltn', x:1420, y:310, type:'notable',  connections:['nc_lt1','nc_lt2','nc_lt3','nc_lma'], name:'Death Explosion', desc:'+18% Dmg, +20 Necrotic', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxResource+=20; p.recomputeStats();}},
    {id:'nc_lt2', x:1350, y:210, type:'minor',   connections:['nc_lt1','nc_ltn','nc_lt3'], name:'Bone Blast', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'nc_lt3', x:1470, y:230, type:'minor',   connections:['nc_lt2','nc_ltn'], name:'Death Blast', desc:'+12% Dmg, +8 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=8; p.recomputeStats();}},
    {id:'nc_lba', x:1170, y:1040, type:'passive',  connections:['nc_mb2','nc_lb1'], name:'Undying Pact', desc:'+3 VIT, +35 HP, +10% Cold Dmg', apply:(p)=>{p.primaryVit=(p.primaryVit||0)+3; p.baseMaxHp+=35; p.bonusColdDmgPct=(p.bonusColdDmgPct||0)+10; p.recomputeStats();}},
    {id:'nc_lb1', x:1290, y:1010, type:'minor',   connections:['nc_lba','nc_lb2','nc_lbn'], name:'Lich Power', desc:'+10% Dmg', apply:(p)=>{p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'nc_lbn', x:1420, y:990, type:'notable',  connections:['nc_lb1','nc_lb2','nc_lb3','nc_lma'], name:'Lich Arts', desc:'+15% Dmg, +10 Crit', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'nc_lb2', x:1350, y:1090, type:'minor',   connections:['nc_lb1','nc_lbn','nc_lb3'], name:'Dark Lich', desc:'+8 Crit', apply:(p)=>{p.baseCritChance+=8; p.recomputeStats();}},
    {id:'nc_lb3', x:1470, y:1070, type:'minor',   connections:['nc_lb2','nc_lbn'], name:'Death Lich', desc:'+12% Dmg, +8% Crit Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritDmg+=0.08; p.recomputeStats();}},
    {id:'nc_lma', x:1590, y:700, type:'notable',  connections:['nc_ltn','nc_lbn','nc_lm1','nc_lm2'], name:'Necro Peak', desc:'+18% Dmg, +25 Necrotic', apply:(p)=>{p.baseDmgMult*=1.180; p.recomputeStats(); p.baseMaxResource+=25; p.recomputeStats();}},
    {id:'nc_lm1', x:1710, y:620, type:'minor',   connections:['nc_lma','nc_lm2','nc_ap'], name:'Death Mastery', desc:'+12% Dmg', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats();}},
    {id:'nc_lm2', x:1710, y:780, type:'minor',   connections:['nc_lma','nc_lm1','nc_ap'], name:'Necrotic God', desc:'+20 Necrotic, +8% Dmg', apply:(p)=>{p.baseMaxResource+=20; p.recomputeStats(); p.baseDmgMult*=1.080; p.recomputeStats();}},
    {id:'nc_ap', x:1880, y:700, type:'notable',  connections:['nc_lm1','nc_lm2','nc_ap1','nc_ap2','nc_ap3'], name:'Necro God', desc:'+22% Dmg, +30 Necrotic', apply:(p)=>{p.baseDmgMult*=1.220; p.recomputeStats(); p.baseMaxResource+=30; p.recomputeStats();}},
    {id:'nc_ap1', x:2000, y:610, type:'minor',   connections:['nc_ap','nc_ap2','nc_pre'], name:'Death God', desc:'+12% Dmg, +10 Crit', apply:(p)=>{p.baseDmgMult*=1.120; p.recomputeStats(); p.baseCritChance+=10; p.recomputeStats();}},
    {id:'nc_ap2', x:2000, y:700, type:'minor',   connections:['nc_ap','nc_ap1','nc_ap3'], name:'Bone God', desc:'+15% Dmg', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats();}},
    {id:'nc_ap3', x:2000, y:790, type:'minor',   connections:['nc_ap','nc_ap2','nc_pre'], name:'Dark God', desc:'+6% Life Steal, +10% Dmg', apply:(p)=>{p.lifeStealPct=(p.lifeStealPct||0)+0.060; p.recomputeStats(); p.baseDmgMult*=1.100; p.recomputeStats();}},
    {id:'nc_pre', x:2170, y:700, type:'minor',   connections:['nc_ap1','nc_ap3','nc_cap'], name:'Death Legend', desc:'+15% Dmg, +15 Necrotic', apply:(p)=>{p.baseDmgMult*=1.150; p.recomputeStats(); p.baseMaxResource+=15; p.recomputeStats();}},
    {id:'nc_cap', x:2340, y:700, type:'keystone', connections:['nc_pre'], name:'Necrotic Apocalypse', desc:'Death cascade on kill. +30% Dmg, +8% Life Steal', apply:(p)=>{p.baseDmgMult*=1.300; p.recomputeStats(); p.lifeStealPct=(p.lifeStealPct||0)+0.080; p.recomputeStats(); p.baseMaxResource+=30; p.recomputeStats();}}
  ]},
};
...
const STAT_POOL = [
  ...
  { id: 'dodge_1',       tier: 1, name: '+1% Dodge',           desc: 'Chance to avoid a hit',    apply: (p) => { p.baseDodge += 1;            p.recomputeStats(); } },
  ...
  { id: 'dodge_2',       tier: 2, name: '+1% Dodge',           desc: 'Noticeable evasion',       apply: (p) => { p.baseDodge += 1;            p.recomputeStats(); } },
  ...
  { id: 'dodge_3',       tier: 3, name: '+1% Dodge',           desc: 'Hard to pin down',         apply: (p) => { p.baseDodge += 1;            p.recomputeStats(); } },
  ...
  { id: 'dodge_4',       tier: 4, name: '+2% Dodge',           desc: 'You are the ghost',        apply: (p) => { p.baseDodge += 2;            p.recomputeStats(); } },
